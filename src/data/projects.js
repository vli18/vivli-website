...
export const portfolioItems = [
  {
    ...
    images: [
      { type: 'video', src: getImg('/src/assets/projects/kinetic-pixels/header_tiles.mp4'), layout: 'full' },
