(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const u of l)if(u.type==="childList")for(const d of u.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function i(l){const u={};return l.integrity&&(u.integrity=l.integrity),l.referrerPolicy&&(u.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?u.credentials="include":l.crossOrigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function r(l){if(l.ep)return;l.ep=!0;const u=i(l);fetch(l.href,u)}})();function sg(o){return o&&o.__esModule&&Object.prototype.hasOwnProperty.call(o,"default")?o.default:o}var Ff={exports:{}},Mo={};var ex;function Gv(){if(ex)return Mo;ex=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(r,l,u){var d=null;if(u!==void 0&&(d=""+u),l.key!==void 0&&(d=""+l.key),"key"in l){u={};for(var h in l)h!=="key"&&(u[h]=l[h])}else u=l;return l=u.ref,{$$typeof:o,type:r,key:d,ref:l!==void 0?l:null,props:u}}return Mo.Fragment=t,Mo.jsx=i,Mo.jsxs=i,Mo}var tx;function Vv(){return tx||(tx=1,Ff.exports=Gv()),Ff.exports}var Ue=Vv(),If={exports:{}},rt={};var nx;function kv(){if(nx)return rt;nx=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),x=Symbol.for("react.activity"),S=Symbol.iterator;function b(L){return L===null||typeof L!="object"?null:(L=S&&L[S]||L["@@iterator"],typeof L=="function"?L:null)}var A={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,y={};function v(L,ae,ye){this.props=L,this.context=ae,this.refs=y,this.updater=ye||A}v.prototype.isReactComponent={},v.prototype.setState=function(L,ae){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,ae,"setState")},v.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function P(){}P.prototype=v.prototype;function U(L,ae,ye){this.props=L,this.context=ae,this.refs=y,this.updater=ye||A}var F=U.prototype=new P;F.constructor=U,C(F,v.prototype),F.isPureReactComponent=!0;var k=Array.isArray;function N(){}var B={H:null,A:null,T:null,S:null},te=Object.prototype.hasOwnProperty;function w(L,ae,ye){var Ee=ye.ref;return{$$typeof:o,type:L,key:ae,ref:Ee!==void 0?Ee:null,props:ye}}function R(L,ae){return w(L.type,ae,L.props)}function V(L){return typeof L=="object"&&L!==null&&L.$$typeof===o}function $(L){var ae={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(ye){return ae[ye]})}var se=/\/+/g;function de(L,ae){return typeof L=="object"&&L!==null&&L.key!=null?$(""+L.key):ae.toString(36)}function fe(L){switch(L.status){case"fulfilled":return L.value;case"rejected":throw L.reason;default:switch(typeof L.status=="string"?L.then(N,N):(L.status="pending",L.then(function(ae){L.status==="pending"&&(L.status="fulfilled",L.value=ae)},function(ae){L.status==="pending"&&(L.status="rejected",L.reason=ae)})),L.status){case"fulfilled":return L.value;case"rejected":throw L.reason}}throw L}function O(L,ae,ye,Ee,ze){var ne=typeof L;(ne==="undefined"||ne==="boolean")&&(L=null);var le=!1;if(L===null)le=!0;else switch(ne){case"bigint":case"string":case"number":le=!0;break;case"object":switch(L.$$typeof){case o:case t:le=!0;break;case _:return le=L._init,O(le(L._payload),ae,ye,Ee,ze)}}if(le)return ze=ze(L),le=Ee===""?"."+de(L,0):Ee,k(ze)?(ye="",le!=null&&(ye=le.replace(se,"$&/")+"/"),O(ze,ae,ye,"",function(Xe){return Xe})):ze!=null&&(V(ze)&&(ze=R(ze,ye+(ze.key==null||L&&L.key===ze.key?"":(""+ze.key).replace(se,"$&/")+"/")+le)),ae.push(ze)),1;le=0;var Ce=Ee===""?".":Ee+":";if(k(L))for(var He=0;He<L.length;He++)Ee=L[He],ne=Ce+de(Ee,He),le+=O(Ee,ae,ye,ne,ze);else if(He=b(L),typeof He=="function")for(L=He.call(L),He=0;!(Ee=L.next()).done;)Ee=Ee.value,ne=Ce+de(Ee,He++),le+=O(Ee,ae,ye,ne,ze);else if(ne==="object"){if(typeof L.then=="function")return O(fe(L),ae,ye,Ee,ze);throw ae=String(L),Error("Objects are not valid as a React child (found: "+(ae==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":ae)+"). If you meant to render a collection of children, use an array instead.")}return le}function j(L,ae,ye){if(L==null)return L;var Ee=[],ze=0;return O(L,Ee,"","",function(ne){return ae.call(ye,ne,ze++)}),Ee}function Y(L){if(L._status===-1){var ae=L._result;ae=ae(),ae.then(function(ye){(L._status===0||L._status===-1)&&(L._status=1,L._result=ye)},function(ye){(L._status===0||L._status===-1)&&(L._status=2,L._result=ye)}),L._status===-1&&(L._status=0,L._result=ae)}if(L._status===1)return L._result.default;throw L._result}var ge=typeof reportError=="function"?reportError:function(L){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var ae=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof L=="object"&&L!==null&&typeof L.message=="string"?String(L.message):String(L),error:L});if(!window.dispatchEvent(ae))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",L);return}console.error(L)},_e={map:j,forEach:function(L,ae,ye){j(L,function(){ae.apply(this,arguments)},ye)},count:function(L){var ae=0;return j(L,function(){ae++}),ae},toArray:function(L){return j(L,function(ae){return ae})||[]},only:function(L){if(!V(L))throw Error("React.Children.only expected to receive a single React element child.");return L}};return rt.Activity=x,rt.Children=_e,rt.Component=v,rt.Fragment=i,rt.Profiler=l,rt.PureComponent=U,rt.StrictMode=r,rt.Suspense=m,rt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=B,rt.__COMPILER_RUNTIME={__proto__:null,c:function(L){return B.H.useMemoCache(L)}},rt.cache=function(L){return function(){return L.apply(null,arguments)}},rt.cacheSignal=function(){return null},rt.cloneElement=function(L,ae,ye){if(L==null)throw Error("The argument must be a React element, but you passed "+L+".");var Ee=C({},L.props),ze=L.key;if(ae!=null)for(ne in ae.key!==void 0&&(ze=""+ae.key),ae)!te.call(ae,ne)||ne==="key"||ne==="__self"||ne==="__source"||ne==="ref"&&ae.ref===void 0||(Ee[ne]=ae[ne]);var ne=arguments.length-2;if(ne===1)Ee.children=ye;else if(1<ne){for(var le=Array(ne),Ce=0;Ce<ne;Ce++)le[Ce]=arguments[Ce+2];Ee.children=le}return w(L.type,ze,Ee)},rt.createContext=function(L){return L={$$typeof:d,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null},L.Provider=L,L.Consumer={$$typeof:u,_context:L},L},rt.createElement=function(L,ae,ye){var Ee,ze={},ne=null;if(ae!=null)for(Ee in ae.key!==void 0&&(ne=""+ae.key),ae)te.call(ae,Ee)&&Ee!=="key"&&Ee!=="__self"&&Ee!=="__source"&&(ze[Ee]=ae[Ee]);var le=arguments.length-2;if(le===1)ze.children=ye;else if(1<le){for(var Ce=Array(le),He=0;He<le;He++)Ce[He]=arguments[He+2];ze.children=Ce}if(L&&L.defaultProps)for(Ee in le=L.defaultProps,le)ze[Ee]===void 0&&(ze[Ee]=le[Ee]);return w(L,ne,ze)},rt.createRef=function(){return{current:null}},rt.forwardRef=function(L){return{$$typeof:h,render:L}},rt.isValidElement=V,rt.lazy=function(L){return{$$typeof:_,_payload:{_status:-1,_result:L},_init:Y}},rt.memo=function(L,ae){return{$$typeof:p,type:L,compare:ae===void 0?null:ae}},rt.startTransition=function(L){var ae=B.T,ye={};B.T=ye;try{var Ee=L(),ze=B.S;ze!==null&&ze(ye,Ee),typeof Ee=="object"&&Ee!==null&&typeof Ee.then=="function"&&Ee.then(N,ge)}catch(ne){ge(ne)}finally{ae!==null&&ye.types!==null&&(ae.types=ye.types),B.T=ae}},rt.unstable_useCacheRefresh=function(){return B.H.useCacheRefresh()},rt.use=function(L){return B.H.use(L)},rt.useActionState=function(L,ae,ye){return B.H.useActionState(L,ae,ye)},rt.useCallback=function(L,ae){return B.H.useCallback(L,ae)},rt.useContext=function(L){return B.H.useContext(L)},rt.useDebugValue=function(){},rt.useDeferredValue=function(L,ae){return B.H.useDeferredValue(L,ae)},rt.useEffect=function(L,ae){return B.H.useEffect(L,ae)},rt.useEffectEvent=function(L){return B.H.useEffectEvent(L)},rt.useId=function(){return B.H.useId()},rt.useImperativeHandle=function(L,ae,ye){return B.H.useImperativeHandle(L,ae,ye)},rt.useInsertionEffect=function(L,ae){return B.H.useInsertionEffect(L,ae)},rt.useLayoutEffect=function(L,ae){return B.H.useLayoutEffect(L,ae)},rt.useMemo=function(L,ae){return B.H.useMemo(L,ae)},rt.useOptimistic=function(L,ae){return B.H.useOptimistic(L,ae)},rt.useReducer=function(L,ae,ye){return B.H.useReducer(L,ae,ye)},rt.useRef=function(L){return B.H.useRef(L)},rt.useState=function(L){return B.H.useState(L)},rt.useSyncExternalStore=function(L,ae,ye){return B.H.useSyncExternalStore(L,ae,ye)},rt.useTransition=function(){return B.H.useTransition()},rt.version="19.2.0",rt}var ix;function ch(){return ix||(ix=1,If.exports=kv()),If.exports}var sa=ch();const Xv=sg(sa);var Hf={exports:{}},Eo={},Gf={exports:{}},Vf={};var ax;function Wv(){return ax||(ax=1,(function(o){function t(O,j){var Y=O.length;O.push(j);e:for(;0<Y;){var ge=Y-1>>>1,_e=O[ge];if(0<l(_e,j))O[ge]=j,O[Y]=_e,Y=ge;else break e}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var j=O[0],Y=O.pop();if(Y!==j){O[0]=Y;e:for(var ge=0,_e=O.length,L=_e>>>1;ge<L;){var ae=2*(ge+1)-1,ye=O[ae],Ee=ae+1,ze=O[Ee];if(0>l(ye,Y))Ee<_e&&0>l(ze,ye)?(O[ge]=ze,O[Ee]=Y,ge=Ee):(O[ge]=ye,O[ae]=Y,ge=ae);else if(Ee<_e&&0>l(ze,Y))O[ge]=ze,O[Ee]=Y,ge=Ee;else break e}}return j}function l(O,j){var Y=O.sortIndex-j.sortIndex;return Y!==0?Y:O.id-j.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var d=Date,h=d.now();o.unstable_now=function(){return d.now()-h}}var m=[],p=[],_=1,x=null,S=3,b=!1,A=!1,C=!1,y=!1,v=typeof setTimeout=="function"?setTimeout:null,P=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function F(O){for(var j=i(p);j!==null;){if(j.callback===null)r(p);else if(j.startTime<=O)r(p),j.sortIndex=j.expirationTime,t(m,j);else break;j=i(p)}}function k(O){if(C=!1,F(O),!A)if(i(m)!==null)A=!0,N||(N=!0,$());else{var j=i(p);j!==null&&fe(k,j.startTime-O)}}var N=!1,B=-1,te=5,w=-1;function R(){return y?!0:!(o.unstable_now()-w<te)}function V(){if(y=!1,N){var O=o.unstable_now();w=O;var j=!0;try{e:{A=!1,C&&(C=!1,P(B),B=-1),b=!0;var Y=S;try{t:{for(F(O),x=i(m);x!==null&&!(x.expirationTime>O&&R());){var ge=x.callback;if(typeof ge=="function"){x.callback=null,S=x.priorityLevel;var _e=ge(x.expirationTime<=O);if(O=o.unstable_now(),typeof _e=="function"){x.callback=_e,F(O),j=!0;break t}x===i(m)&&r(m),F(O)}else r(m);x=i(m)}if(x!==null)j=!0;else{var L=i(p);L!==null&&fe(k,L.startTime-O),j=!1}}break e}finally{x=null,S=Y,b=!1}j=void 0}}finally{j?$():N=!1}}}var $;if(typeof U=="function")$=function(){U(V)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,de=se.port2;se.port1.onmessage=V,$=function(){de.postMessage(null)}}else $=function(){v(V,0)};function fe(O,j){B=v(function(){O(o.unstable_now())},j)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(O){O.callback=null},o.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):te=0<O?Math.floor(1e3/O):5},o.unstable_getCurrentPriorityLevel=function(){return S},o.unstable_next=function(O){switch(S){case 1:case 2:case 3:var j=3;break;default:j=S}var Y=S;S=j;try{return O()}finally{S=Y}},o.unstable_requestPaint=function(){y=!0},o.unstable_runWithPriority=function(O,j){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var Y=S;S=O;try{return j()}finally{S=Y}},o.unstable_scheduleCallback=function(O,j,Y){var ge=o.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?ge+Y:ge):Y=ge,O){case 1:var _e=-1;break;case 2:_e=250;break;case 5:_e=1073741823;break;case 4:_e=1e4;break;default:_e=5e3}return _e=Y+_e,O={id:_++,callback:j,priorityLevel:O,startTime:Y,expirationTime:_e,sortIndex:-1},Y>ge?(O.sortIndex=Y,t(p,O),i(m)===null&&O===i(p)&&(C?(P(B),B=-1):C=!0,fe(k,Y-ge))):(O.sortIndex=_e,t(m,O),A||b||(A=!0,N||(N=!0,$()))),O},o.unstable_shouldYield=R,o.unstable_wrapCallback=function(O){var j=S;return function(){var Y=S;S=j;try{return O.apply(this,arguments)}finally{S=Y}}}})(Vf)),Vf}var rx;function qv(){return rx||(rx=1,Gf.exports=Wv()),Gf.exports}var kf={exports:{}},wn={};var sx;function Yv(){if(sx)return wn;sx=1;var o=ch();function t(m){var p="https://react.dev/errors/"+m;if(1<arguments.length){p+="?args[]="+encodeURIComponent(arguments[1]);for(var _=2;_<arguments.length;_++)p+="&args[]="+encodeURIComponent(arguments[_])}return"Minified React error #"+m+"; visit "+p+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var r={d:{f:i,r:function(){throw Error(t(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},l=Symbol.for("react.portal");function u(m,p,_){var x=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:l,key:x==null?null:""+x,children:m,containerInfo:p,implementation:_}}var d=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function h(m,p){if(m==="font")return"";if(typeof p=="string")return p==="use-credentials"?p:""}return wn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=r,wn.createPortal=function(m,p){var _=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!p||p.nodeType!==1&&p.nodeType!==9&&p.nodeType!==11)throw Error(t(299));return u(m,p,null,_)},wn.flushSync=function(m){var p=d.T,_=r.p;try{if(d.T=null,r.p=2,m)return m()}finally{d.T=p,r.p=_,r.d.f()}},wn.preconnect=function(m,p){typeof m=="string"&&(p?(p=p.crossOrigin,p=typeof p=="string"?p==="use-credentials"?p:"":void 0):p=null,r.d.C(m,p))},wn.prefetchDNS=function(m){typeof m=="string"&&r.d.D(m)},wn.preinit=function(m,p){if(typeof m=="string"&&p&&typeof p.as=="string"){var _=p.as,x=h(_,p.crossOrigin),S=typeof p.integrity=="string"?p.integrity:void 0,b=typeof p.fetchPriority=="string"?p.fetchPriority:void 0;_==="style"?r.d.S(m,typeof p.precedence=="string"?p.precedence:void 0,{crossOrigin:x,integrity:S,fetchPriority:b}):_==="script"&&r.d.X(m,{crossOrigin:x,integrity:S,fetchPriority:b,nonce:typeof p.nonce=="string"?p.nonce:void 0})}},wn.preinitModule=function(m,p){if(typeof m=="string")if(typeof p=="object"&&p!==null){if(p.as==null||p.as==="script"){var _=h(p.as,p.crossOrigin);r.d.M(m,{crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0})}}else p==null&&r.d.M(m)},wn.preload=function(m,p){if(typeof m=="string"&&typeof p=="object"&&p!==null&&typeof p.as=="string"){var _=p.as,x=h(_,p.crossOrigin);r.d.L(m,_,{crossOrigin:x,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0,type:typeof p.type=="string"?p.type:void 0,fetchPriority:typeof p.fetchPriority=="string"?p.fetchPriority:void 0,referrerPolicy:typeof p.referrerPolicy=="string"?p.referrerPolicy:void 0,imageSrcSet:typeof p.imageSrcSet=="string"?p.imageSrcSet:void 0,imageSizes:typeof p.imageSizes=="string"?p.imageSizes:void 0,media:typeof p.media=="string"?p.media:void 0})}},wn.preloadModule=function(m,p){if(typeof m=="string")if(p){var _=h(p.as,p.crossOrigin);r.d.m(m,{as:typeof p.as=="string"&&p.as!=="script"?p.as:void 0,crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0})}else r.d.m(m)},wn.requestFormReset=function(m){r.d.r(m)},wn.unstable_batchedUpdates=function(m,p){return m(p)},wn.useFormState=function(m,p,_){return d.H.useFormState(m,p,_)},wn.useFormStatus=function(){return d.H.useHostTransitionStatus()},wn.version="19.2.0",wn}var ox;function jv(){if(ox)return kf.exports;ox=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(t){console.error(t)}}return o(),kf.exports=Yv(),kf.exports}var lx;function Zv(){if(lx)return Eo;lx=1;var o=qv(),t=ch(),i=jv();function r(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function u(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function d(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function h(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function m(e){if(u(e)!==e)throw Error(r(188))}function p(e){var n=e.alternate;if(!n){if(n=u(e),n===null)throw Error(r(188));return n!==e?null:e}for(var a=e,s=n;;){var c=a.return;if(c===null)break;var f=c.alternate;if(f===null){if(s=c.return,s!==null){a=s;continue}break}if(c.child===f.child){for(f=c.child;f;){if(f===a)return m(c),e;if(f===s)return m(c),n;f=f.sibling}throw Error(r(188))}if(a.return!==s.return)a=c,s=f;else{for(var g=!1,E=c.child;E;){if(E===a){g=!0,a=c,s=f;break}if(E===s){g=!0,s=c,a=f;break}E=E.sibling}if(!g){for(E=f.child;E;){if(E===a){g=!0,a=f,s=c;break}if(E===s){g=!0,s=f,a=c;break}E=E.sibling}if(!g)throw Error(r(189))}}if(a.alternate!==s)throw Error(r(190))}if(a.tag!==3)throw Error(r(188));return a.stateNode.current===a?e:n}function _(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=_(e),n!==null)return n;e=e.sibling}return null}var x=Object.assign,S=Symbol.for("react.element"),b=Symbol.for("react.transitional.element"),A=Symbol.for("react.portal"),C=Symbol.for("react.fragment"),y=Symbol.for("react.strict_mode"),v=Symbol.for("react.profiler"),P=Symbol.for("react.consumer"),U=Symbol.for("react.context"),F=Symbol.for("react.forward_ref"),k=Symbol.for("react.suspense"),N=Symbol.for("react.suspense_list"),B=Symbol.for("react.memo"),te=Symbol.for("react.lazy"),w=Symbol.for("react.activity"),R=Symbol.for("react.memo_cache_sentinel"),V=Symbol.iterator;function $(e){return e===null||typeof e!="object"?null:(e=V&&e[V]||e["@@iterator"],typeof e=="function"?e:null)}var se=Symbol.for("react.client.reference");function de(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===se?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case C:return"Fragment";case v:return"Profiler";case y:return"StrictMode";case k:return"Suspense";case N:return"SuspenseList";case w:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case A:return"Portal";case U:return e.displayName||"Context";case P:return(e._context.displayName||"Context")+".Consumer";case F:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case B:return n=e.displayName||null,n!==null?n:de(e.type)||"Memo";case te:n=e._payload,e=e._init;try{return de(e(n))}catch{}}return null}var fe=Array.isArray,O=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,j=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Y={pending:!1,data:null,method:null,action:null},ge=[],_e=-1;function L(e){return{current:e}}function ae(e){0>_e||(e.current=ge[_e],ge[_e]=null,_e--)}function ye(e,n){_e++,ge[_e]=e.current,e.current=n}var Ee=L(null),ze=L(null),ne=L(null),le=L(null);function Ce(e,n){switch(ye(ne,n),ye(ze,e),ye(Ee,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?Mm(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=Mm(n),e=Em(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}ae(Ee),ye(Ee,e)}function He(){ae(Ee),ae(ze),ae(ne)}function Xe(e){e.memoizedState!==null&&ye(le,e);var n=Ee.current,a=Em(n,e.type);n!==a&&(ye(ze,e),ye(Ee,a))}function lt(e){ze.current===e&&(ae(Ee),ae(ze)),le.current===e&&(ae(le),vo._currentValue=Y)}var $t,dt;function Tt(e){if($t===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);$t=n&&n[1]||"",dt=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+$t+e+dt}var I=!1;function ht(e,n){if(!e||I)return"";I=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var s={DetermineComponentFrameRoot:function(){try{if(n){var me=function(){throw Error()};if(Object.defineProperty(me.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(me,[])}catch(re){var ee=re}Reflect.construct(e,[],me)}else{try{me.call()}catch(re){ee=re}e.call(me.prototype)}}else{try{throw Error()}catch(re){ee=re}(me=e())&&typeof me.catch=="function"&&me.catch(function(){})}}catch(re){if(re&&ee&&typeof re.stack=="string")return[re.stack,ee.stack]}return[null,null]}};s.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var c=Object.getOwnPropertyDescriptor(s.DetermineComponentFrameRoot,"name");c&&c.configurable&&Object.defineProperty(s.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=s.DetermineComponentFrameRoot(),g=f[0],E=f[1];if(g&&E){var z=g.split(`
`),Q=E.split(`
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,pt={alphahash_fragment:Zy,alphahash_pars_fragment:Ky,alphamap_fragment:Qy,alphamap_pars_fragment:Jy,alphatest_fragment:$y,alphatest_pars_fragment:eb,aomap_fragment:tb,aomap_pars_fragment:nb,batching_pars_vertex:ib,batching_vertex:ab,begin_vertex:rb,beginnormal_vertex:sb,bsdfs:ob,iridescence_fragment:lb,bumpmap_pars_fragment:cb,clipping_planes_fragment:ub,clipping_planes_pars_fragment:fb,clipping_planes_pars_vertex:db,clipping_planes_vertex:hb,color_fragment:pb,color_pars_fragment:mb,color_pars_vertex:xb,color_vertex:gb,common:_b,cube_uv_reflection_fragment:vb,defaultnormal_vertex:Sb,displacementmap_pars_vertex:yb,displacementmap_vertex:bb,emissivemap_fragment:Mb,emissivemap_pars_fragment:Eb,colorspace_fragment:Tb,colorspace_pars_fragment:Ab,envmap_fragment:Rb,envmap_common_pars_fragment:Cb,envmap_pars_fragment:wb,envmap_pars_vertex:Db,envmap_physical_pars_fragment:Gb,envmap_vertex:Ub,fog_vertex:Lb,fog_pars_vertex:Nb,fog_fragment:Ob,fog_pars_fragment:zb,gradientmap_pars_fragment:Pb,lightmap_pars_fragment:Bb,lights_lambert_fragment:Fb,lights_lambert_pars_fragment:Ib,lights_pars_begin:Hb,lights_toon_fragment:Vb,lights_toon_pars_fragment:kb,lights_phong_fragment:Xb,lights_phong_pars_fragment:Wb,lights_physical_fragment:qb,lights_physical_pars_fragment:Yb,lights_fragment_begin:jb,lights_fragment_maps:Zb,lights_fragment_end:Kb,logdepthbuf_fragment:Qb,logdepthbuf_pars_fragment:Jb,logdepthbuf_pars_vertex:$b,logdepthbuf_vertex:eM,map_fragment:tM,map_pars_fragment:nM,map_particle_fragment:iM,map_particle_pars_fragment:aM,metalnessmap_fragment:rM,metalnessmap_pars_fragment:sM,morphinstance_vertex:oM,morphcolor_vertex:lM,morphnormal_vertex:cM,morphtarget_pars_vertex:uM,morphtarget_vertex:fM,normal_fragment_begin:dM,normal_fragment_maps:hM,normal_pars_fragment:pM,normal_pars_vertex:mM,normal_vertex:xM,normalmap_pars_fragment:gM,clearcoat_normal_fragment_begin:_M,clearcoat_normal_fragment_maps:vM,clearcoat_pars_fragment:SM,iridescence_pars_fragment:yM,opaque_fragment:bM,packing:MM,premultiplied_alpha_fragment:EM,project_vertex:TM,dithering_fragment:AM,dithering_pars_fragment:RM,roughnessmap_fragment:CM,roughnessmap_pars_fragment:wM,shadowmap_pars_fragment:DM,shadowmap_pars_vertex:UM,shadowmap_vertex:LM,shadowmask_pars_fragment:NM,skinbase_vertex:OM,skinning_pars_vertex:zM,skinning_vertex:PM,skinnormal_vertex:BM,specularmap_fragment:FM,specularmap_pars_fragment:IM,tonemapping_fragment:HM,tonemapping_pars_fragment:GM,transmission_fragment:VM,transmission_pars_fragment:kM,uv_pars_fragment:XM,uv_pars_vertex:WM,uv_vertex:qM,worldpos_vertex:YM,background_vert:jM,background_frag:ZM,backgroundCube_vert:KM,backgroundCube_frag:QM,cube_vert:JM,cube_frag:$M,depth_vert:e3,depth_frag:t3,distanceRGBA_vert:n3,distanceRGBA_frag:i3,equirect_vert:a3,equirect_frag:r3,linedashed_vert:s3,linedashed_frag:o3,meshbasic_vert:l3,meshbasic_frag:c3,meshlambert_vert:u3,meshlambert_frag:f3,meshmatcap_vert:d3,meshmatcap_frag:h3,meshnormal_vert:p3,meshnormal_frag:m3,meshphong_vert:x3,meshphong_frag:g3,meshphysical_vert:_3,meshphysical_frag:v3,meshtoon_vert:S3,meshtoon_frag:y3,points_vert:b3,points_frag:M3,shadow_vert:E3,shadow_frag:T3,sprite_vert:A3,sprite_frag:R3},Ne={common:{diffuse:{value:new Vt(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new ft},alphaMap:{value:null},alphaMapTransform:{value:new ft},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new ft}},envmap:{envMap:{value:null},envMapRotation:{value:new ft},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98},dfgLUT:{value:null}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new ft}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new ft}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new ft},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new ft},normalScale:{value:new Ut(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new ft},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new ft}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new ft}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new ft}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new Vt(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new Vt(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new ft},alphaTest:{value:0},uvTransform:{value:new ft}},sprite:{diffuse:{value:new Vt(16777215)},opacity:{value:1},center:{value:new Ut(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new ft},alphaMap:{value:null},alphaMapTransform:{value:new ft},alphaTest:{value:0}}},wi={basic:{uniforms:Nn([Ne.common,Ne.specularmap,Ne.envmap,Ne.aomap,Ne.lightmap,Ne.fog]),vertexShader:pt.meshbasic_vert,fragmentShader:pt.meshbasic_frag},lambert:{uniforms:Nn([Ne.common,Ne.specularmap,Ne.envmap,Ne.aomap,Ne.lightmap,Ne.emissivemap,Ne.bumpmap,Ne.normalmap,Ne.displacementmap,Ne.fog,Ne.lights,{emissive:{value:new Vt(0)}}]),vertexShader:pt.meshlambert_vert,fragmentShader:pt.meshlambert_frag},phong:{uniforms:Nn([Ne.common,Ne.specularmap,Ne.envmap,Ne.aomap,Ne.lightmap,Ne.emissivemap,Ne.bumpmap,Ne.normalmap,Ne.displacementmap,Ne.fog,Ne.lights,{emissive:{value:new Vt(0)},specular:{value:new Vt(1118481)},shininess:{value:30}}]),vertexShader:pt.meshphong_vert,fragmentShader:pt.meshphong_frag},standard:{uniforms:Nn([Ne.common,Ne.envmap,Ne.aomap,Ne.lightmap,Ne.emissivemap,Ne.bumpmap,Ne.normalmap,Ne.displacementmap,Ne.roughnessmap,Ne.metalnessmap,Ne.fog,Ne.lights,{emissive:{value:new Vt(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:pt.meshphysical_vert,fragmentShader:pt.meshphysical_frag},toon:{uniforms:Nn([Ne.common,Ne.aomap,Ne.lightmap,Ne.emissivemap,Ne.bumpmap,Ne.normalmap,Ne.displacementmap,Ne.gradientmap,Ne.fog,Ne.lights,{emissive:{value:new Vt(0)}}]),vertexShader:pt.meshtoon_vert,fragmentShader:pt.meshtoon_frag},matcap:{uniforms:Nn([Ne.common,Ne.bumpmap,Ne.normalmap,Ne.displacementmap,Ne.fog,{matcap:{value:null}}]),vertexShader:pt.meshmatcap_vert,fragmentShader:pt.meshmatcap_frag},points:{uniforms:Nn([Ne.points,Ne.fog]),vertexShader:pt.points_vert,fragmentShader:pt.points_frag},dashed:{uniforms:Nn([Ne.common,Ne.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:pt.linedashed_vert,fragmentShader:pt.linedashed_frag},depth:{uniforms:Nn([Ne.common,Ne.displacementmap]),vertexShader:pt.depth_vert,fragmentShader:pt.depth_frag},normal:{uniforms:Nn([Ne.common,Ne.bumpmap,Ne.normalmap,Ne.displacementmap,{opacity:{value:1}}]),vertexShader:pt.meshnormal_vert,fragmentShader:pt.meshnormal_frag},sprite:{uniforms:Nn([Ne.sprite,Ne.fog]),vertexShader:pt.sprite_vert,fragmentShader:pt.sprite_frag},background:{uniforms:{uvTransform:{value:new ft},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:pt.background_vert,fragmentShader:pt.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new ft}},vertexShader:pt.backgroundCube_vert,fragmentShader:pt.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:pt.cube_vert,fragmentShader:pt.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:pt.equirect_vert,fragmentShader:pt.equirect_frag},distanceRGBA:{uniforms:Nn([Ne.common,Ne.displacementmap,{referencePosition:{value:new ce},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:pt.distanceRGBA_vert,fragmentShader:pt.distanceRGBA_frag},shadow:{uniforms:Nn([Ne.lights,Ne.fog,{color:{value:new Vt(0)},opacity:{value:1}}]),vertexShader:pt.shadow_vert,fragmentShader:pt.shadow_frag}};wi.physical={uniforms:Nn([wi.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new ft},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new ft},clearcoatNormalScale:{value:new Ut(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new ft},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new ft},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new ft},sheen:{value:0},sheenColor:{value:new Vt(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new ft},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new ft},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new ft},transmissionSamplerSize:{value:new Ut},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new ft},attenuationDistance:{value:0},attenuationColor:{value:new Vt(0)},specularColor:{value:new Vt(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new ft},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new ft},anisotropyVector:{value:new Ut},anisotropyMap:{value:null},anisotropyMapTransform:{value:new ft}}]),vertexShader:pt.meshphysical_vert,fragmentShader:pt.meshphysical_frag};const gc={r:0,b:0,g:0},vr=new ha,C3=new mn;function w3(o,t,i,r,l,u,d){const h=new Vt(0);let m=u===!0?0:1,p,_,x=null,S=0,b=null;function A(U){let F=U.isScene===!0?U.background:null;return F&&F.isTexture&&(F=(U.backgroundBlurriness>0?i:t).get(F)),F}function C(U){let F=!1;const k=A(U);k===null?v(h,m):k&&k.isColor&&(v(k,1),F=!0);const N=o.xr.getEnvironmentBlendMode();N==="additive"?r.buffers.color.setClear(0,0,0,1,d):N==="alpha-blend"&&r.buffers.color.setClear(0,0,0,0,d),(o.autoClear||F)&&(r.buffers.depth.setTest(!0),r.buffers.depth.setMask(!0),r.buffers.color.setMask(!0),o.clear(o.autoClearColor,o.autoClearDepth,o.autoClearStencil))}function y(U,F){const k=A(F);k&&(k.isCubeTexture||k.mapping===Rc)?(_===void 0&&(_=new Li(new Ho(1,1,1),new Mi({name:"BackgroundCubeMaterial",uniforms:Ts(wi.backgroundCube.uniforms),vertexShader:wi.backgroundCube.vertexShader,fragmentShader:wi.backgroundCube.fragmentShader,side:Vn,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),_.geometry.deleteAttribute("normal"),_.geometry.deleteAttribute("uv"),_.onBeforeRender=function(N,B,te){this.matrixWorld.copyPosition(te.matrixWorld)},Object.defineProperty(_.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),l.update(_)),vr.copy(F.backgroundRotation),vr.x*=-1,vr.y*=-1,vr.z*=-1,k.isCubeTexture&&k.isRenderTargetTexture===!1&&(vr.y*=-1,vr.z*=-1),_.material.uniforms.envMap.value=k,_.material.uniforms.flipEnvMap.value=k.isCubeTexture&&k.isRenderTargetTexture===!1?-1:1,_.material.uniforms.backgroundBlurriness.value=F.backgroundBlurriness,_.material.uniforms.backgroundIntensity.value=F.backgroundIntensity,_.material.uniforms.backgroundRotation.value.setFromMatrix4(C3.makeRotationFromEuler(vr)),_.material.toneMapped=Dt.getTransfer(k.colorSpace)!==Gt,(x!==k||S!==k.version||b!==o.toneMapping)&&(_.material.needsUpdate=!0,x=k,S=k.version,b=o.toneMapping),_.layers.enableAll(),U.unshift(_,_.geometry,_.material,0,0,null)):k&&k.isTexture&&(p===void 0&&(p=new Li(new As(2,2),new Mi({name:"BackgroundMaterial",uniforms:Ts(wi.background.uniforms),vertexShader:wi.background.vertexShader,fragmentShader:wi.background.fragmentShader,side:ja,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),p.geometry.deleteAttribute("normal"),Object.defineProperty(p.material,"map",{get:function(){return this.uniforms.t2D.value}}),l.update(p)),p.material.uniforms.t2D.value=k,p.material.uniforms.backgroundIntensity.value=F.backgroundIntensity,p.material.toneMapped=Dt.getTransfer(k.colorSpace)!==Gt,k.matrixAutoUpdate===!0&&k.updateMatrix(),p.material.uniforms.uvTransform.value.copy(k.matrix),(x!==k||S!==k.version||b!==o.toneMapping)&&(p.material.needsUpdate=!0,x=k,S=k.version,b=o.toneMapping),p.layers.enableAll(),U.unshift(p,p.geometry,p.material,0,0,null))}function v(U,F){U.getRGB(gc,Tg(o)),r.buffers.color.setClear(gc.r,gc.g,gc.b,F,d)}function P(){_!==void 0&&(_.geometry.dispose(),_.material.dispose(),_=void 0),p!==void 0&&(p.geometry.dispose(),p.material.dispose(),p=void 0)}return{getClearColor:function(){return h},setClearColor:function(U,F=1){h.set(U),m=F,v(h,m)},getClearAlpha:function(){return m},setClearAlpha:function(U){m=U,v(h,m)},render:C,addToRenderList:y,dispose:P}}function D3(o,t){const i=o.getParameter(o.MAX_VERTEX_ATTRIBS),r={},l=S(null);let u=l,d=!1;function h(R,V,$,se,de){let fe=!1;const O=x(se,$,V);u!==O&&(u=O,p(u.object)),fe=b(R,se,$,de),fe&&A(R,se,$,de),de!==null&&t.update(de,o.ELEMENT_ARRAY_BUFFER),(fe||d)&&(d=!1,F(R,V,$,se),de!==null&&o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,t.get(de).buffer))}function m(){return o.createVertexArray()}function p(R){return o.bindVertexArray(R)}function _(R){return o.deleteVertexArray(R)}function x(R,V,$){const se=$.wireframe===!0;let de=r[R.id];de===void 0&&(de={},r[R.id]=de);let fe=de[V.id];fe===void 0&&(fe={},de[V.id]=fe);let O=fe[se];return O===void 0&&(O=S(m()),fe[se]=O),O}function S(R){const V=[],$=[],se=[];for(let de=0;de<i;de++)V[de]=0,$[de]=0,se[de]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:V,enabledAttributes:$,attributeDivisors:se,object:R,attributes:{},index:null}}function b(R,V,$,se){const de=u.attributes,fe=V.attributes;let O=0;const j=$.getAttributes();for(const Y in j)if(j[Y].location>=0){const _e=de[Y];let L=fe[Y];if(L===void 0&&(Y==="instanceMatrix"&&R.instanceMatrix&&(L=R.instanceMatrix),Y==="instanceColor"&&R.instanceColor&&(L=R.instanceColor)),_e===void 0||_e.attribute!==L||L&&_e.data!==L.data)return!0;O++}return u.attributesNum!==O||u.index!==se}function A(R,V,$,se){const de={},fe=V.attributes;let O=0;const j=$.getAttributes();for(const Y in j)if(j[Y].location>=0){let _e=fe[Y];_e===void 0&&(Y==="instanceMatrix"&&R.instanceMatrix&&(_e=R.instanceMatrix),Y==="instanceColor"&&R.instanceColor&&(_e=R.instanceColor));const L={};L.attribute=_e,_e&&_e.data&&(L.data=_e.data),de[Y]=L,O++}u.attributes=de,u.attributesNum=O,u.index=se}function C(){const R=u.newAttributes;for(let V=0,$=R.length;V<$;V++)R[V]=0}function y(R){v(R,0)}function v(R,V){const $=u.newAttributes,se=u.enabledAttributes,de=u.attributeDivisors;$[R]=1,se[R]===0&&(o.enableVertexAttribArray(R),se[R]=1),de[R]!==V&&(o.vertexAttribDivisor(R,V),de[R]=V)}function P(){const R=u.newAttributes,V=u.enabledAttributes;for(let $=0,se=V.length;$<se;$++)V[$]!==R[$]&&(o.disableVertexAttribArray($),V[$]=0)}function U(R,V,$,se,de,fe,O){O===!0?o.vertexAttribIPointer(R,V,$,de,fe):o.vertexAttribPointer(R,V,$,se,de,fe)}function F(R,V,$,se){C();const de=se.attributes,fe=$.getAttributes(),O=V.defaultAttributeValues;for(const j in fe){const Y=fe[j];if(Y.location>=0){let ge=de[j];if(ge===void 0&&(j==="instanceMatrix"&&R.instanceMatrix&&(ge=R.instanceMatrix),j==="instanceColor"&&R.instanceColor&&(ge=R.instanceColor)),ge!==void 0){const _e=ge.normalized,L=ge.itemSize,ae=t.get(ge);if(ae===void 0)continue;const ye=ae.buffer,Ee=ae.type,ze=ae.bytesPerElement,ne=Ee===o.INT||Ee===o.UNSIGNED_INT||ge.gpuType===fh;if(ge.isInterleavedBufferAttribute){const le=ge.data,Ce=le.stride,He=ge.offset;if(le.isInstancedInterleavedBuffer){for(let Xe=0;Xe<Y.locationSize;Xe++)v(Y.location+Xe,le.meshPerAttribute);R.isInstancedMesh!==!0&&se._maxInstanceCount===void 0&&(se._maxInstanceCount=le.meshPerAttribute*le.count)}else for(let Xe=0;Xe<Y.locationSize;Xe++)y(Y.location+Xe);o.bindBuffer(o.ARRAY_BUFFER,ye);for(let Xe=0;Xe<Y.locationSize;Xe++)U(Y.location+Xe,L/Y.locationSize,Ee,_e,Ce*ze,(He+L/Y.locationSize*Xe)*ze,ne)}else{if(ge.isInstancedBufferAttribute){for(let le=0;le<Y.locationSize;le++)v(Y.location+le,ge.meshPerAttribute);R.isInstancedMesh!==!0&&se._maxInstanceCount===void 0&&(se._maxInstanceCount=ge.meshPerAttribute*ge.count)}else for(let le=0;le<Y.locationSize;le++)y(Y.location+le);o.bindBuffer(o.ARRAY_BUFFER,ye);for(let le=0;le<Y.locationSize;le++)U(Y.location+le,L/Y.locationSize,Ee,_e,L*ze,L/Y.locationSize*le*ze,ne)}}else if(O!==void 0){const _e=O[j];if(_e!==void 0)switch(_e.length){case 2:o.vertexAttrib2fv(Y.location,_e);break;case 3:o.vertexAttrib3fv(Y.location,_e);break;case 4:o.vertexAttrib4fv(Y.location,_e);break;default:o.vertexAttrib1fv(Y.location,_e)}}}}P()}function k(){te();for(const R in r){const V=r[R];for(const $ in V){const se=V[$];for(const de in se)_(se[de].object),delete se[de];delete V[$]}delete r[R]}}function N(R){if(r[R.id]===void 0)return;const V=r[R.id];for(const $ in V){const se=V[$];for(const de in se)_(se[de].object),delete se[de];delete V[$]}delete r[R.id]}function B(R){for(const V in r){const $=r[V];if($[R.id]===void 0)continue;const se=$[R.id];for(const de in se)_(se[de].object),delete se[de];delete $[R.id]}}function te(){w(),d=!0,u!==l&&(u=l,p(u.object))}function w(){l.geometry=null,l.program=null,l.wireframe=!1}return{setup:h,reset:te,resetDefaultState:w,dispose:k,releaseStatesOfGeometry:N,releaseStatesOfProgram:B,initAttributes:C,enableAttribute:y,disableUnusedAttributes:P}}function U3(o,t,i){let r;function l(p){r=p}function u(p,_){o.drawArrays(r,p,_),i.update(_,r,1)}function d(p,_,x){x!==0&&(o.drawArraysInstanced(r,p,_,x),i.update(_,r,x))}function h(p,_,x){if(x===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(r,p,0,_,0,x);let b=0;for(let A=0;A<x;A++)b+=_[A];i.update(b,r,1)}function m(p,_,x,S){if(x===0)return;const b=t.get("WEBGL_multi_draw");if(b===null)for(let A=0;A<p.length;A++)d(p[A],_[A],S[A]);else{b.multiDrawArraysInstancedWEBGL(r,p,0,_,0,S,0,x);let A=0;for(let C=0;C<x;C++)A+=_[C]*S[C];i.update(A,r,1)}}this.setMode=l,this.render=u,this.renderInstances=d,this.renderMultiDraw=h,this.renderMultiDrawInstances=m}function L3(o,t,i,r){let l;function u(){if(l!==void 0)return l;if(t.has("EXT_texture_filter_anisotropic")===!0){const B=t.get("EXT_texture_filter_anisotropic");l=o.getParameter(B.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else l=0;return l}function d(B){return!(B!==bi&&r.convert(B)!==o.getParameter(o.IMPLEMENTATION_COLOR_READ_FORMAT))}function h(B){const te=B===Rs&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(B!==da&&r.convert(B)!==o.getParameter(o.IMPLEMENTATION_COLOR_READ_TYPE)&&B!==ca&&!te)}function m(B){if(B==="highp"){if(o.getShaderPrecisionFormat(o.VERTEX_SHADER,o.HIGH_FLOAT).precision>0&&o.getShaderPrecisionFormat(o.FRAGMENT_SHADER,o.HIGH_FLOAT).precision>0)return"highp";B="mediump"}return B==="mediump"&&o.getShaderPrecisionFormat(o.VERTEX_SHADER,o.MEDIUM_FLOAT).precision>0&&o.getShaderPrecisionFormat(o.FRAGMENT_SHADER,o.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let p=i.precision!==void 0?i.precision:"highp";const _=m(p);_!==p&&(ot("WebGLRenderer:",p,"not supported, using",_,"instead."),p=_);const x=i.logarithmicDepthBuffer===!0,S=i.reversedDepthBuffer===!0&&t.has("EXT_clip_control"),b=o.getParameter(o.MAX_TEXTURE_IMAGE_UNITS),A=o.getParameter(o.MAX_VERTEX_TEXTURE_IMAGE_UNITS),C=o.getParameter(o.MAX_TEXTURE_SIZE),y=o.getParameter(o.MAX_CUBE_MAP_TEXTURE_SIZE),v=o.getParameter(o.MAX_VERTEX_ATTRIBS),P=o.getParameter(o.MAX_VERTEX_UNIFORM_VECTORS),U=o.getParameter(o.MAX_VARYING_VECTORS),F=o.getParameter(o.MAX_FRAGMENT_UNIFORM_VECTORS),k=A>0,N=o.getParameter(o.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:u,getMaxPrecision:m,textureFormatReadable:d,textureTypeReadable:h,precision:p,logarithmicDepthBuffer:x,reversedDepthBuffer:S,maxTextures:b,maxVertexTextures:A,maxTextureSize:C,maxCubemapSize:y,maxAttributes:v,maxVertexUniforms:P,maxVaryings:U,maxFragmentUniforms:F,vertexTextures:k,maxSamples:N}}function N3(o){const t=this;let i=null,r=0,l=!1,u=!1;const d=new yr,h=new ft,m={value:null,needsUpdate:!1};this.uniform=m,this.numPlanes=0,this.numIntersection=0,this.init=function(x,S){const b=x.length!==0||S||r!==0||l;return l=S,r=x.length,b},this.beginShadows=function(){u=!0,_(null)},this.endShadows=function(){u=!1},this.setGlobalState=function(x,S){i=_(x,S,0)},this.setState=function(x,S,b){const A=x.clippingPlanes,C=x.clipIntersection,y=x.clipShadows,v=o.get(x);if(!l||A===null||A.length===0||u&&!y)u?_(null):p();else{const P=u?0:r,U=P*4;let F=v.clippingState||null;m.value=F,F=_(A,S,U,b);for(let k=0;k!==U;++k)F[k]=i[k];v.clippingState=F,this.numIntersection=C?this.numPlanes:0,this.numPlanes+=P}};function p(){m.value!==i&&(m.value=i,m.needsUpdate=r>0),t.numPlanes=r,t.numIntersection=0}function _(x,S,b,A){const C=x!==null?x.length:0;let y=null;if(C!==0){if(y=m.value,A!==!0||y===null){const v=b+C*4,P=S.matrixWorldInverse;h.getNormalMatrix(P),(y===null||y.length<v)&&(y=new Float32Array(v));for(let U=0,F=b;U!==C;++U,F+=4)d.copy(x[U]).applyMatrix4(P,h),d.normal.toArray(y,F),y[F+3]=d.constant}m.value=y,m.needsUpdate=!0}return t.numPlanes=C,t.numIntersection=0,y}}function O3(o){let t=new WeakMap;function i(d,h){return h===wd?d.mapping=bs:h===Dd&&(d.mapping=Ms),d}function r(d){if(d&&d.isTexture){const h=d.mapping;if(h===wd||h===Dd)if(t.has(d)){const m=t.get(d).texture;return i(m,d.mapping)}else{const m=d.image;if(m&&m.height>0){const p=new By(m.height);return p.fromEquirectangularTexture(o,d),t.set(d,p),d.addEventListener("dispose",l),i(p.texture,d.mapping)}else return null}}return d}function l(d){const h=d.target;h.removeEventListener("dispose",l);const m=t.get(h);m!==void 0&&(t.delete(h),m.dispose())}function u(){t=new WeakMap}return{get:r,dispose:u}}const qa=4,Bx=[.125,.215,.35,.446,.526,.582],Mr=20,z3=256,Do=new Ug,Fx=new Vt;let md=null,xd=0,gd=0,_d=!1;const P3=new ce;class Ix{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._sizeLods=[],this._sigmas=[],this._lodMeshes=[],this._backgroundBox=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._blurMaterial=null,this._ggxMaterial=null}fromScene(t,i=0,r=.1,l=100,u={}){const{size:d=256,position:h=P3}=u;md=this._renderer.getRenderTarget(),xd=this._renderer.getActiveCubeFace(),gd=this._renderer.getActiveMipmapLevel(),_d=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(d);const m=this._allocateTargets();return m.depthBuffer=!0,this._sceneToCubeUV(t,r,l,m,h),i>0&&this._blur(m,0,0,i),this._applyPMREM(m),this._cleanup(m),m}fromEquirectangular(t,i=null){return this._fromTexture(t,i)}fromCubemap(t,i=null){return this._fromTexture(t,i)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=Vx(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Gx(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose(),this._backgroundBox!==null&&(this._backgroundBox.geometry.dispose(),this._backgroundBox.material.dispose())}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._ggxMaterial!==null&&this._ggxMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodMeshes.length;t++)this._lodMeshes[t].geometry.dispose()}_cleanup(t){this._renderer.setRenderTarget(md,xd,gd),this._renderer.xr.enabled=_d,t.scissorTest=!1,_s(t,0,0,t.width,t.height)}_fromTexture(t,i){t.mapping===bs||t.mapping===Ms?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),md=this._renderer.getRenderTarget(),xd=this._renderer.getActiveCubeFace(),gd=this._renderer.getActiveMipmapLevel(),_d=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const r=i||this._allocateTargets();return this._textureToCubeUV(t,r),this._applyPMREM(r),this._cleanup(r),r}_allocateTargets(){const t=3*Math.max(this._cubeSize,112),i=4*this._cubeSize,r={magFilter:di,minFilter:di,generateMipmaps:!1,type:Rs,format:bi,colorSpace:Es,depthBuffer:!1},l=Hx(t,i,r);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==i){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=Hx(t,i,r);const{_lodMax:u}=this;({lodMeshes:this._lodMeshes,sizeLods:this._sizeLods,sigmas:this._sigmas}=B3(u)),this._blurMaterial=I3(u,t,i)}return l}_compileMaterial(t){const i=new Li(new Ka,t);this._renderer.compile(i,Do)}_sceneToCubeUV(t,i,r,l,u){const m=new Si(90,1,i,r),p=[1,-1,1,1,1,1],_=[1,1,1,-1,-1,-1],x=this._renderer,S=x.autoClear,b=x.toneMapping;x.getClearColor(Fx),x.toneMapping=Ya,x.autoClear=!1,x.state.buffers.depth.getReversed()&&(x.setRenderTarget(l),x.clearDepth(),x.setRenderTarget(null)),this._backgroundBox===null&&(this._backgroundBox=new Li(new Ho,new bg({name:"PMREM.Background",side:Vn,depthWrite:!1,depthTest:!1})));const C=this._backgroundBox,y=C.material;let v=!1;const P=t.background;P?P.isColor&&(y.color.copy(P),t.background=null,v=!0):(y.color.copy(Fx),v=!0);for(let U=0;U<6;U++){const F=U%3;F===0?(m.up.set(0,p[U],0),m.position.set(u.x,u.y,u.z),m.lookAt(u.x+_[U],u.y,u.z)):F===1?(m.up.set(0,0,p[U]),m.position.set(u.x,u.y,u.z),m.lookAt(u.x,u.y+_[U],u.z)):(m.up.set(0,p[U],0),m.position.set(u.x,u.y,u.z),m.lookAt(u.x,u.y,u.z+_[U]));const k=this._cubeSize;_s(l,F*k,U>2?k:0,k,k),x.setRenderTarget(l),v&&x.render(C,m),x.render(t,m)}x.toneMapping=b,x.autoClear=S,t.background=P}_textureToCubeUV(t,i){const r=this._renderer,l=t.mapping===bs||t.mapping===Ms;l?(this._cubemapMaterial===null&&(this._cubemapMaterial=Vx()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Gx());const u=l?this._cubemapMaterial:this._equirectMaterial,d=this._lodMeshes[0];d.material=u;const h=u.uniforms;h.envMap.value=t;const m=this._cubeSize;_s(i,0,0,3*m,2*m),r.setRenderTarget(i),r.render(d,Do)}_applyPMREM(t){const i=this._renderer,r=i.autoClear;i.autoClear=!1;const l=this._lodMeshes.length;for(let u=1;u<l;u++)this._applyGGXFilter(t,u-1,u);i.autoClear=r}_applyGGXFilter(t,i,r){const l=this._renderer,u=this._pingPongRenderTarget;if(this._ggxMaterial===null){const P=3*Math.max(this._cubeSize,16),U=4*this._cubeSize;this._ggxMaterial=F3(this._lodMax,P,U)}const d=this._ggxMaterial,h=this._lodMeshes[r];h.material=d;const m=d.uniforms,p=r/(this._lodMeshes.length-1),_=i/(this._lodMeshes.length-1),x=Math.sqrt(p*p-_*_),S=.05+p*.95,b=x*S,{_lodMax:A}=this,C=this._sizeLods[r],y=3*C*(r>A-qa?r-A+qa:0),v=4*(this._cubeSize-C);m.envMap.value=t.texture,m.roughness.value=b,m.mipInt.value=A-i,_s(u,y,v,3*C,2*C),l.setRenderTarget(u),l.render(h,Do),m.envMap.value=u.texture,m.roughness.value=0,m.mipInt.value=A-r,_s(t,y,v,3*C,2*C),l.setRenderTarget(t),l.render(h,Do)}_blur(t,i,r,l,u){const d=this._pingPongRenderTarget;this._halfBlur(t,d,i,r,l,"latitudinal",u),this._halfBlur(d,t,r,r,l,"longitudinal",u)}_halfBlur(t,i,r,l,u,d,h){const m=this._renderer,p=this._blurMaterial;d!=="latitudinal"&&d!=="longitudinal"&&nn("blur direction must be either latitudinal or longitudinal!");const _=3,x=this._lodMeshes[l];x.material=p;const S=p.uniforms,b=this._sizeLods[r]-1,A=isFinite(u)?Math.PI/(2*b):2*Math.PI/(2*Mr-1),C=u/A,y=isFinite(u)?1+Math.floor(_*C):Mr;y>Mr&&ot(`sigmaRadians, ${u}, is too large and will clip, as it requested ${y} samples when the maximum is set to ${Mr}`);const v=[];let P=0;for(let B=0;B<Mr;++B){const te=B/C,w=Math.exp(-te*te/2);v.push(w),B===0?P+=w:B<y&&(P+=2*w)}for(let B=0;B<v.length;B++)v[B]=v[B]/P;S.envMap.value=t.texture,S.samples.value=y,S.weights.value=v,S.latitudinal.value=d==="latitudinal",h&&(S.poleAxis.value=h);const{_lodMax:U}=this;S.dTheta.value=A,S.mipInt.value=U-r;const F=this._sizeLods[l],k=3*F*(l>U-qa?l-U+qa:0),N=4*(this._cubeSize-F);_s(i,k,N,3*F,2*F),m.setRenderTarget(i),m.render(x,Do)}}function B3(o){const t=[],i=[],r=[];let l=o;const u=o-qa+1+Bx.length;for(let d=0;d<u;d++){const h=Math.pow(2,l);t.push(h);let m=1/h;d>o-qa?m=Bx[d-o+qa-1]:d===0&&(m=0),i.push(m);const p=1/(h-2),_=-p,x=1+p,S=[_,_,x,_,x,x,_,_,x,x,_,x],b=6,A=6,C=3,y=2,v=1,P=new Float32Array(C*A*b),U=new Float32Array(y*A*b),F=new Float32Array(v*A*b);for(let N=0;N<b;N++){const B=N%3*2/3-1,te=N>2?0:-1,w=[B,te,0,B+2/3,te,0,B+2/3,te+1,0,B,te,0,B+2/3,te+1,0,B,te+1,0];P.set(w,C*A*N),U.set(S,y*A*N);const R=[N,N,N,N,N,N];F.set(R,v*A*N)}const k=new Ka;k.setAttribute("position",new Ui(P,C)),k.setAttribute("uv",new Ui(U,y)),k.setAttribute("faceIndex",new Ui(F,v)),r.push(new Li(k,null)),l>qa&&l--}return{lodMeshes:r,sizeLods:t,sigmas:i}}function Hx(o,t,i){const r=new Za(o,t,i);return r.texture.mapping=Rc,r.texture.name="PMREM.cubeUv",r.scissorTest=!0,r}function _s(o,t,i,r,l){o.viewport.set(t,i,r,l),o.scissor.set(t,i,r,l)}function F3(o,t,i){return new Mi({name:"PMREMGGXConvolution",defines:{GGX_SAMPLES:z3,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},roughness:{value:0},mipInt:{value:0}},vertexShader:wc(),fragmentShader:`
		...
		`,blending:ua,depthTest:!1,depthWrite:!1})}function I3(o,t,i){const r=new Float32Array(Mr),l=new ce(0,1,0);return new Mi({name:"SphericalGaussianBlur",defines:{n:Mr,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:wc(),fragmentShader:`
	...
	`}function H3(o){let t=new WeakMap,i=null;function r(h){if(h&&h.isTexture){const m=h.mapping,p=m===wd||m===Dd,_=m===bs||m===Ms;if(p||_){let x=t.get(h);const S=x!==void 0?x.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==S)return i===null&&(i=new Ix(o)),x=p?i.fromEquirectangular(h,x):i.fromCubemap(h,x),x.texture.pmremVersion=h.pmremVersion,t.set(h,x),x.texture;if(x!==void 0)return x.texture;{const b=h.image;return p&&b&&b.height>0||_&&b&&l(b)?(i===null&&(i=new Ix(o)),x=p?i.fromEquirectangular(h):i.fromCubemap(h),x.texture.pmremVersion=h.pmremVersion,t.set(h,x),h.addEventListener("dispose",u),x.texture):null}}}return h}function l(h){let m=0;const p=6;for(let _=0;_<p;_++)h[_]!==void 0&&m++;return m===p}function u(h){const m=h.target;m.removeEventListener("dispose",u);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function d(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:d}}function G3(o){const t={};function i(r){if(t[r]!==void 0)return t[r];const l=o.getExtension(r);return t[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&Po("WebGLRenderer: "+r+" extension not supported."),l}}}function V3(o,t,i,r){const l={},u=new WeakMap;function d(x){const S=x.target;S.index!==null&&t.remove(S.index);for(const A in S.attributes)t.remove(S.attributes[A]);S.removeEventListener("dispose",d),delete l[S.id];const b=u.get(S);b&&(t.remove(b),u.delete(S)),r.releaseStatesOfGeometry(S),S.isInstancedBufferGeometry===!0&&delete S._maxInstanceCount,i.memory.geometries--}function h(x,S){return l[S.id]===!0||(S.addEventListener("dispose",d),l[S.id]=!0,i.memory.geometries++),S}function m(x){const S=x.attributes;for(const b in S)t.update(S[b],o.ARRAY_BUFFER)}function p(x){const S=[],b=x.index,A=x.attributes.position;let C=0;if(b!==null){const P=b.array;C=b.version;for(let U=0,F=P.length;U<F;U+=3){const k=P[U+0],N=P[U+1],B=P[U+2];S.push(k,N,N,B,B,k)}}else if(A!==void 0){const P=A.array;C=A.version;for(let U=0,F=P.length/3-1;U<F;U+=3){const k=U+0,N=U+1,B=U+2;S.push(k,N,N,B,B,k)}}else return;const y=new(_g(S)?Eg:Mg)(S,1);y.version=C;const v=u.get(x);v&&t.remove(v),u.set(x,y)}function _(x){const S=u.get(x);if(S){const b=x.index;b!==null&&S.version<b.version&&p(x)}else p(x);return u.get(x)}return{get:h,update:m,getWireframeAttribute:_}}function k3(o,t,i){let r;function l(S){r=S}let u,d;function h(S){u=S.type,d=S.bytesPerElement}function m(S,b){o.drawElements(r,b,u,S*d),i.update(b,r,1)}function p(S,b,A){A!==0&&(o.drawElementsInstanced(r,b,u,S*d,A),i.update(b,r,A))}function _(S,b,A){if(A===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,b,0,u,S,0,A);let y=0;for(let v=0;v<A;v++)y+=b[v];i.update(y,r,1)}function x(S,b,A,C){if(A===0)return;const y=t.get("WEBGL_multi_draw");if(y===null)for(let v=0;v<S.length;v++)p(S[v]/d,b[v],C[v]);else{y.multiDrawElementsInstancedWEBGL(r,b,0,u,S,0,C,0,A);let v=0;for(let P=0;P<A;P++)v+=b[P]*C[P];i.update(v,r,1)}}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=_,this.renderMultiDrawInstances=x}function X3(o){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(u,d,h){switch(i.calls++,d){case o.TRIANGLES:i.triangles+=h*(u/3);break;case o.LINES:i.lines+=h*(u/2);break;case o.LINE_STRIP:i.lines+=h*(u-1);break;case o.LINE_LOOP:i.lines+=h*u;break;case o.POINTS:i.points+=h*u;break;default:nn("WebGLInfo: Unknown draw mode:",d);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:r}}function W3(o,t,i){const r=new WeakMap,l=new an;function u(d,h,m){const p=d.morphTargetInfluences,_=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,x=_!==void 0?_.length:0;let S=r.get(h);if(S===void 0||S.count!==x){let R=function(){te.dispose(),r.delete(h),h.removeEventListener("dispose",R)};var b=R;S!==void 0&&S.texture.dispose();const A=h.morphAttributes.position!==void 0,C=h.morphAttributes.normal!==void 0,y=h.morphAttributes.color!==void 0,v=h.morphAttributes.position||[],P=h.morphAttributes.normal||[],U=h.morphAttributes.color||[];let F=0;A===!0&&(F=1),C===!0&&(F=2),y===!0&&(F=3);let k=h.attributes.position.count*F,N=1;k>t.maxTextureSize&&(N=Math.ceil(k/t.maxTextureSize),k=t.maxTextureSize);const B=new Float32Array(k*N*4*x),te=new vg(B,k,N,x);te.type=ca,te.needsUpdate=!0;const w=F*4;for(let V=0;V<x;V++){const $=v[V],se=P[V],de=U[V],fe=k*N*4*V;for(let O=0;O<$.count;O++){const j=O*w;A===!0&&(l.fromBufferAttribute($,O),B[fe+j+0]=l.x,B[fe+j+1]=l.y,B[fe+j+2]=l.z,B[fe+j+3]=0),C===!0&&(l.fromBufferAttribute(se,O),B[fe+j+4]=l.x,B[fe+j+5]=l.y,B[fe+j+6]=l.z,B[fe+j+7]=0),y===!0&&(l.fromBufferAttribute(de,O),B[fe+j+8]=l.x,B[fe+j+9]=l.y,B[fe+j+10]=l.z,B[fe+j+11]=de.itemSize===4?l.w:1)}}S={count:x,texture:te,size:new Ut(k,N)},r.set(h,S),h.addEventListener("dispose",R)}if(d.isInstancedMesh===!0&&d.morphTexture!==null)m.getUniforms().setValue(o,"morphTexture",d.morphTexture,i);else{let A=0;for(let y=0;y<p.length;y++)A+=p[y];const C=h.morphTargetsRelative?1:1-A;m.getUniforms().setValue(o,"morphTargetBaseInfluence",C),m.getUniforms().setValue(o,"morphTargetInfluences",p)}m.getUniforms().setValue(o,"morphTargetsTexture",S.texture,i),m.getUniforms().setValue(o,"morphTargetsTextureSize",S.size)}return{update:u}}function q3(o,t,i,r){let l=new WeakMap;function u(m){const p=r.render.frame,_=m.geometry,x=t.get(m,_);if(l.get(x)!==p&&(t.update(x),l.set(x,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",h)===!1&&m.addEventListener("dispose",h),l.get(m)!==p&&(i.update(m.instanceMatrix,o.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,o.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const S=m.skeleton;l.get(S)!==p&&(S.update(),l.set(S,p))}return x}function d(){l=new WeakMap}function h(m){const p=m.target;p.removeEventListener("dispose",h),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:u,dispose:d}}const Ng=new On,kx=new wg(1,1),Og=new vg,zg=new vy,Pg=new Rg,Xx=[],Wx=[],qx=new Float32Array(16),Yx=new Float32Array(9),jx=new Float32Array(4);function ws(o,t,i){const r=o[0];if(r<=0||r>0)return o;const l=t*i;let u=Xx[l];if(u===void 0&&(u=new Float32Array(l),Xx[l]=u),t!==0){r.toArray(u,0);for(let d=1,h=0;d!==t;++d)h+=i,o[d].toArray(u,h)}return u}function xn(o,t){if(o.length!==t.length)return!1;for(let i=0,r=o.length;i<r;i++)if(o[i]!==t[i])return!1;return!0}function gn(o,t){for(let i=0,r=t.length;i<r;i++)o[i]=t[i]}function Dc(o,t){let i=Wx[t];i===void 0&&(i=new Int32Array(t),Wx[t]=i);for(let r=0;r!==t;++r)i[r]=o.allocateTextureUnit();return i}function Y3(o,t){const i=this.cache;i[0]!==t&&(o.uniform1f(this.addr,t),i[0]=t)}function j3(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(o.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(xn(i,t))return;o.uniform2fv(this.addr,t),gn(i,t)}}function Z3(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(o.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(o.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(xn(i,t))return;o.uniform3fv(this.addr,t),gn(i,t)}}function K3(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(o.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(xn(i,t))return;o.uniform4fv(this.addr,t),gn(i,t)}}function Q3(o,t){const i=this.cache,r=t.elements;if(r===void 0){if(xn(i,t))return;o.uniformMatrix2fv(this.addr,!1,t),gn(i,t)}else{if(xn(i,r))return;jx.set(r),o.uniformMatrix2fv(this.addr,!1,jx),gn(i,r)}}function J3(o,t){const i=this.cache,r=t.elements;if(r===void 0){if(xn(i,t))return;o.uniformMatrix3fv(this.addr,!1,t),gn(i,t)}else{if(xn(i,r))return;Yx.set(r),o.uniformMatrix3fv(this.addr,!1,Yx),gn(i,r)}}function $3(o,t){const i=this.cache,r=t.elements;if(r===void 0){if(xn(i,t))return;o.uniformMatrix4fv(this.addr,!1,t),gn(i,t)}else{if(xn(i,r))return;qx.set(r),o.uniformMatrix4fv(this.addr,!1,qx),gn(i,r)}}function e1(o,t){const i=this.cache;i[0]!==t&&(o.uniform1i(this.addr,t),i[0]=t)}function t1(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(o.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(xn(i,t))return;o.uniform2iv(this.addr,t),gn(i,t)}}function n1(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(o.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(xn(i,t))return;o.uniform3iv(this.addr,t),gn(i,t)}}function i1(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(o.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(xn(i,t))return;o.uniform4iv(this.addr,t),gn(i,t)}}function a1(o,t){const i=this.cache;i[0]!==t&&(o.uniform1ui(this.addr,t),i[0]=t)}function r1(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(o.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(xn(i,t))return;o.uniform2uiv(this.addr,t),gn(i,t)}}function s1(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(o.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(xn(i,t))return;o.uniform3uiv(this.addr,t),gn(i,t)}}function o1(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(o.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(xn(i,t))return;o.uniform4uiv(this.addr,t),gn(i,t)}}function l1(o,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(o.uniform1i(this.addr,l),r[0]=l);let u;this.type===o.SAMPLER_2D_SHADOW?(kx.compareFunction=gg,u=kx):u=Ng,i.setTexture2D(t||u,l)}function c1(o,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(o.uniform1i(this.addr,l),r[0]=l),i.setTexture3D(t||zg,l)}function u1(o,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(o.uniform1i(this.addr,l),r[0]=l),i.setTextureCube(t||Pg,l)}function f1(o,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(o.uniform1i(this.addr,l),r[0]=l),i.setTexture2DArray(t||Og,l)}function d1(o){switch(o){case 5126:return Y3;case 35664:return j3;case 35665:return Z3;case 35666:return K3;case 35674:return Q3;case 35675:return J3;case 35676:return $3;case 5124:case 35670:return e1;case 35667:case 35671:return t1;case 35668:case 35672:return n1;case 35669:case 35673:return i1;case 5125:return a1;case 36294:return r1;case 36295:return s1;case 36296:return o1;case 35678:case 36198:case 36298:case 36306:case 35682:return l1;case 35679:case 36299:case 36307:return c1;case 35680:case 36300:case 36308:case 36293:return u1;case 36289:case 36303:case 36311:case 36292:return f1}}function h1(o,t){o.uniform1fv(this.addr,t)}function p1(o,t){const i=ws(t,this.size,2);o.uniform2fv(this.addr,i)}function m1(o,t){const i=ws(t,this.size,3);o.uniform3fv(this.addr,i)}function x1(o,t){const i=ws(t,this.size,4);o.uniform4fv(this.addr,i)}function g1(o,t){const i=ws(t,this.size,4);o.uniformMatrix2fv(this.addr,!1,i)}function _1(o,t){const i=ws(t,this.size,9);o.uniformMatrix3fv(this.addr,!1,i)}function v1(o,t){const i=ws(t,this.size,16);o.uniformMatrix4fv(this.addr,!1,i)}function S1(o,t){o.uniform1iv(this.addr,t)}function y1(o,t){o.uniform2iv(this.addr,t)}function b1(o,t){o.uniform3iv(this.addr,t)}function M1(o,t){o.uniform4iv(this.addr,t)}function E1(o,t){o.uniform1uiv(this.addr,t)}function T1(o,t){o.uniform2uiv(this.addr,t)}function A1(o,t){o.uniform3uiv(this.addr,t)}function R1(o,t){o.uniform4uiv(this.addr,t)}function C1(o,t,i){const r=this.cache,l=t.length,u=Dc(i,l);xn(r,u)||(o.uniform1iv(this.addr,u),gn(r,u));for(let d=0;d!==l;++d)i.setTexture2D(t[d]||Ng,u[d])}function w1(o,t,i){const r=this.cache,l=t.length,u=Dc(i,l);xn(r,u)||(o.uniform1iv(this.addr,u),gn(r,u));for(let d=0;d!==l;++d)i.setTexture3D(t[d]||zg,u[d])}function D1(o,t,i){const r=this.cache,l=t.length,u=Dc(i,l);xn(r,u)||(o.uniform1iv(this.addr,u),gn(r,u));for(let d=0;d!==l;++d)i.setTextureCube(t[d]||Pg,u[d])}function U1(o,t,i){const r=this.cache,l=t.length,u=Dc(i,l);xn(r,u)||(o.uniform1iv(this.addr,u),gn(r,u));for(let d=0;d!==l;++d)i.setTexture2DArray(t[d]||Og,u[d])}function L1(o){switch(o){case 5126:return h1;case 35664:return p1;case 35665:return m1;case 35666:return x1;case 35674:return g1;case 35675:return _1;case 35676:return v1;case 5124:case 35670:return S1;case 35667:case 35671:return y1;case 35668:case 35672:return b1;case 35669:case 35673:return M1;case 5125:return E1;case 36294:return T1;case 36295:return A1;case 36296:return R1;case 35678:case 36198:case 36298:case 36306:case 35682:return C1;case 35679:case 36299:case 36307:return w1;case 35680:case 36300:case 36308:case 36293:return D1;case 36289:case 36303:case 36311:case 36292:return U1}}class N1{constructor(t,i,r){this.id=t,this.addr=r,this.cache=[],this.type=i.type,this.setValue=d1(i.type)}}class O1{constructor(t,i,r){this.id=t,this.addr=r,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=L1(i.type)}}class z1{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,i,r){const l=this.seq;for(let u=0,d=l.length;u!==d;++u){const h=l[u];h.setValue(t,i[h.id],r)}}}const vd=/(\w+)(\])?(\[|\.)?/g;function Zx(o,t){o.seq.push(t),o.map[t.id]=t}function P1(o,t,i){const r=o.name,l=r.length;for(vd.lastIndex=0;;){const u=vd.exec(r),d=vd.lastIndex;let h=u[1];const m=u[2]==="]",p=u[3];if(m&&(h=h|0),p===void 0||p==="["&&d+2===l){Zx(i,p===void 0?new N1(h,o,t):new O1(h,o,t));break}else{let x=i.map[h];x===void 0&&(x=new z1(h),Zx(i,x)),i=x}}}class Mc{constructor(t,i){this.seq=[],this.map={};const r=t.getProgramParameter(i,t.ACTIVE_UNIFORMS);for(let l=0;l<r;++l){const u=t.getActiveUniform(i,l),d=t.getUniformLocation(i,u.name);P1(u,d,this)}}setValue(t,i,r,l){const u=this.map[i];u!==void 0&&u.setValue(t,r,l)}setOptional(t,i,r){const l=i[r];l!==void 0&&this.setValue(t,r,l)}static upload(t,i,r,l){for(let u=0,d=i.length;u!==d;++u){const h=i[u],m=r[h.id];m.needsUpdate!==!1&&h.setValue(t,m.value,l)}}static seqWithValue(t,i){const r=[];for(let l=0,u=t.length;l!==u;++l){const d=t[l];d.id in i&&r.push(d)}return r}}function Kx(o,t,i){const r=o.createShader(t);return o.shaderSource(r,i),o.compileShader(r),r}const B1=37297;let F1=0;function I1(o,t){const i=o.split(`
`),r=[],l=Math.max(t-6,0),u=Math.min(t+6,i.length);for(let d=l;d<u;d++){const h=d+1;r.push(`${h===t?">":" "} ${h}: ${i[d]}`)}return r.join(`
`)}const Qx=new ft;function H1(o){Dt._getMatrix(Qx,Dt.workingColorSpace,o);const t=`mat3( ${Qx.elements.map(i=>i.toFixed(4))} )`;switch(Dt.getTransfer(o)){case Ec:return[t,"LinearTransferOETF"];case Gt:return[t,"sRGBTransferOETF"];default:return ot("WebGLProgram: Unsupported color space: ",o),[t,"LinearTransferOETF"]}}function Jx(o,t,i){const r=o.getShaderParameter(t,o.COMPILE_STATUS),u=(o.getShaderInfoLog(t)||"").trim();if(r&&u==="")return"";const d=/ERROR: 0:(\d+)/.exec(u);if(d){const h=parseInt(d[1]);return i.toUpperCase()+`

`+u+`

`+I1(o.getShaderSource(t),h)}else return u}function G1(o,t){const i=H1(t);return[`vec4 ${o}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function V1(o,t){let i;switch(t){case qS:i="Linear";break;case YS:i="Reinhard";break;case jS:i="Cineon";break;case ZS:i="ACESFilmic";break;case QS:i="AgX";break;case JS:i="Neutral";break;case KS:i="Custom";break;default:ot("WebGLProgram: Unsupported toneMapping:",t),i="Linear"}return"vec3 "+o+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const _c=new ce;function k1(){Dt.getLuminanceCoefficients(_c);const o=_c.x.toFixed(4),t=_c.y.toFixed(4),i=_c.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function X1(o){return[o.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",o.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Uo).join(`
`)}function W1(o){const t=[];for(const i in o){const r=o[i];r!==!1&&t.push("#define "+i+" "+r)}return t.join(`
`)}function q1(o,t){const i={},r=o.getProgramParameter(t,o.ACTIVE_ATTRIBUTES);for(let l=0;l<r;l++){const u=o.getActiveAttrib(t,l),d=u.name;let h=1;u.type===o.FLOAT_MAT2&&(h=2),u.type===o.FLOAT_MAT3&&(h=3),u.type===o.FLOAT_MAT4&&(h=4),i[d]={type:u.type,location:o.getAttribLocation(t,d),locationSize:h}}return i}function Uo(o){return o!==""}function $x(o,t){const i=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function eg(o,t){return o.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Y1=/^[ \t]*#include +<([\w\d./]+)>/gm;function lh(o){return o.replace(Y1,Z1)}const j1=new Map;function Z1(o,t){let i=pt[t];if(i===void 0){const r=j1.get(t);if(r!==void 0)i=pt[r],ot('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,r);else throw new Error("Can not resolve #include <"+t+">")}return lh(i)}const K1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function tg(o){return o.replace(K1,Q1)}function Q1(o,t,i,r){let l="";for(let u=parseInt(t);u<parseInt(i);u++)l+=r.replace(/\[\s*i\s*\]/g,"[ "+u+" ]").replace(/UNROLLED_LOOP_INDEX/g,u);return l}function ng(o){let t=`precision ${o.precision} float;
...
#define LOW_PRECISION`),t}function J1(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===og?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===TS?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===ra&&(t="SHADOWMAP_TYPE_VSM"),t}function $1(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case bs:case Ms:t="ENVMAP_TYPE_CUBE";break;case Rc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function eE(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Ms:t="ENVMAP_MODE_REFRACTION";break}return t}function tE(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case lg:t="ENVMAP_BLENDING_MULTIPLY";break;case XS:t="ENVMAP_BLENDING_MIX";break;case WS:t="ENVMAP_BLENDING_ADD";break}return t}function nE(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function iE(o,t,i,r){const l=o.getContext(),u=i.defines;let d=i.vertexShader,h=i.fragmentShader;const m=J1(i),p=$1(i),_=eE(i),x=tE(i),S=nE(i),b=X1(i),A=W1(u),C=l.createProgram();let y,v,P=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+v);const U=P+y+d,F=P+v+h,k=Kx(l,l.VERTEX_SHADER,U),N=Kx(l,l.FRAGMENT_SHADER,F);l.attachShader(C,k),l.attachShader(C,N),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function B(V){if(o.debug.checkShaderErrors){const $=l.getProgramInfoLog(C)||"",se=l.getShaderInfoLog(k)||"",de=l.getShaderInfoLog(N)||"",fe=$.trim(),O=se.trim(),j=de.trim();let Y=!0,ge=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(Y=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,k,N);else{const _e=Jx(l,k,"vertex"),L=Jx(l,N,"fragment");nn("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
Program Info Log: `+fe+`
`+_e+`
`+L)}else fe!==""?ot("WebGLProgram: Program Info Log:",fe):(O===""||j==="")&&(ge=!1);ge&&(V.diagnostics={runnable:Y,programLog:fe,vertexShader:{log:O,prefix:y},fragmentShader:{log:j,prefix:v}})}l.deleteShader(k),l.deleteShader(N),te=new Mc(l,C),w=q1(l,C)}let te;this.getUniforms=function(){return te===void 0&&B(this),te};let w;this.getAttributes=function(){return w===void 0&&B(this),w};let R=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=l.getProgramParameter(C,B1)),R},this.destroy=function(){r.releaseStatesOfProgram(this),l.deleteProgram(C),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=F1++,this.cacheKey=t,this.usedTimes=1,this.program=C,this.vertexShader=k,this.fragmentShader=N,this}let aE=0;class rE{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,r=t.fragmentShader,l=this._getShaderStage(i),u=this._getShaderStage(r),d=this._getShaderCacheForMaterial(t);return d.has(l)===!1&&(d.add(l),l.usedTimes++),d.has(u)===!1&&(d.add(u),u.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const r of i)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let r=i.get(t);return r===void 0&&(r=new Set,i.set(t,r)),r}_getShaderStage(t){const i=this.shaderCache;let r=i.get(t);return r===void 0&&(r=new sE(t),i.set(t,r)),r}}class sE{constructor(t){this.id=aE++,this.code=t,this.usedTimes=0}}function oE(o,t,i,r,l,u,d){const h=new Sg,m=new rE,p=new Set,_=[],x=l.logarithmicDepthBuffer,S=l.vertexTextures;let b=l.precision;const A={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function C(w){return p.add(w),w===0?"uv":`uv${w}`}function y(w,R,V,$,se){const de=$.fog,fe=se.geometry,O=w.isMeshStandardMaterial?$.environment:null,j=(w.isMeshStandardMaterial?i:t).get(w.envMap||O),Y=j&&j.mapping===Rc?j.image.height:null,ge=A[w.type];w.precision!==null&&(b=l.getMaxPrecision(w.precision),b!==w.precision&&ot("WebGLProgram.getParameters:",w.precision,"not supported, using",b,"instead."));const _e=fe.morphAttributes.position||fe.morphAttributes.normal||fe.morphAttributes.color,L=_e!==void 0?_e.length:0;let ae=0;fe.morphAttributes.position!==void 0&&(ae=1),fe.morphAttributes.normal!==void 0&&(ae=2),fe.morphAttributes.color!==void 0&&(ae=3);let ye,Ee,ze,ne;if(ge){const At=wi[ge];ye=At.vertexShader,Ee=At.fragmentShader}else ye=w.vertexShader,Ee=w.fragmentShader,m.update(w),ze=m.getVertexShaderID(w),ne=m.getFragmentShaderID(w);const le=o.getRenderTarget(),Ce=o.state.buffers.depth.getReversed(),He=se.isInstancedMesh===!0,Xe=se.isBatchedMesh===!0,lt=!!w.map,$t=!!w.matcap,dt=!!j,Tt=!!w.aoMap,I=!!w.lightMap,ht=!!w.bumpMap,mt=!!w.normalMap,Ot=!!w.displacementMap,Ge=!!w.emissiveMap,kt=!!w.metalnessMap,je=!!w.roughnessMap,at=w.anisotropy>0,D=w.clearcoat>0,M=w.dispersion>0,K=w.iridescence>0,pe=w.sheen>0,ve=w.transmission>0,oe=at&&!!w.anisotropyMap,qe=D&&!!w.clearcoatMap,Le=D&&!!w.clearcoatNormalMap,Qe=D&&!!w.clearcoatRoughnessMap,We=K&&!!w.iridescenceMap,Se=K&&!!w.iridescenceThicknessMap,Me=pe&&!!w.sheenColorMap,Ye=pe&&!!w.sheenRoughnessMap,Ve=!!w.specularMap,Oe=!!w.specularColorMap,nt=!!w.specularIntensityMap,H=ve&&!!w.transmissionMap,we=ve&&!!w.thicknessMap,Ae=!!w.gradientMap,Re=!!w.alphaMap,be=w.alphaTest>0,xe=!!w.alphaHash,Be=!!w.extensions;let it=Ya;w.toneMapped&&(le===null||le.isXRRenderTarget===!0)&&(it=o.toneMapping);const Bt={shaderID:ge,shaderType:w.type,shaderName:w.name,vertexShader:ye,fragmentShader:Ee,defines:w.defines,customVertexShaderID:ze,customFragmentShaderID:ne,isRawShaderMaterial:w.isRawShaderMaterial===!0,glslVersion:w.glslVersion,precision:b,batching:Xe,batchingColor:Xe&&se._colorsTexture!==null,instancing:He,instancingColor:He&&se.instanceColor!==null,instancingMorph:He&&se.morphTexture!==null,supportsVertexTextures:S,outputColorSpace:le===null?o.outputColorSpace:le.isXRRenderTarget===!0?le.texture.colorSpace:Es,alphaToCoverage:!!w.alphaToCoverage,map:lt,matcap:$t,envMap:dt,envMapMode:dt&&j.mapping,envMapCubeUVHeight:Y,aoMap:Tt,lightMap:I,bumpMap:ht,normalMap:mt,displacementMap:S&&Ot,emissiveMap:Ge,normalMapObjectSpace:mt&&w.normalMapType===iy,normalMapTangentSpace:mt&&w.normalMapType===ny,metalnessMap:kt,roughnessMap:je,anisotropy:at,anisotropyMap:oe,clearcoat:D,clearcoatMap:qe,clearcoatNormalMap:Le,clearcoatRoughnessMap:Qe,dispersion:M,iridescence:K,iridescenceMap:We,iridescenceThicknessMap:Se,sheen:pe,sheenColorMap:Me,sheenRoughnessMap:Ye,specularMap:Ve,specularColorMap:Oe,specularIntensityMap:nt,transmission:ve,transmissionMap:H,thicknessMap:we,gradientMap:Ae,opaque:w.transparent===!1&&w.blending===vs&&w.alphaToCoverage===!1,alphaMap:Re,alphaTest:be,alphaHash:xe,combine:w.combine,mapUv:lt&&C(w.map.channel),aoMapUv:Tt&&C(w.aoMap.channel),lightMapUv:I&&C(w.lightMap.channel),bumpMapUv:ht&&C(w.bumpMap.channel),normalMapUv:mt&&C(w.normalMap.channel),displacementMapUv:Ot&&C(w.displacementMap.channel),emissiveMapUv:Ge&&C(w.emissiveMap.channel),metalnessMapUv:kt&&C(w.metalnessMap.channel),roughnessMapUv:je&&C(w.roughnessMap.channel),anisotropyMapUv:oe&&C(w.anisotropyMap.channel),clearcoatMapUv:qe&&C(w.clearcoatMap.channel),clearcoatNormalMapUv:Le&&C(w.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Qe&&C(w.clearcoatRoughnessMap.channel),iridescenceMapUv:We&&C(w.iridescenceMap.channel),iridescenceThicknessMapUv:Se&&C(w.iridescenceThicknessMap.channel),sheenColorMapUv:Me&&C(w.sheenColorMap.channel),sheenRoughnessMapUv:Ye&&C(w.sheenRoughnessMap.channel),specularMapUv:Ve&&C(w.specularMap.channel),specularColorMapUv:Oe&&C(w.specularColorMap.channel),specularIntensityMapUv:nt&&C(w.specularIntensityMap.channel),transmissionMapUv:H&&C(w.transmissionMap.channel),thicknessMapUv:we&&C(w.thicknessMap.channel),alphaMapUv:Re&&C(w.alphaMap.channel),vertexTangents:!!fe.attributes.tangent&&(mt||at),vertexColors:w.vertexColors,vertexAlphas:w.vertexColors===!0&&!!fe.attributes.color&&fe.attributes.color.itemSize===4,pointsUvs:se.isPoints===!0&&!!fe.attributes.uv&&(lt||Re),fog:!!de,useFog:w.fog===!0,fogExp2:!!de&&de.isFogExp2,flatShading:w.flatShading===!0&&w.wireframe===!1,sizeAttenuation:w.sizeAttenuation===!0,logarithmicDepthBuffer:x,reversedDepthBuffer:Ce,skinning:se.isSkinnedMesh===!0,morphTargets:fe.morphAttributes.position!==void 0,morphNormals:fe.morphAttributes.normal!==void 0,morphColors:fe.morphAttributes.color!==void 0,morphTargetsCount:L,morphTextureStride:ae,numDirLights:R.directional.length,numPointLights:R.point.length,numSpotLights:R.spot.length,numSpotLightMaps:R.spotLightMap.length,numRectAreaLights:R.rectArea.length,numHemiLights:R.hemi.length,numDirLightShadows:R.directionalShadowMap.length,numPointLightShadows:R.pointShadowMap.length,numSpotLightShadows:R.spotShadowMap.length,numSpotLightShadowsWithMaps:R.numSpotLightShadowsWithMaps,numLightProbes:R.numLightProbes,numClippingPlanes:d.numPlanes,numClipIntersection:d.numIntersection,dithering:w.dithering,shadowMapEnabled:o.shadowMap.enabled&&V.length>0,shadowMapType:o.shadowMap.type,toneMapping:it,decodeVideoTexture:lt&&w.map.isVideoTexture===!0&&Dt.getTransfer(w.map.colorSpace)===Gt,decodeVideoTextureEmissive:Ge&&w.emissiveMap.isVideoTexture===!0&&Dt.getTransfer(w.emissiveMap.colorSpace)===Gt,premultipliedAlpha:w.premultipliedAlpha,doubleSided:w.side===oa,flipSided:w.side===Vn,useDepthPacking:w.depthPacking>=0,depthPacking:w.depthPacking||0,index0AttributeName:w.index0AttributeName,extensionClipCullDistance:Be&&w.extensions.clipCullDistance===!0&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Be&&w.extensions.multiDraw===!0||Xe)&&r.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:w.customProgramCacheKey()};return Bt.vertexUv1s=p.has(1),Bt.vertexUv2s=p.has(2),Bt.vertexUv3s=p.has(3),p.clear(),Bt}function v(w){const R=[];if(w.shaderID?R.push(w.shaderID):(R.push(w.customVertexShaderID),R.push(w.customFragmentShaderID)),w.defines!==void 0)for(const V in w.defines)R.push(V),R.push(w.defines[V]);return w.isRawShaderMaterial===!1&&(P(R,w),U(R,w),R.push(o.outputColorSpace)),R.push(w.customProgramCacheKey),R.join()}function P(w,R){w.push(R.precision),w.push(R.outputColorSpace),w.push(R.envMapMode),w.push(R.envMapCubeUVHeight),w.push(R.mapUv),w.push(R.alphaMapUv),w.push(R.lightMapUv),w.push(R.aoMapUv),w.push(R.bumpMapUv),w.push(R.normalMapUv),w.push(R.displacementMapUv),w.push(R.emissiveMapUv),w.push(R.metalnessMapUv),w.push(R.roughnessMapUv),w.push(R.anisotropyMapUv),w.push(R.clearcoatMapUv),w.push(R.clearcoatNormalMapUv),w.push(R.clearcoatRoughnessMapUv),w.push(R.iridescenceMapUv),w.push(R.iridescenceThicknessMapUv),w.push(R.sheenColorMapUv),w.push(R.sheenRoughnessMapUv),w.push(R.specularMapUv),w.push(R.specularColorMapUv),w.push(R.specularIntensityMapUv),w.push(R.transmissionMapUv),w.push(R.thicknessMapUv),w.push(R.combine),w.push(R.fogExp2),w.push(R.sizeAttenuation),w.push(R.morphTargetsCount),w.push(R.morphAttributeCount),w.push(R.numDirLights),w.push(R.numPointLights),w.push(R.numSpotLights),w.push(R.numSpotLightMaps),w.push(R.numHemiLights),w.push(R.numRectAreaLights),w.push(R.numDirLightShadows),w.push(R.numPointLightShadows),w.push(R.numSpotLightShadows),w.push(R.numSpotLightShadowsWithMaps),w.push(R.numLightProbes),w.push(R.shadowMapType),w.push(R.toneMapping),w.push(R.numClippingPlanes),w.push(R.numClipIntersection),w.push(R.depthPacking)}function U(w,R){h.disableAll(),R.supportsVertexTextures&&h.enable(0),R.instancing&&h.enable(1),R.instancingColor&&h.enable(2),R.instancingMorph&&h.enable(3),R.matcap&&h.enable(4),R.envMap&&h.enable(5),R.normalMapObjectSpace&&h.enable(6),R.normalMapTangentSpace&&h.enable(7),R.clearcoat&&h.enable(8),R.iridescence&&h.enable(9),R.alphaTest&&h.enable(10),R.vertexColors&&h.enable(11),R.vertexAlphas&&h.enable(12),R.vertexUv1s&&h.enable(13),R.vertexUv2s&&h.enable(14),R.vertexUv3s&&h.enable(15),R.vertexTangents&&h.enable(16),R.anisotropy&&h.enable(17),R.alphaHash&&h.enable(18),R.batching&&h.enable(19),R.dispersion&&h.enable(20),R.batchingColor&&h.enable(21),R.gradientMap&&h.enable(22),w.push(h.mask),h.disableAll(),R.fog&&h.enable(0),R.useFog&&h.enable(1),R.flatShading&&h.enable(2),R.logarithmicDepthBuffer&&h.enable(3),R.reversedDepthBuffer&&h.enable(4),R.skinning&&h.enable(5),R.morphTargets&&h.enable(6),R.morphNormals&&h.enable(7),R.morphColors&&h.enable(8),R.premultipliedAlpha&&h.enable(9),R.shadowMapEnabled&&h.enable(10),R.doubleSided&&h.enable(11),R.flipSided&&h.enable(12),R.useDepthPacking&&h.enable(13),R.dithering&&h.enable(14),R.transmission&&h.enable(15),R.sheen&&h.enable(16),R.opaque&&h.enable(17),R.pointsUvs&&h.enable(18),R.decodeVideoTexture&&h.enable(19),R.decodeVideoTextureEmissive&&h.enable(20),R.alphaToCoverage&&h.enable(21),w.push(h.mask)}function F(w){const R=A[w.type];let V;if(R){const $=wi[R];V=Ny.clone($.uniforms)}else V=w.uniforms;return V}function k(w,R){let V;for(let $=0,se=_.length;$<se;$++){const de=_[$];if(de.cacheKey===R){V=de,++V.usedTimes;break}}return V===void 0&&(V=new iE(o,R,w,u),_.push(V)),V}function N(w){if(--w.usedTimes===0){const R=_.indexOf(w);_[R]=_[_.length-1],_.pop(),w.destroy()}}function B(w){m.remove(w)}function te(){m.dispose()}return{getParameters:y,getProgramCacheKey:v,getUniforms:F,acquireProgram:k,releaseProgram:N,releaseShaderCache:B,programs:_,dispose:te}}function lE(){let o=new WeakMap;function t(d){return o.has(d)}function i(d){let h=o.get(d);return h===void 0&&(h={},o.set(d,h)),h}function r(d){o.delete(d)}function l(d,h,m){o.get(d)[h]=m}function u(){o=new WeakMap}return{has:t,get:i,remove:r,update:l,dispose:u}}function cE(o,t){return o.groupOrder!==t.groupOrder?o.groupOrder-t.groupOrder:o.renderOrder!==t.renderOrder?o.renderOrder-t.renderOrder:o.material.id!==t.material.id?o.material.id-t.material.id:o.z!==t.z?o.z-t.z:o.id-t.id}function ig(o,t){return o.groupOrder!==t.groupOrder?o.groupOrder-t.groupOrder:o.renderOrder!==t.renderOrder?o.renderOrder-t.renderOrder:o.z!==t.z?t.z-o.z:o.id-t.id}function ag(){const o=[];let t=0;const i=[],r=[],l=[];function u(){t=0,i.length=0,r.length=0,l.length=0}function d(x,S,b,A,C,y){let v=o[t];return v===void 0?(v={id:x.id,object:x,geometry:S,material:b,groupOrder:A,renderOrder:x.renderOrder,z:C,group:y},o[t]=v):(v.id=x.id,v.object=x,v.geometry=S,v.material=b,v.groupOrder=A,v.renderOrder=x.renderOrder,v.z=C,v.group=y),t++,v}function h(x,S,b,A,C,y){const v=d(x,S,b,A,C,y);b.transmission>0?r.push(v):b.transparent===!0?l.push(v):i.push(v)}function m(x,S,b,A,C,y){const v=d(x,S,b,A,C,y);b.transmission>0?r.unshift(v):b.transparent===!0?l.unshift(v):i.unshift(v)}function p(x,S){i.length>1&&i.sort(x||cE),r.length>1&&r.sort(S||ig),l.length>1&&l.sort(S||ig)}function _(){for(let x=t,S=o.length;x<S;x++){const b=o[x];if(b.id===null)break;b.id=null,b.object=null,b.geometry=null,b.material=null,b.group=null}}return{opaque:i,transmissive:r,transparent:l,init:u,push:h,unshift:m,finish:_,sort:p}}function uE(){let o=new WeakMap;function t(r,l){const u=o.get(r);let d;return u===void 0?(d=new ag,o.set(r,[d])):l>=u.length?(d=new ag,u.push(d)):d=u[l],d}function i(){o=new WeakMap}return{get:t,dispose:i}}function fE(){const o={};return{get:function(t){if(o[t.id]!==void 0)return o[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new ce,color:new Vt};break;case"SpotLight":i={position:new ce,direction:new ce,color:new Vt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new ce,color:new Vt,distance:0,decay:0};break;case"HemisphereLight":i={direction:new ce,skyColor:new Vt,groundColor:new Vt};break;case"RectAreaLight":i={color:new Vt,position:new ce,halfWidth:new ce,halfHeight:new ce};break}return o[t.id]=i,i}}}function dE(){const o={};return{get:function(t){if(o[t.id]!==void 0)return o[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ut};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ut};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ut,shadowCameraNear:1,shadowCameraFar:1e3};break}return o[t.id]=i,i}}}let hE=0;function pE(o,t){return(t.castShadow?2:0)-(o.castShadow?2:0)+(t.map?1:0)-(o.map?1:0)}function mE(o){const t=new fE,i=dE(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)r.probe.push(new ce);const l=new ce,u=new mn,d=new mn;function h(p){let _=0,x=0,S=0;for(let w=0;w<9;w++)r.probe[w].set(0,0,0);let b=0,A=0,C=0,y=0,v=0,P=0,U=0,F=0,k=0,N=0,B=0;p.sort(pE);for(let w=0,R=p.length;w<R;w++){const V=p[w],$=V.color,se=V.intensity,de=V.distance,fe=V.shadow&&V.shadow.map?V.shadow.map.texture:null;if(V.isAmbientLight)_+=$.r*se,x+=$.g*se,S+=$.b*se;else if(V.isLightProbe){for(let O=0;O<9;O++)r.probe[O].addScaledVector(V.sh.coefficients[O],se);B++}else if(V.isDirectionalLight){const O=t.get(V);if(O.color.copy(V.color).multiplyScalar(V.intensity),V.castShadow){const j=V.shadow,Y=i.get(V);Y.shadowIntensity=j.intensity,Y.shadowBias=j.bias,Y.shadowNormalBias=j.normalBias,Y.shadowRadius=j.radius,Y.shadowMapSize=j.mapSize,r.directionalShadow[b]=Y,r.directionalShadowMap[b]=fe,r.directionalShadowMatrix[b]=V.shadow.matrix,P++}r.directional[b]=O,b++}else if(V.isSpotLight){const O=t.get(V);O.position.setFromMatrixPosition(V.matrixWorld),O.color.copy($).multiplyScalar(se),O.distance=de,O.coneCos=Math.cos(V.angle),O.penumbraCos=Math.cos(V.angle*(1-V.penumbra)),O.decay=V.decay,r.spot[C]=O;const j=V.shadow;if(V.map&&(r.spotLightMap[k]=V.map,k++,j.updateMatrices(V),V.castShadow&&N++),r.spotLightMatrix[C]=j.matrix,V.castShadow){const Y=i.get(V);Y.shadowIntensity=j.intensity,Y.shadowBias=j.bias,Y.shadowNormalBias=j.normalBias,Y.shadowRadius=j.radius,Y.shadowMapSize=j.mapSize,r.spotShadow[C]=Y,r.spotShadowMap[C]=fe,F++}C++}else if(V.isRectAreaLight){const O=t.get(V);O.color.copy($).multiplyScalar(se),O.halfWidth.set(V.width*.5,0,0),O.halfHeight.set(0,V.height*.5,0),r.rectArea[y]=O,y++}else if(V.isPointLight){const O=t.get(V);if(O.color.copy(V.color).multiplyScalar(V.intensity),O.distance=V.distance,O.decay=V.decay,V.castShadow){const j=V.shadow,Y=i.get(V);Y.shadowIntensity=j.intensity,Y.shadowBias=j.bias,Y.shadowNormalBias=j.normalBias,Y.shadowRadius=j.radius,Y.shadowMapSize=j.mapSize,Y.shadowCameraNear=j.camera.near,Y.shadowCameraFar=j.camera.far,r.pointShadow[A]=Y,r.pointShadowMap[A]=fe,r.pointShadowMatrix[A]=V.shadow.matrix,U++}r.point[A]=O,A++}else if(V.isHemisphereLight){const O=t.get(V);O.skyColor.copy(V.color).multiplyScalar(se),O.groundColor.copy(V.groundColor).multiplyScalar(se),r.hemi[v]=O,v++}}y>0&&(o.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=Ne.LTC_FLOAT_1,r.rectAreaLTC2=Ne.LTC_FLOAT_2):(r.rectAreaLTC1=Ne.LTC_HALF_1,r.rectAreaLTC2=Ne.LTC_HALF_2)),r.ambient[0]=_,r.ambient[1]=x,r.ambient[2]=S;const te=r.hash;(te.directionalLength!==b||te.pointLength!==A||te.spotLength!==C||te.rectAreaLength!==y||te.hemiLength!==v||te.numDirectionalShadows!==P||te.numPointShadows!==U||te.numSpotShadows!==F||te.numSpotMaps!==k||te.numLightProbes!==B)&&(r.directional.length=b,r.spot.length=C,r.rectArea.length=y,r.point.length=A,r.hemi.length=v,r.directionalShadow.length=P,r.directionalShadowMap.length=P,r.pointShadow.length=U,r.pointShadowMap.length=U,r.spotShadow.length=F,r.spotShadowMap.length=F,r.directionalShadowMatrix.length=P,r.pointShadowMatrix.length=U,r.spotLightMatrix.length=F+k-N,r.spotLightMap.length=k,r.numSpotLightShadowsWithMaps=N,r.numLightProbes=B,te.directionalLength=b,te.pointLength=A,te.spotLength=C,te.rectAreaLength=y,te.hemiLength=v,te.numDirectionalShadows=P,te.numPointShadows=U,te.numSpotShadows=F,te.numSpotMaps=k,te.numLightProbes=B,r.version=hE++)}function m(p,_){let x=0,S=0,b=0,A=0,C=0;const y=_.matrixWorldInverse;for(let v=0,P=p.length;v<P;v++){const U=p[v];if(U.isDirectionalLight){const F=r.directional[x];F.direction.setFromMatrixPosition(U.matrixWorld),l.setFromMatrixPosition(U.target.matrixWorld),F.direction.sub(l),F.direction.transformDirection(y),x++}else if(U.isSpotLight){const F=r.spot[b];F.position.setFromMatrixPosition(U.matrixWorld),F.position.applyMatrix4(y),F.direction.setFromMatrixPosition(U.matrixWorld),l.setFromMatrixPosition(U.target.matrixWorld),F.direction.sub(l),F.direction.transformDirection(y),b++}else if(U.isRectAreaLight){const F=r.rectArea[A];F.position.setFromMatrixPosition(U.matrixWorld),F.position.applyMatrix4(y),d.identity(),u.copy(U.matrixWorld),u.premultiply(y),d.extractRotation(u),F.halfWidth.set(U.width*.5,0,0),F.halfHeight.set(0,U.height*.5,0),F.halfWidth.applyMatrix4(d),F.halfHeight.applyMatrix4(d),A++}else if(U.isPointLight){const F=r.point[S];F.position.setFromMatrixPosition(U.matrixWorld),F.position.applyMatrix4(y),S++}else if(U.isHemisphereLight){const F=r.hemi[C];F.direction.setFromMatrixPosition(U.matrixWorld),F.direction.transformDirection(y),C++}}}return{setup:h,setupView:m,state:r}}function rg(o){const t=new mE(o),i=[],r=[];function l(_){p.camera=_,i.length=0,r.length=0}function u(_){i.push(_)}function d(_){r.push(_)}function h(){t.setup(i)}function m(_){t.setupView(i,_)}const p={lightsArray:i,shadowsArray:r,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:h,setupLightsView:m,pushLight:u,pushShadow:d}}function xE(o){let t=new WeakMap;function i(l,u=0){const d=t.get(l);let h;return d===void 0?(h=new rg(o),t.set(l,[h])):u>=d.length?(h=new rg(o),d.push(h)):h=d[u],h}function r(){t=new WeakMap}return{get:i,dispose:r}}const gE=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function vE(o,t,i){let r=new Cg;const l=new Ut,u=new Ut,d=new an,h=new ky({depthPacking:ty}),m=new Xy,p={},_=i.maxTextureSize,x={[ja]:Vn,[Vn]:ja,[oa]:oa},S=new Mi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ut},radius:{value:4}},vertexShader:gE,fragmentShader:_E}),b=S.clone();b.defines.HORIZONTAL_PASS=1;const A=new Ka;A.setAttribute("position",new Ui(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Li(A,S),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=og;let v=this.type;this.render=function(N,B,te){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||N.length===0)return;const w=o.getRenderTarget(),R=o.getActiveCubeFace(),V=o.getActiveMipmapLevel(),$=o.state;$.setBlending(ua),$.buffers.depth.getReversed()===!0?$.buffers.color.setClear(0,0,0,0):$.buffers.color.setClear(1,1,1,1),$.buffers.depth.setTest(!0),$.setScissorTest(!1);const se=v!==ra&&this.type===ra,de=v===ra&&this.type!==ra;for(let fe=0,O=N.length;fe<O;fe++){const j=N[fe],Y=j.shadow;if(Y===void 0){ot("WebGLShadowMap:",j,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;l.copy(Y.mapSize);const ge=Y.getFrameExtents();if(l.multiply(ge),u.copy(Y.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(u.x=Math.floor(_/ge.x),l.x=u.x*ge.x,Y.mapSize.x=u.x),l.y>_&&(u.y=Math.floor(_/ge.y),l.y=u.y*ge.y,Y.mapSize.y=u.y)),Y.map===null||se===!0||de===!0){const L=this.type!==ra?{minFilter:ei,magFilter:ei}:{};Y.map!==null&&Y.map.dispose(),Y.map=new Za(l.x,l.y,L),Y.map.texture.name=j.name+".shadowMap",Y.camera.updateProjectionMatrix()}o.setRenderTarget(Y.map),o.clear();const _e=Y.getViewportCount();for(let L=0;L<_e;L++){const ae=Y.getViewport(L);d.set(u.x*ae.x,u.y*ae.y,u.x*ae.z,u.y*ae.w),$.viewport(d),Y.updateMatrices(j,L),r=Y.getFrustum(),F(B,te,Y.camera,j,this.type)}Y.isPointLightShadow!==!0&&this.type===ra&&P(Y,te),Y.needsUpdate=!1}v=this.type,y.needsUpdate=!1,o.setRenderTarget(w,R,V)};function P(N,B){const te=t.update(C);S.defines.VSM_SAMPLES!==N.blurSamples&&(S.defines.VSM_SAMPLES=N.blurSamples,b.defines.VSM_SAMPLES=N.blurSamples,S.needsUpdate=!0,b.needsUpdate=!0),N.mapPass===null&&(N.mapPass=new Za(l.x,l.y)),S.uniforms.shadow_pass.value=N.map.texture,S.uniforms.resolution.value=N.mapSize,S.uniforms.radius.value=N.radius,o.setRenderTarget(N.mapPass),o.clear(),o.renderBufferDirect(B,null,te,S,C,null),b.uniforms.shadow_pass.value=N.mapPass.texture,b.uniforms.resolution.value=N.mapSize,b.uniforms.radius.value=N.radius,o.setRenderTarget(N.map),o.clear(),o.renderBufferDirect(B,null,te,b,C,null)}function U(N,B,te,w){let R=null;const V=te.isPointLight===!0?N.customDistanceMaterial:N.customDepthMaterial;if(V!==void 0)R=V;else if(R=te.isPointLight===!0?m:h,o.localClippingEnabled&&B.clipShadows===!0&&Array.isArray(B.clippingPlanes)&&B.clippingPlanes.length!==0||B.displacementMap&&B.displacementScale!==0||B.alphaMap&&B.alphaTest>0||B.map&&B.alphaTest>0||B.alphaToCoverage===!0){const $=R.uuid,se=B.uuid;let de=p[$];de===void 0&&(de={},p[$]=de);let fe=de[se];fe===void 0&&(fe=R.clone(),de[se]=fe,B.addEventListener("dispose",k)),R=fe}if(R.visible=B.visible,R.wireframe=B.wireframe,w===ra?R.side=B.shadowSide!==null?B.shadowSide:B.side:R.side=B.shadowSide!==null?B.shadowSide:x[B.side],R.alphaMap=B.alphaMap,R.alphaTest=B.alphaToCoverage===!0?.5:B.alphaTest,R.map=B.map,R.clipShadows=B.clipShadows,R.clippingPlanes=B.clippingPlanes,R.clipIntersection=B.clipIntersection,R.displacementMap=B.displacementMap,R.displacementScale=B.displacementScale,R.displacementBias=B.displacementBias,R.wireframeLinewidth=B.wireframeLinewidth,R.linewidth=B.linewidth,te.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const $=o.properties.get(R);$.light=te}return R}function F(N,B,te,w,R){if(N.visible===!1)return;if(N.layers.test(B.layers)&&(N.isMesh||N.isLine||N.isPoints)&&(N.castShadow||N.receiveShadow&&R===ra)&&(!N.frustumCulled||r.intersectsObject(N))){N.modelViewMatrix.multiplyMatrices(te.matrixWorldInverse,N.matrixWorld);const se=t.update(N),de=N.material;if(Array.isArray(de)){const fe=se.groups;for(let O=0,j=fe.length;O<j;O++){const Y=fe[O],ge=de[Y.materialIndex];if(ge&&ge.visible){const _e=U(N,ge,w,R);N.onBeforeShadow(o,N,B,te,se,_e,Y),o.renderBufferDirect(te,null,se,_e,N,Y),N.onAfterShadow(o,N,B,te,se,_e,Y)}}}else if(de.visible){const fe=U(N,de,w,R);N.onBeforeShadow(o,N,B,te,se,fe,null),o.renderBufferDirect(te,null,se,fe,N,null),N.onAfterShadow(o,N,B,te,se,fe,null)}}const $=N.children;for(let se=0,de=$.length;se<de;se++)F($[se],B,te,w,R)}function k(N){N.target.removeEventListener("dispose",k);for(const te in p){const w=p[te],R=N.target.uuid;R in w&&(w[R].dispose(),delete w[R])}}}const SE={[bd]:Md,[Ed]:Rd,[Td]:Cd,[ys]:Ad,[Md]:bd,[Rd]:Ed,[Cd]:Td,[Ad]:ys};function yE(o,t){function i(){let H=!1;const we=new an;let Ae=null;const Re=new an(0,0,0,0);return{setMask:function(be){Ae!==be&&!H&&(o.colorMask(be,be,be,be),Ae=be)},setLocked:function(be){H=be},setClear:function(be,xe,Be,it,Bt){Bt===!0&&(be*=it,xe*=it,Be*=it),we.set(be,xe,Be,it),Re.equals(we)===!1&&(o.clearColor(be,xe,Be,it),Re.copy(we))},reset:function(){H=!1,Ae=null,Re.set(-1,0,0,0)}}}function r(){let H=!1,we=!1,Ae=null,Re=null,be=null;return{setReversed:function(xe){if(we!==xe){const Be=t.get("EXT_clip_control");xe?Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.ZERO_TO_ONE_EXT):Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.NEGATIVE_ONE_TO_ONE_EXT),we=xe;const it=be;be=null,this.setClear(it)}},getReversed:function(){return we},setTest:function(xe){xe?le(o.DEPTH_TEST):Ce(o.DEPTH_TEST)},setMask:function(xe){Ae!==xe&&!H&&(o.depthMask(xe),Ae=xe)},setFunc:function(xe){if(we&&(xe=SE[xe]),Re!==xe){switch(xe){case bd:o.depthFunc(o.NEVER);break;case Md:o.depthFunc(o.ALWAYS);break;case Ed:o.depthFunc(o.LESS);break;case ys:o.depthFunc(o.LEQUAL);break;case Td:o.depthFunc(o.EQUAL);break;case Ad:o.depthFunc(o.GEQUAL);break;case Rd:o.depthFunc(o.GREATER);break;case Cd:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Re=xe}},setLocked:function(xe){H=xe},setClear:function(xe){be!==xe&&(we&&(xe=1-xe),o.clearDepth(xe),be=xe)},reset:function(){H=!1,Ae=null,Re=null,be=null,we=!1}}}function l(){let H=!1,we=null,Ae=null,Re=null,be=null,xe=null,Be=null,it=null,Bt=null;return{setTest:function(At){H||(At?le(o.STENCIL_TEST):Ce(o.STENCIL_TEST))},setMask:function(At){we!==At&&!H&&(o.stencilMask(At),we=At)},setFunc:function(At,Cn,kn){(Ae!==At||Re!==Cn||be!==kn)&&(o.stencilFunc(At,Cn,kn),Ae=At,Re=Cn,be=kn)},setOp:function(At,Cn,kn){(xe!==At||Be!==Cn||it!==kn)&&(o.stencilOp(At,Cn,kn),xe=At,Be=Cn,it=kn)},setLocked:function(At){H=At},setClear:function(At){Bt!==At&&(o.clearStencil(At),Bt=At)},reset:function(){H=!1,we=null,Ae=null,Re=null,be=null,xe=null,Be=null,it=null,Bt=null}}}const u=new i,d=new r,h=new l,m=new WeakMap,p=new WeakMap;let _={},x={},S=new WeakMap,b=[],A=null,C=!1,y=null,v=null,P=null,U=null,F=null,k=null,N=null,B=new Vt(0,0,0),te=0,w=!1,R=null,V=null,$=null,se=null,de=null;const fe=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,j=0;const Y=o.getParameter(o.VERSION);Y.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(Y)[1]),O=j>=1):Y.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),O=j>=2);let ge=null,_e={};const L=o.getParameter(o.SCISSOR_BOX),ae=o.getParameter(o.VIEWPORT),ye=new an().fromArray(L),Ee=new an().fromArray(ae);function ze(H,we,Ae,Re){const be=new Uint8Array(4),xe=o.createTexture();o.bindTexture(H,xe),o.texParameteri(H,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(H,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Be=0;Be<Ae;Be++)H===o.TEXTURE_3D||H===o.TEXTURE_2D_ARRAY?o.texImage3D(we,0,o.RGBA,1,1,Re,0,o.RGBA,o.UNSIGNED_BYTE,be):o.texImage2D(we+Be,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,be);return xe}const ne={};ne[o.TEXTURE_2D]=ze(o.TEXTURE_2D,o.TEXTURE_2D,1),ne[o.TEXTURE_CUBE_MAP]=ze(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),ne[o.TEXTURE_2D_ARRAY]=ze(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),ne[o.TEXTURE_3D]=ze(o.TEXTURE_3D,o.TEXTURE_3D,1,1),u.setClear(0,0,0,1),d.setClear(1),h.setClear(0),le(o.DEPTH_TEST),d.setFunc(ys),ht(!1),mt(ux),le(o.CULL_FACE),Tt(ua);function le(H){_[H]!==!0&&(o.enable(H),_[H]=!0)}function Ce(H){_[H]!==!1&&(o.disable(H),_[H]=!1)}function He(H,we){return x[H]!==we?(o.bindFramebuffer(H,we),x[H]=we,H===o.DRAW_FRAMEBUFFER&&(x[o.FRAMEBUFFER]=we),H===o.FRAMEBUFFER&&(x[o.DRAW_FRAMEBUFFER]=we),!0):!1}function Xe(H,we){let Ae=b,Re=!1;if(H){Ae=S.get(we),Ae===void 0&&(Ae=[],S.set(we,Ae));const be=H.textures;if(Ae.length!==be.length||Ae[0]!==o.COLOR_ATTACHMENT0){for(let xe=0,Be=be.length;xe<Be;xe++)Ae[xe]=o.COLOR_ATTACHMENT0+xe;Ae.length=be.length,Re=!0}}else Ae[0]!==o.BACK&&(Ae[0]=o.BACK,Re=!0);Re&&o.drawBuffers(Ae)}function lt(H){return A!==H?(o.useProgram(H),A=H,!0):!1}const $t={[br]:o.FUNC_ADD,[RS]:o.FUNC_SUBTRACT,[CS]:o.FUNC_REVERSE_SUBTRACT};$t[wS]=o.MIN,$t[DS]=o.MAX;const dt={[US]:o.ZERO,[LS]:o.ONE,[NS]:o.SRC_COLOR,[Sd]:o.SRC_ALPHA,[IS]:o.SRC_ALPHA_SATURATE,[BS]:o.DST_COLOR,[zS]:o.DST_ALPHA,[OS]:o.ONE_MINUS_SRC_COLOR,[yd]:o.ONE_MINUS_SRC_ALPHA,[FS]:o.ONE_MINUS_DST_COLOR,[PS]:o.ONE_MINUS_DST_ALPHA,[HS]:o.CONSTANT_COLOR,[GS]:o.ONE_MINUS_CONSTANT_COLOR,[VS]:o.CONSTANT_ALPHA,[kS]:o.ONE_MINUS_CONSTANT_ALPHA};function Tt(H,we,Ae,Re,be,xe,Be,it,Bt,At){if(H===ua){C===!0&&(Ce(o.BLEND),C=!1);return}if(C===!1&&(le(o.BLEND),C=!0),H!==AS){if(H!==y||At!==w){if((v!==br||F!==br)&&(o.blendEquation(o.FUNC_ADD),v=br,F=br),At)switch(H){case vs:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case fx:o.blendFunc(o.ONE,o.ONE);break;case dx:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case hx:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:nn("WebGLState: Invalid blending: ",H);break}else switch(H){case vs:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case fx:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case dx:nn("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case hx:nn("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:nn("WebGLState: Invalid blending: ",H);break}P=null,U=null,k=null,N=null,B.set(0,0,0),te=0,y=H,w=At}return}be=be||we,xe=xe||Ae,Be=Be||Re,(we!==v||be!==F)&&(o.blendEquationSeparate($t[we],$t[be]),v=we,F=be),(Ae!==P||Re!==U||xe!==k||Be!==N)&&(o.blendFuncSeparate(dt[Ae],dt[Re],dt[xe],dt[Be]),P=Ae,U=Re,k=xe,N=Be),(it.equals(B)===!1||Bt!==te)&&(o.blendColor(it.r,it.g,it.b,Bt),B.copy(it),te=Bt),y=H,w=!1}function I(H,we){H.side===oa?Ce(o.CULL_FACE):le(o.CULL_FACE);let Ae=H.side===Vn;we&&(Ae=!Ae),ht(Ae),H.blending===vs&&H.transparent===!1?Tt(ua):Tt(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),d.setFunc(H.depthFunc),d.setTest(H.depthTest),d.setMask(H.depthWrite),u.setMask(H.colorWrite);const Re=H.stencilWrite;h.setTest(Re),Re&&(h.setMask(H.stencilWriteMask),h.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),h.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),Ge(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?le(o.SAMPLE_ALPHA_TO_COVERAGE):Ce(o.SAMPLE_ALPHA_TO_COVERAGE)}function ht(H){R!==H&&(H?o.frontFace(o.CW):o.frontFace(o.CCW),R=H)}function mt(H){H!==MS?(le(o.CULL_FACE),H!==V&&(H===ux?o.cullFace(o.BACK):H===ES?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):Ce(o.CULL_FACE),V=H}function Ot(H){H!==$&&(O&&o.lineWidth(H),$=H)}function Ge(H,we,Ae){H?(le(o.POLYGON_OFFSET_FILL),(se!==we||de!==Ae)&&(o.polygonOffset(we,Ae),se=we,de=Ae)):Ce(o.POLYGON_OFFSET_FILL)}function kt(H){H?le(o.SCISSOR_TEST):Ce(o.SCISSOR_TEST)}function je(H){H===void 0&&(H=o.TEXTURE0+fe-1),ge!==H&&(o.activeTexture(H),ge=H)}function at(H,we,Ae){Ae===void 0&&(ge===null?Ae=o.TEXTURE0+fe-1:Ae=ge);let Re=_e[Ae];Re===void 0&&(Re={type:void 0,texture:void 0},_e[Ae]=Re),(Re.type!==H||Re.texture!==we)&&(ge!==Ae&&(o.activeTexture(Ae),ge=Ae),o.bindTexture(H,we||ne[H]),Re.type=H,Re.texture=we)}function D(){const H=_e[ge];H!==void 0&&H.type!==void 0&&(o.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function M(){try{o.compressedTexImage2D(...arguments)}catch(H){H("WebGLState:",H)}}function K(){try{o.compressedTexImage3D(...arguments)}catch(H){H("WebGLState:",H)}}function pe(){try{o.texSubImage2D(...arguments)}catch(H){H("WebGLState:",H)}}function ve(){try{o.texSubImage3D(...arguments)}catch(H){H("WebGLState:",H)}}function oe(){try{o.compressedTexSubImage2D(...arguments)}catch(H){H("WebGLState:",H)}}function qe(){try{o.compressedTexSubImage3D(...arguments)}catch(H){H("WebGLState:",H)}}function Le(){try{o.texStorage2D(...arguments)}catch(H){H("WebGLState:",H)}}function Qe(){try{o.texStorage3D(...arguments)}catch(H){H("WebGLState:",H)}}function We(){try{o.texImage2D(...arguments)}catch(H){H("WebGLState:",H)}}function Se(){try{o.texImage3D(...arguments)}catch(H){H("WebGLState:",H)}}function Me(H){ye.equals(H)===!1&&(o.scissor(H.x,H.y,H.z,H.w),ye.copy(H))}function Ye(H){Ee.equals(H)===!1&&(o.viewport(H.x,H.y,H.z,H.w),Ee.copy(H))}function Ve(H,we){let Ae=p.get(we);Ae===void 0&&(Ae=new WeakMap,p.set(we,Ae));let Re=Ae.get(H);Re===void 0&&(Re=o.getUniformBlockIndex(we,H.name),Ae.set(H,Re))}function Oe(H,we){const Re=p.get(we).get(H);m.get(we)!==Re&&(o.uniformBlockBinding(we,Re,H.__bindingPointIndex),m.set(we,Re))}function nt(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),d.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),_={},ge=null,_e={},x={},S=new WeakMap,b=[],A=null,C=!1,y=null,v=null,P=null,U=null,F=null,k=null,N=null,B=new Vt(0,0,0),te=0,w=!1,R=null,V=null,$=null,se=null,de=null,ye.set(0,0,o.canvas.width,o.canvas.height),Ee.set(0,0,o.canvas.width,o.canvas.height),u.reset(),d.reset(),h.reset()}return{buffers:{color:u,depth:d,stencil:h},enable:le,disable:Ce,bindFramebuffer:He,drawBuffers:Xe,useProgram:lt,setBlending:Tt,setMaterial:I,setFlipSided:ht,setCullFace:mt,setLineWidth:Ot,setPolygonOffset:Ge,setScissorTest:kt,activeTexture:je,bindTexture:at,unbindTexture:D,compressedTexImage2D:M,compressedTexImage3D:K,texImage2D:We,texImage3D:Se,updateUBOMapping:Ve,uniformBlockBinding:Oe,texStorage2D:Le,texStorage3D:Qe,texSubImage2D:pe,texSubImage3D:ve,compressedTexSubImage2D:oe,compressedTexSubImage3D:qe,scissor:Me,viewport:Ye,reset:nt}}function bE(o,t,i,r,l,u,d){const h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Ut,_=new WeakMap;let x;const S=new WeakMap;let b=!1;try{b=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function A(D,M){return b?new OffscreenCanvas(D,M):Ac("canvas")}function C(D,M,K){let pe=1;const ve=at(D);if((ve.width>K||ve.height>K)&&(pe=K/Math.max(ve.width,ve.height)),pe<1)if(typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&D instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&D instanceof ImageBitmap||typeof VideoFrame<"u"&&D instanceof VideoFrame){const oe=Math.floor(pe*ve.width),qe=Math.floor(pe*ve.height);x===void 0&&(x=A(oe,qe));const Le=M?A(oe,qe):x;return Le.width=oe,Le.height=qe,Le.getContext("2d").drawImage(D,0,0,oe,qe),ot("WebGLRenderer: Texture has been resized from ("+ve.width+"x"+ve.height+") to ("+oe+"x"+qe+")."),Le}else return"data"in D&&ot("WebGLRenderer: Image in DataTexture is too big ("+ve.width+"x"+ve.height+")."),D;return D}function y(D){return D.generateMipmaps}function v(D){o.generateMipmap(D)}function P(D){return D.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:D.isWebGL3DRenderTarget?o.TEXTURE_3D:D.isWebGLArrayRenderTarget||D.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function U(D,M,K,pe,ve=!1){if(D!==null){if(o[D]!==void 0)return o[D];ot("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+D+"'")}let oe=M;if(M===o.RED&&(K===o.FLOAT&&(oe=o.R32F),K===o.HALF_FLOAT&&(oe=o.R16F),K===o.UNSIGNED_BYTE&&(oe=o.R8)),M===o.RED_INTEGER&&(K===o.UNSIGNED_BYTE&&(oe=o.R8UI),K===o.UNSIGNED_SHORT&&(oe=o.R16UI),K===o.UNSIGNED_INT&&(oe=o.R32UI),K===o.BYTE&&(oe=o.R8I),K===o.SHORT&&(oe=o.R16I),K===o.INT&&(oe=o.R32I)),M===o.RG&&(K===o.FLOAT&&(oe=o.RG32F),K===o.HALF_FLOAT&&(oe=o.RG16F),K===o.UNSIGNED_BYTE&&(oe=o.RG8)),M===o.RG_INTEGER&&(K===o.UNSIGNED_BYTE&&(oe=o.RG8UI),K===o.UNSIGNED_SHORT&&(oe=o.RG16UI),K===o.UNSIGNED_INT&&(oe=o.RG32UI),K===o.BYTE&&(oe=o.RG8I),K===o.SHORT&&(oe=o.RG16I),K===o.INT&&(oe=o.RG32I)),M===o.RGB_INTEGER&&(K===o.UNSIGNED_BYTE&&(oe=o.RGB8UI),K===o.UNSIGNED_SHORT&&(oe=o.RGB16UI),K===o.UNSIGNED_INT&&(oe=o.RGB32UI),K===o.BYTE&&(oe=o.RGB8I),K===o.SHORT&&(oe=o.RGB16I),K===o.INT&&(oe=o.RGB32I)),M===o.RGBA_INTEGER&&(K===o.UNSIGNED_BYTE&&(oe=o.RGBA8UI),K===o.UNSIGNED_SHORT&&(oe=o.RGBA16UI),K===o.UNSIGNED_INT&&(oe=o.RGBA32UI),K===o.BYTE&&(oe=o.RGBA8I),K===o.SHORT&&(oe=o.RGBA16I),K===o.INT&&(oe=o.RGBA32I)),M===o.RGB&&(K===o.UNSIGNED_INT_5_9_9_9_REV&&(oe=o.RGB9_E5),K===o.UNSIGNED_INT_10F_11F_11F_REV&&(oe=o.R11F_G11F_B10F)),M===o.RGBA){const qe=ve?Ec:Dt.getTransfer(pe);K===o.FLOAT&&(oe=o.RGBA32F),K===o.HALF_FLOAT&&(oe=o.RGBA16F),K===o.UNSIGNED_BYTE&&(oe=qe===Gt?o.SRGB8_ALPHA8:o.RGBA8),K===o.UNSIGNED_SHORT_4_4_4_4&&(oe=o.RGBA4),K===o.UNSIGNED_SHORT_5_5_5_1&&(oe=o.RGB5_A1)}return(oe===o.R16F||oe===o.R32F||oe===o.RG16F||oe===o.RG32F||oe===o.RGBA16F||oe===o.RGBA32F)&&t.get("EXT_color_buffer_float"),oe}function F(D,M){let K;return D?M===null||M===Ar||M===No?K=o.DEPTH24_STENCIL8:M===ca?K=o.DEPTH32F_STENCIL8:M===Lo&&(K=o.DEPTH24_STENCIL8,ot("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Ar||M===No?K=o.DEPTH_COMPONENT24:M===ca?K=o.DEPTH_COMPONENT32F:M===Lo&&(K=o.DEPTH_COMPONENT16),K}function k(D,M){return y(D)===!0||D.isFramebufferTexture&&D.minFilter!==ei&&D.minFilter!==di?Math.log2(Math.max(M.width,M.height))+1:D.mipmaps!==void 0&&D.mipmaps.length>0?D.mipmaps.length:D.isCompressedTexture&&Array.isArray(D.image)?M.mipmaps.length:1}function N(D){const M=D.target;M.removeEventListener("dispose",N),te(M),M.isVideoTexture&&_.delete(M)}function B(D){const M=D.target;M.removeEventListener("dispose",B),R(M)}function te(D){const M=r.get(D);if(M.__webglInit===void 0)return;const K=D.source,pe=S.get(K);if(pe){const ve=pe[M.__cacheKey];ve.usedTimes--,ve.usedTimes===0&&w(D),Object.keys(pe).length===0&&S.delete(K)}r.remove(D)}function w(D){const M=r.get(D);o.deleteTexture(M.__webglTexture);const K=D.source,pe=S.get(K);delete pe[M.__cacheKey],d.memory.textures--}function R(D){const M=r.get(D);if(D.depthTexture&&(D.depthTexture.dispose(),r.remove(D.depthTexture)),D.isWebGLCubeRenderTarget)for(let pe=0;pe<6;pe++){if(Array.isArray(M.__webglFramebuffer[pe]))for(let ve=0;ve<M.__webglFramebuffer[pe].length;ve++)o.deleteFramebuffer(M.__webglFramebuffer[pe][ve]);else o.deleteFramebuffer(M.__webglFramebuffer[pe]);M.__webglDepthbuffer&&o.deleteRenderbuffer(M.__webglDepthbuffer[pe])}else{if(Array.isArray(M.__webglFramebuffer))for(let pe=0;pe<M.__webglFramebuffer.length;pe++)o.deleteFramebuffer(M.__webglFramebuffer[pe]);else o.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&o.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&o.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let pe=0;pe<M.__webglColorRenderbuffer.length;pe++)M.__webglColorRenderbuffer[pe]&&o.deleteRenderbuffer(M.__webglColorRenderbuffer[pe]);M.__webglDepthRenderbuffer&&o.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const K=D.textures;for(let pe=0,ve=K.length;pe<ve;pe++){const oe=r.get(K[pe]);oe.__webglTexture&&(o.deleteTexture(oe.__webglTexture),d.memory.textures--),r.remove(K[pe])}r.remove(D)}let V=0;function $(){V=0}function se(){const D=V;return D>=l.maxTextures&&ot("WebGLTextures: Trying to use "+D+" texture units while this GPU supports only "+l.maxTextures),V+=1,D}function de(D){const M=[];return M.push(D.wrapS),M.push(D.wrapT),M.push(D.wrapR||0),M.push(D.magFilter),M.push(D.minFilter),M.push(D.anisotropy),M.push(D.internalFormat),M.push(D.format),M.push(D.type),M.push(D.generateMipmaps),M.push(D.premultiplyAlpha),M.push(D.flipY),M.push(D.unpackAlignment),M.push(D.colorSpace),M.join()}function fe(D,M){const K=r.get(D);if(D.isVideoTexture&&kt(D),D.isRenderTargetTexture===!1&&D.isExternalTexture!==!0&&D.version>0&&K.__version!==D.version){const pe=D.image;if(pe===null)ot("WebGLRenderer: Texture marked for update but no image data found.");else if(pe.complete===!1)ot("WebGLRenderer: Texture marked for update but image is incomplete");else{ne(K,D,M);return}}else D.isExternalTexture&&(K.__webglTexture=D.sourceTexture?D.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,K.__webglTexture,o.TEXTURE0+M)}function O(D,M){const K=r.get(D);if(D.isRenderTargetTexture===!1&&D.version>0&&K.__version!==D.version){ne(K,D,M);return}else D.isExternalTexture&&(K.__webglTexture=D.sourceTexture?D.sourceTexture:null);i.bindTexture(o.TEXTURE_2D_ARRAY,K.__webglTexture,o.TEXTURE0+M)}function j(D,M){const K=r.get(D);if(D.isRenderTargetTexture===!1&&D.version>0&&K.__version!==D.version){ne(K,D,M);return}i.bindTexture(o.TEXTURE_3D,K.__webglTexture,o.TEXTURE0+M)}function Y(D,M){const K=r.get(D);if(D.version>0&&K.__version!==D.version){le(K,D,M);return}i.bindTexture(o.TEXTURE_CUBE_MAP,K.__webglTexture,o.TEXTURE0+M)}const ge={[Ud]:o.REPEAT,[la]:o.CLAMP_TO_EDGE,[Ld]:o.MIRRORED_REPEAT},_e={[ei]:o.NEAREST,[$S]:o.NEAREST_MIPMAP_NEAREST,[Jl]:o.NEAREST_MIPMAP_LINEAR,[di]:o.LINEAR,[Xf]:o.LINEAR_MIPMAP_NEAREST,[Er]:o.LINEAR_MIPMAP_LINEAR},L={[ay]:o.NEVER,[uy]:o.ALWAYS,[ry]:o.LESS,[gg]:o.LEQUAL,[sy]:o.EQUAL,[cy]:o.GEQUAL,[oy]:o.GREATER,[ly]:o.NOTEQUAL};function ae(D,M){if(M.type===ca&&t.has("OES_texture_float_linear")===!1&&(M.magFilter===di||M.magFilter===Xf||M.magFilter===Jl||M.magFilter===Er||M.minFilter===di||M.minFilter===Xf||M.minFilter===Jl||M.minFilter===Er)&&ot("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(D,o.TEXTURE_WRAP_S,ge[M.wrapS]),o.texParameteri(D,o.TEXTURE_WRAP_T,ge[M.wrapT]),(D===o.TEXTURE_3D||D===o.TEXTURE_2D_ARRAY)&&o.texParameteri(D,o.TEXTURE_WRAP_R,ge[M.wrapR]),o.texParameteri(D,o.TEXTURE_MAG_FILTER,_e[M.magFilter]),o.texParameteri(D,o.TEXTURE_MIN_FILTER,_e[M.minFilter]),M.compareFunction&&(o.texParameteri(D,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(D,o.TEXTURE_COMPARE_FUNC,L[M.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===ei||M.minFilter!==Jl&&M.minFilter!==Er||M.type===ca&&t.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||r.get(M).__currentAnisotropy){const K=t.get("EXT_texture_filter_anisotropic");o.texParameterf(D,K.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,l.getMaxAnisotropy())),r.get(M).__currentAnisotropy=M.anisotropy}}}function ye(D,M){let K=!1;D.__webglInit===void 0&&(D.__webglInit=!0,M.addEventListener("dispose",N));const pe=M.source;let ve=S.get(pe);ve===void 0&&(ve={},S.set(pe,ve));const oe=de(M);if(oe!==D.__cacheKey){ve[oe]===void 0&&(ve[oe]={texture:o.createTexture(),usedTimes:0},d.memory.textures++,K=!0),ve[oe].usedTimes++;const qe=ve[D.__cacheKey];qe!==void 0&&(ve[D.__cacheKey].usedTimes--,qe.usedTimes===0&&w(M)),D.__cacheKey=oe,D.__webglTexture=ve[oe].texture}return K}function Ee(D,M,K){return Math.floor(Math.floor(D/K)/M)}function ze(D,M,K,pe){const oe=D.updateRanges;if(oe.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,M.width,M.height,K,pe,M.data);else{oe.sort((Se,Me)=>Se.start-Me.start);let qe=0;for(let Se=1;Se<oe.length;Se++){const Me=oe[qe],Ye=oe[Se],Ve=Me.start+Me.count,Oe=Ee(Ye.start,M.width,4),nt=Ee(Me.start,M.width,4);Ye.start<=Ve+1&&Oe===nt&&Ee(Ye.start+Ye.count-1,M.width,4)===Oe?Me.count=Math.max(Me.count,Ye.start+Ye.count-Me.start):(++qe,oe[qe]=Ye)}oe.length=qe+1;const Le=o.getParameter(o.UNPACK_ROW_LENGTH),Qe=o.getParameter(o.UNPACK_SKIP_PIXELS),We=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,M.width);for(let Se=0,Me=oe.length;Se<Me;Se++){const Ye=oe[Se],Ve=Math.floor(Ye.start/4),Oe=Math.ceil(Ye.count/4),nt=Ve%M.width,H=Math.floor(Ve/M.width),we=Oe,Ae=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,nt),o.pixelStorei(o.UNPACK_SKIP_ROWS,H),i.texSubImage2D(o.TEXTURE_2D,0,nt,H,we,Ae,K,pe,M.data)}D.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Le),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Qe),o.pixelStorei(o.UNPACK_SKIP_ROWS,We)}}function ne(D,M,K){let pe=o.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(pe=o.TEXTURE_2D_ARRAY),M.isData3DTexture&&(pe=o.TEXTURE_3D);const ve=ye(D,M),oe=M.source;i.bindTexture(pe,D.__webglTexture,o.TEXTURE0+K);const qe=r.get(oe);if(oe.version!==qe.__version||ve===!0){i.activeTexture(o.TEXTURE0+K);const Le=Dt.getPrimaries(Dt.workingColorSpace),Qe=M.colorSpace===Wa?null:Dt.getPrimaries(M.colorSpace),We=M.colorSpace===Wa||Le===Qe?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,M.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,M.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,We);let Se=C(M.image,!1,l.maxTextureSize);Se=je(M,Se);const Me=u.convert(M.format,M.colorSpace),Ye=u.convert(M.type);let Ve=U(M.internalFormat,Me,Ye,M.colorSpace,M.isVideoTexture);ae(pe,M);let Oe;const nt=M.mipmaps,H=M.isVideoTexture!==!0,we=qe.__version===void 0||ve===!0,Ae=oe.dataReady,Re=k(M,Se);if(M.isDepthTexture)Ve=F(M.format===zo,M.type),we&&(H?i.texStorage2D(o.TEXTURE_2D,1,Ve,Se.width,Se.height):i.texImage2D(o.TEXTURE_2D,0,Ve,Se.width,Se.height,0,Me,Ye,null));else if(M.isDataTexture)if(nt.length>0){H&&we&&i.texStorage2D(o.TEXTURE_2D,Re,Ve,nt[0].width,nt[0].height);for(let be=0,xe=nt.length;be<xe;be++)Oe=nt[be],H?Ae&&i.texSubImage2D(o.TEXTURE_2D,be,0,0,Oe.width,Oe.height,Me,Ye,Oe.data):i.texImage2D(o.TEXTURE_2D,be,Ve,Oe.width,Oe.height,0,Me,Ye,Oe.data);M.generateMipmaps=!1}else H?(we&&i.texStorage2D(o.TEXTURE_2D,Re,Ve,Se.width,Se.height),Ae&&ze(M,Se,Me,Ye)):i.texImage2D(o.TEXTURE_2D,0,Ve,Se.width,Se.height,0,Me,Ye,Se.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){H&&we&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Re,Ve,nt[0].width,nt[0].height,Se.depth);for(let be=0,xe=nt.length;be<xe;be++)if(Oe=nt[be],M.format!==bi)if(Me!==null)if(H){if(Ae)if(M.layerUpdates.size>0){const Be=Px(Oe.width,Oe.height,M.format,M.type);for(const it of M.layerUpdates){const Bt=Oe.data.subarray(it*Be/Oe.data.BYTES_PER_ELEMENT,(it+1)*Be/Oe.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,be,0,0,it,Oe.width,Oe.height,1,Me,Bt)}M.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,be,0,0,0,Oe.width,Oe.height,Se.depth,Me,Oe.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,be,Ve,Oe.width,Oe.height,Se.depth,0,Oe.data,0,0);else ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else H?Ae&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,be,0,0,0,Oe.width,Oe.height,Se.depth,Me,Ye,Oe.data):i.texImage3D(o.TEXTURE_2D_ARRAY,be,Ve,Oe.width,Oe.height,Se.depth,0,Me,Ye,Oe.data)}else{H&&we&&i.texStorage2D(o.TEXTURE_2D,Re,Ve,nt[0].width,nt[0].height);for(let be=0,xe=nt.length;be<xe;be++)Oe=nt[be],M.format!==bi?Me!==null?H?Ae&&i.compressedTexSubImage2D(o.TEXTURE_2D,be,0,0,Oe.width,Oe.height,Me,Oe.data):i.compressedTexImage2D(o.TEXTURE_2D,be,Ve,Oe.width,Oe.height,0,Oe.data):ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):H?Ae&&i.texSubImage2D(o.TEXTURE_2D,be,0,0,Oe.width,Oe.height,Me,Ye,Oe.data):i.texImage2D(o.TEXTURE_2D,be,Ve,Oe.width,Oe.height,0,Me,Ye,Oe.data)}else if(M.isDataArrayTexture)if(H){if(we&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Re,Ve,Se.width,Se.height,Se.depth),Ae)if(M.layerUpdates.size>0){const be=Px(Se.width,Se.height,M.format,M.type);for(const xe of M.layerUpdates){const Be=Se.data.subarray(xe*be/Se.data.BYTES_PER_ELEMENT,(xe+1)*be/Se.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,xe,Se.width,Se.height,1,Me,Ye,Be)}M.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,Se.width,Se.height,Se.depth,Me,Ye,Se.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Ve,Se.width,Se.height,Se.depth,0,Me,Ye,Se.data);else if(M.isData3DTexture)H?(we&&i.texStorage3D(o.TEXTURE_3D,Re,Ve,Se.width,Se.height,Se.depth),Ae&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,Se.width,Se.height,Se.depth,Me,Ye,Se.data)):i.texImage3D(o.TEXTURE_3D,0,Ve,Se.width,Se.height,Se.depth,0,Me,Ye,Se.data);else if(M.isFramebufferTexture){if(we)if(H)i.texStorage2D(o.TEXTURE_2D,Re,Ve,Se.width,Se.height);else{let be=Se.width,xe=Se.height;for(let Be=0;Be<Re;Be++)i.texImage2D(o.TEXTURE_2D,Be,Ve,be,xe,0,Me,Ye,null),be>>=1,xe>>=1}}else if(nt.length>0){if(H&&we){const be=at(nt[0]);i.texStorage2D(o.TEXTURE_2D,Re,Ve,be.width,be.height)}for(let be=0,xe=nt.length;be<xe;be++)Oe=nt[be],H?Ae&&i.texSubImage2D(o.TEXTURE_2D,be,0,0,Me,Ye,Oe):i.texImage2D(o.TEXTURE_2D,be,Ve,Me,Ye,Oe);M.generateMipmaps=!1}else if(H){if(we){const be=at(Se);i.texStorage2D(o.TEXTURE_2D,Re,Ve,be.width,be.height)}Ae&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Me,Ye,Se)}else i.texImage2D(o.TEXTURE_2D,0,Ve,Me,Ye,Se);y(M)&&v(pe),qe.__version=oe.version,M.onUpdate&&M.onUpdate(M)}D.__version=M.version}function le(D,M,K){if(M.image.length!==6)return;const pe=ye(D,M),ve=M.source;i.bindTexture(o.TEXTURE_CUBE_MAP,D.__webglTexture,o.TEXTURE0+K);const oe=r.get(ve);if(ve.version!==oe.__version||pe===!0){i.activeTexture(o.TEXTURE0+K);const qe=Dt.getPrimaries(Dt.workingColorSpace),Le=M.colorSpace===Wa?null:Dt.getPrimaries(M.colorSpace),Qe=M.colorSpace===Wa||qe===Le?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,M.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,M.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Qe);const We=M.isCompressedTexture||M.image[0].isCompressedTexture,Se=M.image[0]&&M.image[0].isDataTexture,Me=[];for(let xe=0;xe<6;xe++)!We&&!Se?Me[xe]=C(M.image[xe],!0,l.maxCubemapSize):Me[xe]=Se?M.image[xe].image:M.image[xe],Me[xe]=je(M,Me[xe]);const Ye=Me[0],Ve=u.convert(M.format,M.colorSpace),Oe=u.convert(M.type),nt=U(M.internalFormat,Ve,Oe,M.colorSpace),H=M.isVideoTexture!==!0,we=oe.__version===void 0||pe===!0,Ae=ve.dataReady;let Re=k(M,Ye);ae(o.TEXTURE_CUBE_MAP,M);let be;if(We){H&&we&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Re,nt,Ye.width,Ye.height);for(let xe=0;xe<6;xe++){be=Me[xe].mipmaps;for(let Be=0;Be<be.length;Be++){const it=be[Be];M.format!==bi?Ve!==null?H?Ae&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Be,0,0,it.width,it.height,Ve,it.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Be,nt,it.width,it.height,0,it.data):ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):H?Ae&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Be,0,0,it.width,it.height,Ve,Oe,it.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Be,nt,it.width,it.height,0,Ve,Oe,it.data)}}}else{if(be=M.mipmaps,H&&we){be.length>0&&Re++;const xe=at(Me[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Re,nt,xe.width,xe.height)}for(let xe=0;xe<6;xe++)if(Se){H?Ae&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,0,0,Me[xe].width,Me[xe].height,Ve,Oe,Me[xe].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,nt,Me[xe].width,Me[xe].height,0,Ve,Oe,Me[xe].data);for(let Be=0;Be<be.length;Be++){const Bt=be[Be].image[xe].image;H?Ae&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Be+1,0,0,Bt.width,Bt.height,Ve,Oe,Bt.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Be+1,nt,Bt.width,Bt.height,0,Ve,Oe,Bt.data)}}else{H?Ae&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,0,0,Ve,Oe,Me[xe]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,nt,Ve,Oe,Me[xe]);for(let Be=0;Be<be.length;Be++){const it=be[Be];H?Ae&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Be+1,0,0,Ve,Oe,it.image[xe]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Be+1,nt,Ve,Oe,it.image[xe])}}}y(M)&&v(o.TEXTURE_CUBE_MAP),oe.__version=ve.version,M.onUpdate&&M.onUpdate(M)}D.__version=M.version}function Ce(D,M,K,pe,ve,oe){const qe=u.convert(K.format,K.colorSpace),Le=u.convert(K.type),Qe=U(K.internalFormat,qe,Le,K.colorSpace),We=r.get(M),Se=r.get(K);if(Se.__renderTarget=M,!We.__hasExternalTextures){const Me=Math.max(1,M.width>>oe),Ye=Math.max(1,M.height>>oe);ve===o.TEXTURE_3D||ve===o.TEXTURE_2D_ARRAY?i.texImage3D(ve,oe,Qe,Me,Ye,M.depth,0,qe,Le,null):i.texImage2D(ve,oe,Qe,Me,Ye,0,qe,Le,null)}i.bindFramebuffer(o.FRAMEBUFFER,D),Ge(M)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,pe,ve,Se.__webglTexture,0,Ot(M)):(ve===o.TEXTURE_2D||ve>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&ve<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,pe,ve,Se.__webglTexture,oe),i.bindFramebuffer(o.FRAMEBUFFER,null)}function He(D,M,K){if(o.bindRenderbuffer(o.RENDERBUFFER,D),M.depthBuffer){const pe=M.depthTexture,ve=pe&&pe.isDepthTexture?pe.type:null,oe=F(M.stencilBuffer,ve),qe=M.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Le=Ot(M);Ge(M)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Le,oe,M.width,M.height):K?o.renderbufferStorageMultisample(o.RENDERBUFFER,Le,oe,M.width,M.height):o.renderbufferStorage(o.RENDERBUFFER,oe,M.width,M.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,qe,o.RENDERBUFFER,D)}else{const pe=M.textures;for(let ve=0;ve<pe.length;ve++){const oe=pe[ve],qe=u.convert(oe.format,oe.colorSpace),Le=u.convert(oe.type),Qe=U(oe.internalFormat,qe,Le,oe.colorSpace),We=Ot(M);K&&Ge(M)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,We,Qe,M.width,M.height):Ge(M)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,We,Qe,M.width,M.height):o.renderbufferStorage(o.RENDERBUFFER,Qe,M.width,M.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Xe(D,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,D),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const pe=r.get(M.depthTexture);pe.__renderTarget=M,(!pe.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),fe(M.depthTexture,0);const ve=pe.__webglTexture,oe=Ot(M);if(M.depthTexture.format===Oo)Ge(M)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,ve,0,oe):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,ve,0);else if(M.depthTexture.format===zo)Ge(M)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,ve,0,oe):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,ve,0);else throw new Error("Unknown depthTexture format")}function lt(D){const M=r.get(D),K=D.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==D.depthTexture){const pe=D.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),pe){const ve=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,pe.removeEventListener("dispose",ve)};pe.addEventListener("dispose",ve),M.__depthDisposeCallback=ve}M.__boundDepthTexture=pe}if(D.depthTexture&&!M.__autoAllocateDepthBuffer){if(K)throw new Error("target.depthTexture not supported in Cube render targets");const pe=D.texture.mipmaps;pe&&pe.length>0?Xe(M.__webglFramebuffer[0],D):Xe(M.__webglFramebuffer,D)}else if(K){M.__webglDepthbuffer=[];for(let pe=0;pe<6;pe++)if(i.bindFramebuffer(o.FRAMEBUFFER,M.__webglFramebuffer[pe]),M.__webglDepthbuffer[pe]===void 0)M.__webglDepthbuffer[pe]=o.createRenderbuffer(),He(M.__webglDepthbuffer[pe],D,!1);else{const ve=D.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,oe=M.__webglDepthbuffer[pe];o.bindRenderbuffer(o.RENDERBUFFER,oe),o.framebufferRenderbuffer(o.FRAMEBUFFER,ve,o.RENDERBUFFER,oe)}}else{const pe=D.texture.mipmaps;if(pe&&pe.length>0?i.bindFramebuffer(o.FRAMEBUFFER,M.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=o.createRenderbuffer(),He(M.__webglDepthbuffer,D,!1);else{const ve=D.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,oe=M.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,oe),o.framebufferRenderbuffer(o.FRAMEBUFFER,ve,o.RENDERBUFFER,oe)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function $t(D,M,K){const pe=r.get(D);M!==void 0&&Ce(pe.__webglFramebuffer,D,D.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),K!==void 0&&lt(D)}function dt(D){const M=D.texture,K=r.get(D),pe=r.get(M);D.addEventListener("dispose",B);const ve=D.textures,oe=D.isWebGLCubeRenderTarget===!0,qe=ve.length>1;if(qe||(pe.__webglTexture===void 0&&(pe.__webglTexture=o.createTexture()),pe.__version=M.version,d.memory.textures++),oe){K.__webglFramebuffer=[];for(let Le=0;Le<6;Le++)if(M.mipmaps&&M.mipmaps.length>0){K.__webglFramebuffer[Le]=[];for(let Qe=0;Qe<M.mipmaps.length;Qe++)K.__webglFramebuffer[Le][Qe]=o.createFramebuffer()}else K.__webglFramebuffer[Le]=o.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){K.__webglFramebuffer=[];for(let Le=0;Le<M.mipmaps.length;Le++)K.__webglFramebuffer[Le]=o.createFramebuffer()}else K.__webglFramebuffer=o.createFramebuffer();if(qe)for(let Le=0,Qe=ve.length;Le<Qe;Le++){const We=r.get(ve[Le]);We.__webglTexture===void 0&&(We.__webglTexture=o.createTexture(),d.memory.textures++)}if(D.samples>0&&Ge(D)===!1){K.__webglMultisampledFramebuffer=o.createFramebuffer(),K.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,K.__webglMultisampledFramebuffer);for(let Le=0;Le<ve.length;Le++){const Qe=ve[Le];K.__webglColorRenderbuffer[Le]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,K.__webglColorRenderbuffer[Le]);const We=u.convert(Qe.format,Qe.colorSpace),Se=u.convert(Qe.type),Me=U(Qe.internalFormat,We,Se,Qe.colorSpace,D.isXRRenderTarget===!0),Ye=Ot(D);o.renderbufferStorageMultisample(o.RENDERBUFFER,Ye,Me,D.width,D.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Le,o.RENDERBUFFER,K.__webglColorRenderbuffer[Le])}o.bindRenderbuffer(o.RENDERBUFFER,null),D.depthBuffer&&(K.__webglDepthRenderbuffer=o.createRenderbuffer(),He(K.__webglDepthRenderbuffer,D,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(oe){i.bindTexture(o.TEXTURE_CUBE_MAP,pe.__webglTexture),ae(o.TEXTURE_CUBE_MAP,M);for(let Le=0;Le<6;Le++)if(M.mipmaps&&M.mipmaps.length>0)for(let Qe=0;Qe<M.mipmaps.length;Qe++)Ce(K.__webglFramebuffer[Le][Qe],D,M,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Le,Qe);else Ce(K.__webglFramebuffer[Le],D,M,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Le,0);y(M)&&v(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(qe){for(let Le=0,Qe=ve.length;Le<Qe;Le++){const We=ve[Le],Se=r.get(We);let Me=o.TEXTURE_2D;(D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(Me=D.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Me,Se.__webglTexture),ae(Me,We),Ce(K.__webglFramebuffer,D,We,o.COLOR_ATTACHMENT0+Le,Me,0),y(We)&&v(Me)}i.unbindTexture()}else{let Le=o.TEXTURE_2D;if((D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(Le=D.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Le,pe.__webglTexture),ae(Le,M),M.mipmaps&&M.mipmaps.length>0)for(let Qe=0;Qe<M.mipmaps.length;Qe++)Ce(K.__webglFramebuffer[Qe],D,M,o.COLOR_ATTACHMENT0,Le,Qe);else Ce(K.__webglFramebuffer,D,M,o.COLOR_ATTACHMENT0,Le,0);y(M)&&v(Le),i.unbindTexture()}D.depthBuffer&&lt(D)}function Tt(D){const M=D.textures;for(let K=0,pe=M.length;K<pe;K++){const ve=M[K];if(y(ve)){const oe=P(D),qe=r.get(ve).__webglTexture;i.bindTexture(oe,qe),v(oe),i.unbindTexture()}}}const I=[],ht=[];function mt(D){if(D.samples>0){if(Ge(D)===!1){const M=D.textures,K=D.width,pe=D.height;let ve=o.COLOR_BUFFER_BIT;const oe=D.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,qe=r.get(D),Le=M.length>1;if(Le)for(let We=0;We<M.length;We++)i.bindFramebuffer(o.FRAMEBUFFER,qe.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+We,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,qe.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+We,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,qe.__webglMultisampledFramebuffer);const Qe=D.texture.mipmaps;Qe&&Qe.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qe.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qe.__webglFramebuffer);for(let We=0;We<M.length;We++){if(D.resolveDepthBuffer&&(D.depthBuffer&&(ve|=o.DEPTH_BUFFER_BIT),D.stencilBuffer&&D.resolveStencilBuffer&&(ve|=o.STENCIL_BUFFER_BIT)),Le){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,qe.__webglColorRenderbuffer[We]);const Se=r.get(M[We]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,Se,0)}o.blitFramebuffer(0,0,K,pe,0,0,K,pe,ve,o.NEAREST),m===!0&&(I.length=0,ht.length=0,I.push(o.COLOR_ATTACHMENT0+We),D.depthBuffer&&D.resolveDepthBuffer===!1&&(I.push(oe),ht.push(oe),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,ht)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,I))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Le)for(let We=0;We<M.length;We++){i.bindFramebuffer(o.FRAMEBUFFER,qe.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+We,o.RENDERBUFFER,qe.__webglColorRenderbuffer[We]);const Se=r.get(M[We]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,qe.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+We,o.TEXTURE_2D,Se,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qe.__webglMultisampledFramebuffer)}else if(D.depthBuffer&&D.resolveDepthBuffer===!1&&m){const M=D.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[M])}}}function Ot(D){return Math.min(l.maxSamples,D.samples)}function Ge(D){const M=r.get(D);return D.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function kt(D){const M=d.render.frame;_.get(D)!==M&&(_.set(D,M),D.update())}function je(D,M){const K=D.colorSpace,pe=D.format,ve=D.type;return D.isCompressedTexture===!0||D.isVideoTexture===!0||K!==Es&&K!==Wa&&(Dt.getTransfer(K)===Gt?(pe!==bi||ve!==da)&&ot("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):nn("WebGLTextures: Unsupported texture color space:",K)),M}function at(D){return typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement?(p.width=D.naturalWidth||D.width,p.height=D.naturalHeight||D.height):typeof VideoFrame<"u"&&D instanceof VideoFrame?(p.width=D.displayWidth,p.height=D.displayHeight):(p.width=D.width,p.height=D.height),p}this.allocateTextureUnit=se,this.resetTextureUnits=$,this.setTexture2D=fe,this.setTexture2DArray=O,this.setTexture3D=j,this.setTextureCube=Y,this.rebindTextures=$t,this.setupRenderTarget=dt,this.updateRenderTargetMipmap=Tt,this.updateMultisampleRenderTarget=mt,this.setupDepthRenderbuffer=lt,this.setupFrameBufferTexture=Ce,this.useMultisampledRTT=Ge}function ME(o,t){function i(r,l=Wa){let u;const d=Dt.getTransfer(l);if(r===da)return o.UNSIGNED_BYTE;if(r===dh)return o.UNSIGNED_SHORT_4_4_4_4;if(r===hh)return o.UNSIGNED_SHORT_5_5_5_1;if(r===dg)return o.UNSIGNED_INT_5_9_9_9_REV;if(r===hg)return o.UNSIGNED_INT_10F_11F_11F_REV;if(r===ug)return o.BYTE;if(r===fg)return o.SHORT;if(r===Lo)return o.UNSIGNED_SHORT;if(r===fh)return o.INT;if(r===Ar)return o.UNSIGNED_INT;if(r===ca)return o.FLOAT;if(r===Rs)return o.HALF_FLOAT;if(r===pg)return o.ALPHA;if(r===mg)return o.RGB;if(r===bi)return o.RGBA;if(r===Oo)return o.DEPTH_COMPONENT;if(r===zo)return o.DEPTH_STENCIL;if(r===xg)return o.RED;if(r===ph)return o.RED_INTEGER;if(r===mh)return o.RG;if(r===xh)return o.RG_INTEGER;if(r===gh)return o.RGBA_INTEGER;if(r===vc||r===Sc||r===yc||r===bc)if(d===Gt)if(u=t.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===vc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Sc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===yc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===bc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=t.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===vc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Sc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===yc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===bc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Nd||r===Od||r===zd||r===Pd)if(u=t.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Nd)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Od)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===zd)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Pd)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Bd||r===Fd||r===Id)if(u=t.get("WEBGL_compressed_texture_etc"),u!==null){if(r===Bd||r===Fd)return d===Gt?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===Id)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Hd||r===Gd||r===Vd||r===kd||r===Xd||r===Wd||r===qd||r===Yd||r===jd||r===Zd||r===Kd||r===Qd||r===Jd||r===$d)if(u=t.get("WEBGL_compressed_texture_astc"),u!==null){if(r===Hd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Gd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Vd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===kd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Xd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Wd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===qd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Yd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===jd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Zd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Kd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===Qd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===Jd)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===$d)return d===Gt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===eh||r===th||r===nh)if(u=t.get("EXT_texture_compression_bptc"),u!==null){if(r===eh)return d===Gt?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===th)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===nh)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===ih||r===ah||r===rh||r===sh)if(u=t.get("EXT_texture_compression_rgtc"),u!==null){if(r===ih)return u.COMPRESSED_RED_RGTC1_EXT;if(r===ah)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===rh)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===sh)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===No?o.UNSIGNED_INT_24_8:o[r]!==void 0?o[r]:null}return{convert:i}}const EE=`
void main() {
...
}`;class AE{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const r=new Dg(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,r=new Mi({vertexShader:EE,fragmentShader:TE,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Li(new As(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class RE extends Cs{constructor(t,i){super();const r=this;let l=null,u=1,d=null,h="local-floor",m=1,p=null,_=null,x=null,S=null,b=null,A=null;const C=typeof XRWebGLBinding<"u",y=new AE,v={},P=i.getContextAttributes();let U=null,F=null;const k=[],N=[],B=new Ut;let te=null;const w=new Si;w.viewport=new an;const R=new Si;R.viewport=new an;const V=[w,R],$=new Wy;let se=null,de=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ne){let le=k[ne];return le===void 0&&(le=new hd,k[ne]=le),le.getTargetRaySpace()},this.getControllerGrip=function(ne){let le=k[ne];return le===void 0&&(le=new hd,k[ne]=le),le.getGripSpace()},this.getHand=function(ne){let le=k[ne];return le===void 0&&(le=new hd,k[ne]=le),le.getHandSpace()};function fe(ne){const le=N.indexOf(ne.inputSource);if(le===-1)return;const Ce=k[le];Ce!==void 0&&(Ce.update(ne.inputSource,ne.frame,p||d),Ce.dispatchEvent({type:ne.type,data:ne.inputSource}))}function O(){l.removeEventListener("select",fe),l.removeEventListener("selectstart",fe),l.removeEventListener("selectend",fe),l.removeEventListener("squeeze",fe),l.removeEventListener("squeezestart",fe),l.removeEventListener("squeezeend",fe),l.removeEventListener("end",O),l.removeEventListener("inputsourceschange",j);for(let ne=0;ne<k.length;ne++){const le=N[ne];le!==null&&(N[ne]=null,k[ne].disconnect(le))}se=null,de=null,y.reset();for(const ne in v)delete v[ne];t.setRenderTarget(U),b=null,S=null,x=null,l=null,F=null,ze.stop(),r.isPresenting=!1,t.setPixelRatio(te),t.setSize(B.width,B.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ne){u=ne,r.isPresenting===!0&&ot("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ne){h=ne,r.isPresenting===!0&&ot("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||d},this.setReferenceSpace=function(ne){p=ne},this.getBaseLayer=function(){return S!==null?S:b},this.getBinding=function(){return x===null&&C&&(x=new XRWebGLBinding(l,i)),x},this.getFrame=function(){return A},this.getSession=function(){return l},this.setSession=async function(ne){if(l=ne,l!==null){if(U=t.getRenderTarget(),l.addEventListener("select",fe),l.addEventListener("selectstart",fe),l.addEventListener("selectend",fe),l.addEventListener("squeeze",fe),l.addEventListener("squeezestart",fe),l.addEventListener("squeezeend",fe),l.addEventListener("end",O),l.addEventListener("inputsourceschange",j),P.xrCompatible!==!0&&await i.makeXRCompatible(),te=t.getPixelRatio(),t.getSize(B),C&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ce=null,He=null,Xe=null;P.depth&&(Xe=P.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Ce=P.stencil?zo:Oo,He=P.stencil?No:Ar);const lt={colorFormat:i.RGBA8,depthFormat:Xe,scaleFactor:u};x=this.getBinding(),S=x.createProjectionLayer(lt),l.updateRenderState({layers:[S]}),t.setPixelRatio(1),t.setSize(S.textureWidth,S.textureHeight,!1),F=new Za(S.textureWidth,S.textureHeight,{format:bi,type:da,depthTexture:new wg(S.textureWidth,S.textureHeight,He,void 0,void 0,void 0,void 0,void 0,void 0,Ce),stencilBuffer:P.stencil,colorSpace:t.outputColorSpace,samples:P.antialias?4:0,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}else{const Ce={antialias:P.antialias,alpha:!0,depth:P.depth,stencil:P.stencil,framebufferScaleFactor:u};b=new XRWebGLLayer(l,i,Ce),l.updateRenderState({baseLayer:b}),t.setPixelRatio(1),t.setSize(b.framebufferWidth,b.framebufferHeight,!1),F=new Za(b.framebufferWidth,b.framebufferHeight,{format:bi,type:da,colorSpace:t.outputColorSpace,stencilBuffer:P.stencil,resolveDepthBuffer:b.ignoreDepthValues===!1,resolveStencilBuffer:b.ignoreDepthValues===!1})}F.isXRRenderTarget=!0,this.setFoveation(m),p=null,d=await l.requestReferenceSpace(h),ze.setContext(l),ze.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function j(ne){for(let le=0;le<ne.removed.length;le++){const Ce=ne.removed[le],He=N.indexOf(Ce);He>=0&&(N[He]=null,k[He].disconnect(Ce))}for(let le=0;le<ne.added.length;le++){const Ce=ne.added[le];let He=N.indexOf(Ce);if(He===-1){for(let lt=0;lt<k.length;lt++)if(lt>=N.length){N.push(Ce),He=lt;break}else if(N[lt]===null){N[lt]=Ce,He=lt;break}if(He===-1)break}const Xe=k[He];Xe&&Xe.connect(Ce)}}const Y=new ce,ge=new ce;function _e(ne,le,Ce){Y.setFromMatrixPosition(le.matrixWorld),ge.setFromMatrixPosition(Ce.matrixWorld);const He=Y.distanceTo(ge),Xe=le.projectionMatrix.elements,lt=Ce.projectionMatrix.elements,$t=Xe[14]/(Xe[10]-1),dt=Xe[14]/(Xe[10]+1),Tt=(Xe[9]+1)/Xe[5],I=(Xe[9]-1)/Xe[5],ht=(Xe[8]-1)/Xe[0],mt=(lt[8]+1)/lt[0],Ot=$t*ht,Ge=$t*mt,kt=He/(-ht+mt),je=kt*-ht;if(le.matrixWorld.decompose(ne.position,ne.quaternion,ne.scale),ne.translateX(je),ne.translateZ(kt),ne.matrixWorld.compose(ne.position,ne.quaternion,ne.scale),ne.matrixWorldInverse.copy(ne.matrixWorld).invert(),Xe[10]===-1)ne.projectionMatrix.copy(le.projectionMatrix),ne.projectionMatrixInverse.copy(le.projectionMatrixInverse);else{const at=$t+kt,D=dt+kt,M=Ot-je,K=Ge+(He-je),pe=Tt*dt/D*at,ve=I*dt/D*at;ne.projectionMatrix.makePerspective(M,K,pe,ve,at,D),ne.projectionMatrixInverse.copy(ne.projectionMatrix).invert()}}function L(ne,le){le===null?ne.matrixWorld.copy(ne.matrix):ne.matrixWorld.multiplyMatrices(le.matrixWorld,ne.matrix),ne.matrixWorldInverse.copy(ne.matrixWorld).invert()}this.updateCamera=function(ne){if(l===null)return;let le=ne.near,Ce=ne.far;y.texture!==null&&(y.depthNear>0&&(le=y.depthNear),y.depthFar>0&&(Ce=y.depthFar)),$.near=R.near=w.near=le,$.far=R.far=w.far=Ce,(se!==$.near||de!==$.far)&&(l.updateRenderState({depthNear:$.near,depthFar:$.far}),se=$.near,de=$.far),$.layers.mask=ne.layers.mask|6,w.layers.mask=$.layers.mask&3,R.layers.mask=$.layers.mask&5;const He=ne.parent,Xe=$.cameras;L($,He);for(let lt=0;lt<Xe.length;lt++)L(Xe[lt],He);Xe.length===2?_e($,w,R):$.projectionMatrix.copy(w.projectionMatrix),ae(ne,$,He)};function ae(ne,le,Ce){Ce===null?ne.matrix.copy(le.matrixWorld):(ne.matrix.copy(Ce.matrixWorld),ne.matrix.invert(),ne.matrix.multiply(le.matrixWorld)),ne.matrix.decompose(ne.position,ne.quaternion,ne.scale),ne.updateMatrixWorld(!0),ne.projectionMatrix.copy(le.projectionMatrix),ne.projectionMatrixInverse.copy(le.projectionMatrixInverse),ne.isPerspectiveCamera&&(ne.fov=oh*2*Math.atan(1/ne.projectionMatrix.elements[5]),ne.zoom=1)}this.getCamera=function(){return $},this.getFoveation=function(){if(!(S===null&&b===null))return m},this.setFoveation=function(ne){m=ne,S!==null&&(S.fixedFoveation=ne),b!==null&&b.fixedFoveation!==void 0&&(b.fixedFoveation=ne)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh($)},this.getCameraTexture=function(ne){return v[ne]};let ye=null;function Ee(ne,le){if(_=le.getViewerPose(p||d),A=le,_!==null){const Ce=_.views;b!==null&&(t.setRenderTargetFramebuffer(F,b.framebuffer),t.setRenderTarget(F));let He=!1;Ce.length!==$.cameras.length&&($.cameras.length=0,He=!0);for(let dt=0;dt<Ce.length;dt++){const Tt=Ce[dt];let I=null;if(b!==null)I=b.getViewport(Tt);else{const mt=x.getViewSubImage(S,Tt);I=mt.viewport,dt===0&&(t.setRenderTargetTextures(F,mt.colorTexture,mt.depthStencilTexture),t.setRenderTarget(F))}let ht=V[dt];ht===void 0&&(ht=new Si,ht.layers.enable(dt),ht.viewport=new an,V[dt]=ht),ht.matrix.fromArray(Tt.transform.matrix),ht.matrix.decompose(ht.position,ht.quaternion,ht.scale),ht.projectionMatrix.fromArray(Tt.projectionMatrix),ht.projectionMatrixInverse.copy(ht.projectionMatrix).invert(),ht.viewport.set(I.x,I.y,I.width,I.height),dt===0&&($.matrix.copy(ht.matrix),$.matrix.decompose($.position,$.quaternion,$.scale)),He===!0&&$.cameras.push(ht)}const Xe=l.enabledFeatures;if(Xe&&Xe.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&C){x=r.getBinding();const dt=x.getDepthInformation(Ce[0]);dt&&dt.isValid&&dt.texture&&y.init(dt,l.renderState)}if(Xe&&Xe.includes("camera-access")&&C){t.state.unbindTexture(),x=r.getBinding();for(let dt=0;dt<Ce.length;dt++){const Tt=Ce[dt].camera;if(Tt){let I=v[Tt];I||(I=new Dg,v[Tt]=I);const ht=x.getCameraImage(Tt);I.sourceTexture=ht}}}}for(let Ce=0;Ce<k.length;Ce++){const He=N[Ce],Xe=k[Ce];He!==null&&Xe!==void 0&&Xe.update(He,le,p||d)}ye&&ye(ne,le),le.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:le}),A=null}const ze=new Lg;ze.setAnimationLoop(Ee),this.setAnimationLoop=function(ne){ye=ne},this.dispose=function(){}}}const Sr=new ha,CE=new mn;function wE(o,t){function i(y,v){y.matrixAutoUpdate===!0&&y.updateMatrix(),v.value.copy(y.matrix)}function r(y,v){v.color.getRGB(y.fogColor.value,Tg(o)),v.isFog?(y.fogNear.value=v.near,y.fogFar.value=v.far):v.isFogExp2&&(y.fogDensity.value=v.density)}function l(y,v,P,U,F){v.isMeshBasicMaterial||v.isMeshLambertMaterial?u(y,v):v.isMeshToonMaterial?(u(y,v),x(y,v)):v.isMeshPhongMaterial?(u(y,v),_(y,v)):v.isMeshStandardMaterial?(u(y,v),S(y,v),v.isMeshPhysicalMaterial&&b(y,v,F)):v.isMeshMatcapMaterial?(u(y,v),A(y,v)):v.isMeshDepthMaterial?u(y,v):v.isMeshDistanceMaterial?(u(y,v),C(y,v)):v.isMeshNormalMaterial?u(y,v):v.isLineBasicMaterial?(d(y,v),v.isLineDashedMaterial&&h(y,v)):v.isPointsMaterial?m(y,v,P,U):v.isSpriteMaterial?p(y,v):v.isShadowMaterial?(y.color.value.copy(v.color),y.opacity.value=v.opacity):v.isShaderMaterial&&(v.uniformsNeedUpdate=!1)}function u(y,v){y.opacity.value=v.opacity,v.color&&y.diffuse.value.copy(v.color),v.emissive&&y.emissive.value.copy(v.emissive).multiplyScalar(v.emissiveIntensity),v.map&&(y.map.value=v.map,i(v.map,y.mapTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.bumpMap&&(y.bumpMap.value=v.bumpMap,i(v.bumpMap,y.bumpMapTransform),y.bumpScale.value=v.bumpScale,v.side===Vn&&(y.bumpScale.value*=-1)),v.normalMap&&(y.normalMap.value=v.normalMap,i(v.normalMap,y.normalMapTransform),y.normalScale.value.copy(v.normalScale),v.side===Vn&&y.normalScale.value.negate()),v.displacementMap&&(y.displacementMap.value=v.displacementMap,i(v.displacementMap,y.displacementMapTransform),y.displacementScale.value=v.displacementScale,y.displacementBias.value=v.displacementBias),v.emissiveMap&&(y.emissiveMap.value=v.emissiveMap,i(v.emissiveMap,y.emissiveMapTransform)),v.specularMap&&(y.specularMap.value=v.specularMap,i(v.specularMap,y.specularMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest);const P=t.get(v),U=P.envMap,F=P.envMapRotation;U&&(y.envMap.value=U,Sr.copy(F),Sr.x*=-1,Sr.y*=-1,Sr.z*=-1,U.isCubeTexture&&U.isRenderTargetTexture===!1&&(Sr.y*=-1,Sr.z*=-1),y.envMapRotation.value.setFromMatrix4(CE.makeRotationFromEuler(Sr)),y.flipEnvMap.value=U.isCubeTexture&&U.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=v.reflectivity,y.ior.value=v.ior,y.refractionRatio.value=v.refractionRatio),v.lightMap&&(y.lightMap.value=v.lightMap,y.lightMapIntensity.value=v.lightMapIntensity,i(v.lightMap,y.lightMapTransform)),v.aoMap&&(y.aoMap.value=v.aoMap,y.aoMapIntensity.value=v.aoMapIntensity,i(v.aoMap,y.aoMapTransform))}function d(y,v){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,v.map&&(y.map.value=v.map,i(v.map,y.mapTransform))}function h(y,v){y.dashSize.value=v.dashSize,y.totalSize.value=v.dashSize+v.gapSize,y.scale.value=v.scale}function m(y,v,P,U){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,y.size.value=v.size*P,y.scale.value=U*.5,v.map&&(y.map.value=v.map,i(v.map,y.uvTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest)}function p(y,v){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,y.rotation.value=v.rotation,v.map&&(y.map.value=v.map,i(v.map,y.mapTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest)}function _(y,v){y.specular.value.copy(v.specular),y.shininess.value=Math.max(v.shininess,1e-4)}function x(y,v){v.gradientMap&&(y.gradientMap.value=v.gradientMap)}function S(y,v){y.metalness.value=v.metalness,v.metalnessMap&&(y.metalnessMap.value=v.metalnessMap,i(v.metalnessMap,y.metalnessMapTransform)),y.roughness.value=v.roughness,v.roughnessMap&&(y.roughnessMap.value=v.roughnessMap,i(v.roughnessMap,y.roughnessMapTransform)),v.envMap&&(y.envMapIntensity.value=v.envMapIntensity)}function b(y,v,P){y.ior.value=v.ior,v.sheen>0&&(y.sheenColor.value.copy(v.sheenColor).multiplyScalar(v.sheen),y.sheenRoughness.value=v.sheenRoughness,v.sheenColorMap&&(y.sheenColorMap.value=v.sheenColorMap,i(v.sheenColorMap,y.sheenColorMapTransform)),v.sheenRoughnessMap&&(y.sheenRoughnessMap.value=v.sheenRoughnessMap,i(v.sheenRoughnessMap,y.sheenRoughnessMapTransform))),v.clearcoat>0&&(y.clearcoat.value=v.clearcoat,y.clearcoatRoughness.value=v.clearcoatRoughness,v.clearcoatMap&&(y.clearcoatMap.value=v.clearcoatMap,i(v.clearcoatMap,y.clearcoatMapTransform)),v.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=v.clearcoatRoughnessMap,i(v.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),v.clearcoatNormalMap&&(y.clearcoatNormalMap.value=v.clearcoatNormalMap,i(v.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(v.clearcoatNormalScale),v.side===Vn&&y.clearcoatNormalScale.value.negate())),v.dispersion>0&&(y.dispersion.value=v.dispersion),v.iridescence>0&&(y.iridescence.value=v.iridescence,y.iridescenceIOR.value=v.iridescenceIOR,y.iridescenceThicknessMinimum.value=v.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=v.iridescenceThicknessRange[1],v.iridescenceMap&&(y.iridescenceMap.value=v.iridescenceMap,i(v.iridescenceMap,y.iridescenceMapTransform)),v.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=v.iridescenceThicknessMap,i(v.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),v.transmission>0&&(y.transmission.value=v.transmission,y.transmissionSamplerMap.value=P.texture,y.transmissionSamplerSize.value.set(P.width,P.height),v.transmissionMap&&(y.transmissionMap.value=v.transmissionMap,i(v.transmissionMap,y.transmissionMapTransform)),y.thickness.value=v.thickness,v.thicknessMap&&(y.thicknessMap.value=v.thicknessMap,i(v.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=v.attenuationDistance,y.attenuationColor.value.copy(v.attenuationColor)),v.anisotropy>0&&(y.anisotropyVector.value.set(v.anisotropy*Math.cos(v.anisotropyRotation),v.anisotropy*Math.sin(v.anisotropyRotation)),v.anisotropyMap&&(y.anisotropyMap.value=v.anisotropyMap,i(v.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=v.specularIntensity,y.specularColor.value.copy(v.specularColor),v.specularColorMap&&(y.specularColorMap.value=v.specularColorMap,i(v.specularColorMap,y.specularColorMapTransform)),v.specularIntensityMap&&(y.specularIntensityMap.value=v.specularIntensityMap,i(v.specularIntensityMap,y.specularIntensityMapTransform))}function A(y,v){v.matcap&&(y.matcap.value=v.matcap)}function C(y,v){const P=t.get(v).light;y.referencePosition.value.setFromMatrixPosition(P.matrixWorld),y.nearDistance.value=P.shadow.camera.near,y.farDistance.value=P.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function DE(o,t,i,r){let l={},u={},d=[];const h=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function m(P,U){const F=U.program;r.uniformBlockBinding(P,F)}function p(P,U){let F=l[P.id];F===void 0&&(A(P),F=_(P),l[P.id]=F,P.addEventListener("dispose",y));const k=U.program;r.updateUBOMapping(P,k);const N=t.render.frame;u[P.id]!==N&&(S(P),u[P.id]=N)}function _(P){const U=x();P.__bindingPointIndex=U;const F=o.createBuffer(),k=P.__size,N=P.usage;return o.bindBuffer(o.UNIFORM_BUFFER,F),o.bufferData(o.UNIFORM_BUFFER,k,N),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,U,F),F}function x(){for(let P=0;P<h;P++)if(d.indexOf(P)===-1)return d.push(P),P;return nn("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function S(P){const U=l[P.id],F=P.uniforms,k=P.__cache;o.bindBuffer(o.UNIFORM_BUFFER,U);for(let N=0,B=F.length;N<B;N++){const te=Array.isArray(F[N])?F[N]:[F[N]];for(let w=0,R=te.length;w<R;w++){const V=te[w];if(b(V,N,w,k)===!0){const $=V.__offset,se=Array.isArray(V.value)?V.value:[V.value];let de=0;for(let fe=0;fe<se.length;fe++){const O=se[fe],j=C(O);typeof O=="number"||typeof O=="boolean"?(V.__data[0]=O,o.bufferSubData(o.UNIFORM_BUFFER,$+de,V.__data)):O.isMatrix3?(V.__data[0]=O.elements[0],V.__data[1]=O.elements[1],V.__data[2]=O.elements[2],V.__data[3]=0,V.__data[4]=O.elements[3],V.__data[5]=O.elements[4],V.__data[6]=O.elements[5],V.__data[7]=0,V.__data[8]=O.elements[6],V.__data[9]=O.elements[7],V.__data[10]=O.elements[8],V.__data[11]=0):(O.toArray(V.__data,de),de+=j.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,$,V.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function b(P,U,F,k){const N=P.value,B=U+"_"+F;if(k[B]===void 0)return typeof N=="number"||typeof N=="boolean"?k[B]=N:k[B]=N.clone(),!0;{const te=k[B];if(typeof N=="number"||typeof N=="boolean"){if(te!==N)return k[B]=N,!0}else if(te.equals(N)===!1)return te.copy(N),!0}return!1}function A(P){const U=P.uniforms;let F=0;const k=16;for(let B=0,te=U.length;B<te;B++){const w=Array.isArray(U[B])?U[B]:[U[B]];for(let R=0,V=w.length;R<V;R++){const $=w[R],se=Array.isArray($.value)?$.value:[$.value];for(let de=0,fe=se.length;de<fe;de++){const O=se[de],j=C(O),Y=F%k,ge=Y%j.boundary,_e=Y+ge;F+=ge,_e!==0&&k-_e<j.storage&&(F+=k-_e),$.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=F,F+=j.storage}}}const N=F%k;return N>0&&(F+=k-N),P.__size=F,P.__cache={},this}function C(P){const U={boundary:0,storage:0};return typeof P=="number"||typeof P=="boolean"?(U.boundary=4,U.storage=4):P.isVector2?(U.boundary=8,U.storage=8):P.isVector3||P.isColor?(U.boundary=16,U.storage=12):P.isVector4?(U.boundary=16,U.storage=16):P.isMatrix3?(U.boundary=48,U.storage=48):P.isMatrix4?(U.boundary=64,U.storage=64):P.isTexture?ot("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ot("WebGLRenderer: Unsupported uniform value type.",P),U}function y(P){const U=P.target;U.removeEventListener("dispose",y);const F=d.indexOf(U.__bindingPointIndex);d.splice(F,1),o.deleteBuffer(l[U.id]),delete l[U.id],delete u[U.id]}function v(){for(const P in l)o.deleteBuffer(l[P]);d=[],l={},u={}}return{bind:m,update:p,dispose:v}}const UE=new Uint16Array([11481,15204,11534,15171,11808,15015,12385,14843,12894,14716,13396,14600,13693,14483,13976,14366,14237,14171,14405,13961,14511,13770,14605,13598,14687,13444,14760,13305,14822,13066,14876,12857,14923,12675,14963,12517,14997,12379,15025,12230,15049,12023,15070,11843,15086,11687,15100,11551,15111,11433,15120,11330,15127,11217,15132,11060,15135,10922,15138,10801,15139,10695,15139,10600,13012,14923,13020,14917,13064,14886,13176,14800,13349,14666,13513,14526,13724,14398,13960,14230,14200,14020,14383,13827,14488,13651,14583,13491,14667,13348,14740,13132,14803,12908,14856,12713,14901,12542,14938,12394,14968,12241,14992,12017,15010,11822,15024,11654,15034,11507,15041,11380,15044,11269,15044,11081,15042,10913,15037,10764,15031,10635,15023,10520,15014,10419,15003,10330,13657,14676,13658,14673,13670,14660,13698,14622,13750,14547,13834,14442,13956,14317,14112,14093,14291,13889,14407,13704,14499,13538,14586,13389,14664,13201,14733,12966,14792,12758,14842,12577,14882,12418,14915,12272,14940,12033,14959,11826,14972,11646,14980,11490,14983,11355,14983,11212,14979,11008,14971,10830,14961,10675,14950,10540,14936,10420,14923,10315,14909,10204,14894,10041,14089,14460,14090,14459,14096,14452,14112,14431,14141,14388,14186,14305,14252,14130,14341,13941,14399,13756,14467,13585,14539,13430,14610,13272,14677,13026,14737,12808,14790,12617,14833,12449,14869,12303,14896,12065,14916,11845,14929,11655,14937,11490,14939,11347,14936,11184,14930,10970,14921,10783,14912,10621,14900,10480,14885,10356,14867,10247,14848,10062,14827,9894,14805,9745,14400,14208,14400,14206,14402,14198,14406,14174,14415,14122,14427,14035,14444,13913,14469,13767,14504,13613,14548,13463,14598,13324,14651,13082,14704,12858,14752,12658,14795,12483,14831,12330,14860,12106,14881,11875,14895,11675,14903,11501,14905,11351,14903,11178,14900,10953,14892,10757,14880,10589,14865,10442,14847,10313,14827,10162,14805,9965,14782,9792,14757,9642,14731,9507,14562,13883,14562,13883,14563,13877,14566,13862,14570,13830,14576,13773,14584,13689,14595,13582,14613,13461,14637,13336,14668,13120,14704,12897,14741,12695,14776,12516,14808,12358,14835,12150,14856,11910,14870,11701,14878,11519,14882,11361,14884,11187,14880,10951,14871,10748,14858,10572,14842,10418,14823,10286,14801,10099,14777,9897,14751,9722,14725,9567,14696,9430,14666,9309,14702,13604,14702,13604,14702,13600,14703,13591,14705,13570,14707,13533,14709,13477,14712,13400,14718,13305,14727,13106,14743,12907,14762,12716,14784,12539,14807,12380,14827,12190,14844,11943,14855,11727,14863,11539,14870,11376,14871,11204,14868,10960,14858,10748,14845,10565,14829,10406,14809,10269,14786,10058,14761,9852,14734,9671,14705,9512,14674,9374,14641,9253,14608,9076,14821,13366,14821,13365,14821,13364,14821,13358,14821,13344,14821,13320,14819,13252,14817,13145,14815,13011,14814,12858,14817,12698,14823,12539,14832,12389,14841,12214,14850,11968,14856,11750,14861,11558,14866,11390,14867,11226,14862,10972,14853,10754,14840,10565,14823,10401,14803,10259,14780,10032,14754,9820,14725,9635,14694,9473,14661,9333,14627,9203,14593,8988,14557,8798,14923,13014,14922,13014,14922,13012,14922,13004,14920,12987,14919,12957,14915,12907,14909,12834,14902,12738,14894,12623,14888,12498,14883,12370,14880,12203,14878,11970,14875,11759,14873,11569,14874,11401,14872,11243,14865,10986,14855,10762,14842,10568,14825,10401,14804,10255,14781,10017,14754,9799,14725,9611,14692,9445,14658,9301,14623,9139,14587,8920,14548,8729,14509,8562,15008,12672,15008,12672,15008,12671,15007,12667,15005,12656,15001,12637,14997,12605,14989,12556,14978,12490,14966,12407,14953,12313,14940,12136,14927,11934,14914,11742,14903,11563,14896,11401,14889,11247,14879,10992,14866,10767,14851,10570,14833,10400,14812,10252,14789,10007,14761,9784,14731,9592,14698,9424,14663,9279,14627,9088,14588,8868,14548,8676,14508,8508,14467,8360,15080,12386,15080,12386,15079,12385,15078,12383,15076,12378,15072,12367,15066,12347,15057,12315,15045,12253,15030,12138,15012,11998,14993,11845,14972,11685,14951,11530,14935,11383,14920,11228,14904,10981,14887,10762,14870,10567,14850,10397,14827,10248,14803,9997,14774,9771,14743,9578,14710,9407,14674,9259,14637,9048,14596,8826,14555,8632,14514,8464,14471,8317,14427,8182,15139,12008,15139,12008,15138,12008,15137,12007,15135,12003,15130,11990,15124,11969,15115,11929,15102,11872,15086,11794,15064,11693,15041,11581,15013,11459,14987,11336,14966,11170,14944,10944,14921,10738,14898,10552,14875,10387,14850,10239,14824,9983,14794,9758,14762,9563,14728,9392,14692,9244,14653,9014,14611,8791,14569,8597,14526,8427,14481,8281,14436,8110,14391,7885,15188,11617,15188,11617,15187,11617,15186,11618,15183,11617,15179,11612,15173,11601,15163,11581,15150,11546,15133,11495,15110,11427,15083,11346,15051,11246,15024,11057,14996,10868,14967,10687,14938,10517,14911,10362,14882,10206,14853,9956,14821,9737,14787,9543,14752,9375,14715,9228,14675,8980,14632,8760,14589,8565,14544,8395,14498,8248,14451,8049,14404,7824,14357,7630,15228,11298,15228,11298,15227,11299,15226,11301,15223,11303,15219,11302,15213,11299,15204,11290,15191,11271,15174,11217,15150,11129,15119,11015,15087,10886,15057,10744,15024,10599,14990,10455,14957,10318,14924,10143,14891,9911,14856,9701,14820,9516,14782,9352,14744,9200,14703,8946,14659,8725,14615,8533,14568,8366,14521,8220,14472,7992,14423,7770,14374,7578,14315,7408,15260,10819,15260,10819,15259,10822,15258,10826,15256,10832,15251,10836,15246,10841,15237,10838,15225,10821,15207,10788,15183,10734,15151,10660,15120,10571,15087,10469,15049,10359,15012,10249,14974,10041,14937,9837,14900,9647,14860,9475,14820,9320,14779,9147,14736,8902,14691,8688,14646,8499,14598,8335,14549,8189,14499,7940,14448,7720,14397,7529,14347,7363,14256,7218,15285,10410,15285,10411,15285,10413,15284,10418,15282,10425,15278,10434,15272,10442,15264,10449,15252,10445,15235,10433,15210,10403,15179,10358,15149,10301,15113,10218,15073,10059,15033,9894,14991,9726,14951,9565,14909,9413,14865,9273,14822,9073,14777,8845,14730,8641,14682,8459,14633,8300,14583,8129,14531,7883,14479,7670,14426,7482,14373,7321,14305,7176,14201,6939,15305,9939,15305,9940,15305,9945,15304,9955,15302,9967,15298,9989,15293,10010,15286,10033,15274,10044,15258,10045,15233,10022,15205,9975,15174,9903,15136,9808,15095,9697,15053,9578,15009,9451,14965,9327,14918,9198,14871,8973,14825,8766,14775,8579,14725,8408,14675,8259,14622,8058,14569,7821,14515,7615,14460,7435,14405,7276,14350,7108,14256,6866,14149,6653,15321,9444,15321,9445,15321,9448,15320,9458,15317,9470,15314,9490,15310,9515,15302,9540,15292,9562,15276,9579,15251,9577,15226,9559,15195,9519,15156,9463,15116,9389,15071,9304,15025,9208,14978,9023,14927,8838,14878,8661,14827,8496,14774,8344,14722,8206,14667,7973,14612,7749,14556,7555,14499,7382,14443,7229,14385,7025,14322,6791,14210,6588,14100,6409,15333,8920,15333,8921,15332,8927,15332,8943,15329,8965,15326,9002,15322,9048,15316,9106,15307,9162,15291,9204,15267,9221,15244,9221,15212,9196,15175,9134,15133,9043,15088,8930,15040,8801,14990,8665,14938,8526,14886,8391,14830,8261,14775,8087,14719,7866,14661,7664,14603,7482,14544,7322,14485,7178,14426,6936,14367,6713,14281,6517,14166,6348,14054,6198,15341,8360,15341,8361,15341,8366,15341,8379,15339,8399,15336,8431,15332,8473,15326,8527,15318,8585,15302,8632,15281,8670,15258,8690,15227,8690,15191,8664,15149,8612,15104,8543,15055,8456,15001,8360,14948,8259,14892,8122,14834,7923,14776,7734,14716,7558,14656,7397,14595,7250,14534,7070,14472,6835,14410,6628,14350,6443,14243,6283,14125,6135,14010,5889,15348,7715,15348,7717,15348,7725,15347,7745,15345,7780,15343,7836,15339,7905,15334,8e3,15326,8103,15310,8193,15293,8239,15270,8270,15240,8287,15204,8283,15163,8260,15118,8223,15067,8143,15014,8014,14958,7873,14899,7723,14839,7573,14778,7430,14715,7293,14652,7164,14588,6931,14524,6720,14460,6531,14396,6362,14330,6210,14207,6015,14086,5781,13969,5576,15352,7114,15352,7116,15352,7128,15352,7159,15350,7195,15348,7237,15345,7299,15340,7374,15332,7457,15317,7544,15301,7633,15280,7703,15251,7754,15216,7775,15176,7767,15131,7733,15079,7670,15026,7588,14967,7492,14906,7387,14844,7278,14779,7171,14714,6965,14648,6770,14581,6587,14515,6420,14448,6269,14382,6123,14299,5881,14172,5665,14049,5477,13929,5310,15355,6329,15355,6330,15355,6339,15355,6362,15353,6410,15351,6472,15349,6572,15344,6688,15337,6835,15323,6985,15309,7142,15287,7220,15260,7277,15226,7310,15188,7326,15142,7318,15090,7285,15036,7239,14976,7177,14914,7045,14849,6892,14782,6736,14714,6581,14645,6433,14576,6293,14506,6164,14438,5946,14369,5733,14270,5540,14140,5369,14014,5216,13892,5043,15357,5483,15357,5484,15357,5496,15357,5528,15356,5597,15354,5692,15351,5835,15347,6011,15339,6195,15328,6317,15314,6446,15293,6566,15268,6668,15235,6746,15197,6796,15152,6811,15101,6790,15046,6748,14985,6673,14921,6583,14854,6479,14785,6371,14714,6259,14643,6149,14571,5946,14499,5750,14428,5567,14358,5401,14242,5250,14109,5111,13980,4870,13856,4657,15359,4555,15359,4557,15358,4573,15358,4633,15357,4715,15355,4841,15353,5061,15349,5216,15342,5391,15331,5577,15318,5770,15299,5967,15274,6150,15243,6223,15206,6280,15161,6310,15111,6317,15055,6300,14994,6262,14928,6208,14860,6141,14788,5994,14715,5838,14641,5684,14566,5529,14492,5384,14418,5247,14346,5121,14216,4892,14079,4682,13948,4496,13822,4330,15359,3498,15359,3501,15359,3520,15359,3598,15358,3719,15356,3860,15355,4137,15351,4305,15344,4563,15334,4809,15321,5116,15303,5273,15280,5418,15250,5547,15214,5653,15170,5722,15120,5761,15064,5763,15002,5733,14935,5673,14865,5597,14792,5504,14716,5400,14640,5294,14563,5185,14486,5041,14410,4841,14335,4655,14191,4482,14051,4325,13918,4183,13790,4012,15360,2282,15360,2285,15360,2306,15360,2401,15359,2547,15357,2748,15355,3103,15352,3349,15345,3675,15336,4020,15324,4272,15307,4496,15285,4716,15255,4908,15220,5086,15178,5170,15128,5214,15072,5234,15010,5231,14943,5206,14871,5166,14796,5102,14718,4971,14639,4833,14559,4687,14480,4541,14402,4401,14315,4268,14167,4142,14025,3958,13888,3747,13759,3556,15360,923,15360,925,15360,946,15360,1052,15359,1214,15357,1494,15356,1892,15352,2274,15346,2663,15338,3099,15326,3393,15309,3679,15288,3980,15260,4183,15226,4325,15185,4437,15136,4517,15080,4570,15018,4591,14950,4581,14877,4545,14800,4485,14720,4411,14638,4325,14556,4231,14475,4136,14395,3988,14297,3803,14145,3628,13999,3465,13861,3314,13729,3177,15360,263,15360,264,15360,272,15360,325,15359,407,15358,548,15356,780,15352,1144,15347,1580,15339,2099,15328,2425,15312,2795,15292,3133,15264,3329,15232,3517,15191,3689,15143,3819,15088,3923,15025,3978,14956,3999,14882,3979,14804,3931,14722,3855,14639,3756,14554,3645,14470,3529,14388,3409,14279,3289,14124,3173,13975,3055,13834,2848,13701,2658,15360,49,15360,49,15360,52,15360,75,15359,111,15358,201,15356,283,15353,519,15348,726,15340,1045,15329,1415,15314,1795,15295,2173,15269,2410,15237,2649,15197,2866,15150,3054,15095,3140,15032,3196,14963,3228,14888,3236,14808,3224,14725,3191,14639,3146,14553,3088,14466,2976,14382,2836,14262,2692,14103,2549,13952,2409,13808,2278,13674,2154,15360,4,15360,4,15360,4,15360,13,15359,33,15358,59,15357,112,15353,199,15348,302,15341,456,15331,628,15316,827,15297,1082,15272,1332,15241,1601,15202,1851,15156,2069,15101,2172,15039,2256,14970,2314,14894,2348,14813,2358,14728,2344,14640,2311,14551,2263,14463,2203,14376,2133,14247,2059,14084,1915,13930,1761,13784,1609,13648,1464,15360,0,15360,0,15360,0,15360,3,15359,18,15358,26,15357,53,15354,80,15348,97,15341,165,15332,238,15318,326,15299,427,15275,529,15245,654,15207,771,15161,885,15108,994,15046,1089,14976,1170,14900,1229,14817,1266,14731,1284,14641,1282,14550,1260,14460,1223,14370,1174,14232,1116,14066,1050,13909,981,13761,910,13623,839]);let aa=null;function LE(){return aa===null&&(aa=new Iy(UE,32,32,mh,Rs),aa.minFilter=di,aa.magFilter=di,aa.wrapS=la,aa.wrapT=la,aa.generateMipmaps=!1,aa.needsUpdate=!0),aa}class NE{constructor(t={}){const{canvas:i=fy(),context:r=null,depth:l=!0,stencil:u=!1,alpha:d=!1,antialias:h=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:x=!1,reversedDepthBuffer:S=!1}=t;this.isWebGLRenderer=!0;let b;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");b=r.getContextAttributes().alpha}else b=d;const A=new Set([gh,xh,ph]),C=new Set([da,Ar,Lo,No,dh,hh]),y=new Uint32Array(4),v=new Int32Array(4);let P=null,U=null;const F=[],k=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ya,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const N=this;let B=!1;this._outputColorSpace=fi;let te=0,w=0,R=null,V=-1,$=null;const se=new an,de=new an;let fe=null;const O=new Vt(0);let j=0,Y=i.width,ge=i.height,_e=1,L=null,ae=null;const ye=new an(0,0,Y,ge),Ee=new an(0,0,Y,ge);let ze=!1;const ne=new Cg;let le=!1,Ce=!1;const He=new mn,Xe=new ce,lt=new an,$t={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let dt=!1;function Tt(){return R===null?_e:1}let I=r;function ht(T,X){return i.getContext(T,X)}try{const T={alpha:!0,depth:l,stencil:u,antialias:h,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:x};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${uh}`),i.addEventListener("webglcontextlost",be,!1),i.addEventListener("webglcontextrestored",xe,!1),i.addEventListener("webglcontextcreationerror",Be,!1),I===null){const X="webgl2";if(I=ht(X,T),I===null)throw ht(X)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw T("WebGLRenderer: "+T.message),T}let mt,Ot,Ge,kt,je,at,D,M,K,pe,ve,oe,qe,Le,Qe,We,Se,Me,Ye,Ve,Oe,nt,H,we;function Ae(){mt=new G3(I),mt.init(),nt=new ME(I,mt),Ot=new L3(I,mt,t,nt),Ge=new yE(I,mt),Ot.reversedDepthBuffer&&S&&Ge.buffers.depth.setReversed(!0),kt=new X3(I),je=new lE,at=new bE(I,mt,Ge,je,Ot,nt,kt),D=new O3(N),M=new H3(N),K=new jy(I),H=new D3(I,K),pe=new V3(I,K,kt,H),ve=new q3(I,pe,K,kt),Ye=new W3(I,Ot,at),We=new N3(je),oe=new oE(N,D,M,mt,Ot,H,We),qe=new wE(N,je),Le=new uE,Qe=new xE(mt),Me=new w3(N,D,M,Ge,ve,b,m),Se=new vE(N,ve,Ot),we=new DE(I,kt,Ot,Ge),Ve=new U3(I,mt,kt),Oe=new k3(I,mt,kt),kt.programs=oe.programs,N.capabilities=Ot,N.extensions=mt,N.properties=je,N.renderLists=Le,N.shadowMap=Se,N.state=Ge,N.info=kt}Ae();const Re=new RE(N,I);this.xr=Re,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const T=mt.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=mt.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(T){T!==void 0&&(_e=T,this.setSize(Y,ge,!1))},this.getSize=function(T){return T.set(Y,ge)},this.setSize=function(T,X,ie=!0){if(Re.isPresenting){ot("WebGLRenderer: Can't change size while VR device is presenting.");return}Y=T,ge=X,i.width=Math.floor(T*_e),i.height=Math.floor(X*_e),ie===!0&&(i.style.width=T+"px",i.style.height=X+"px"),this.setViewport(0,0,T,X)},this.getDrawingBufferSize=function(T){return T.set(Y*_e,ge*_e).floor()},this.setDrawingBufferSize=function(T,X,ie){Y=T,ge=X,_e=ie,i.width=Math.floor(T*ie),i.height=Math.floor(X*ie),this.setViewport(0,0,T,X)},this.getCurrentViewport=function(T){return T.copy(se)},this.getViewport=function(T){return T.copy(ye)},this.setViewport=function(T,X,ie,J){T.isVector4?ye.set(T.x,T.y,T.z,T.w):ye.set(T,X,ie,J),Ge.viewport(se.copy(ye).multiplyScalar(_e).round())},this.getScissor=function(T){return T.copy(Ee)},this.setScissor=function(T,X,ie,J){T.isVector4?Ee.set(T.x,T.y,T.z,T.w):Ee.set(T,X,ie,J),Ge.scissor(de.copy(Ee).multiplyScalar(_e).round())},this.getScissorTest=function(){return ze},this.setScissorTest=function(T){Ge.setScissorTest(ze=T)},this.setOpaqueSort=function(T){L=T},this.setTransparentSort=function(T){ae=T},this.getClearColor=function(T){return T.copy(Me.getClearColor())},this.setClearColor=function(){Me.setClearColor(...arguments)},this.getClearAlpha=function(){return Me.getClearAlpha()},this.setClearAlpha=function(){Me.setClearAlpha(...arguments)},this.clear=function(T=!0,X=!0,ie=!0){let J=0;if(T){let q=!1;if(R!==null){const Te=R.texture.format;q=A.has(Te)}if(q){const Te=R.texture.type,De=C.has(Te),Pe=Me.getClearColor(),Fe=Me.getClearAlpha(),$e=Pe.r,tt=Pe.g,Ze=Pe.b;De?(y[0]=$e,y[1]=tt,y[2]=Ze,y[3]=Fe,I.clearBufferuiv(I.COLOR,0,y)):(v[0]=$e,v[1]=tt,v[2]=Ze,v[3]=Fe,I.clearBufferiv(I.COLOR,0,v))}else J|=I.COLOR_BUFFER_BIT}X&&(J|=I.DEPTH_BUFFER_BIT),ie&&(J|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(J)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",be,!1),i.removeEventListener("webglcontextrestored",xe,!1),i.removeEventListener("webglcontextcreationerror",Be,!1),Me.dispose(),Le.dispose(),Qe.dispose(),je.dispose(),D.dispose(),M.dispose(),ve.dispose(),H.dispose(),we.dispose(),oe.dispose(),Re.dispose(),Re.removeEventListener("sessionstart",Ds),Re.removeEventListener("sessionend",Us),hi.stop()};function be(T){T.preventDefault(),_x("WebGLRenderer: Context Lost."),B=!0}function xe(){_x("WebGLRenderer: Context Restored."),B=!1;const T=kt.autoReset,X=Se.enabled,ie=Se.autoUpdate,J=Se.needsUpdate,q=Se.type;Ae(),kt.autoReset=T,Se.enabled=X,Se.autoUpdate=ie,Se.needsUpdate=J,Se.type=q}function Be(T){nn("WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function it(T){const X=T.target;X.removeEventListener("dispose",it),Bt(X)}function Bt(T){At(T),je.remove(T)}function At(T){const X=je.get(T).programs;X!==void 0&&(X.forEach(function(ie){oe.releaseProgram(ie)}),T.isShaderMaterial&&oe.releaseShaderCache(T))}this.renderBufferDirect=function(T,X,ie,J,q,Te){X===null&&(X=$t);const De=q.isMesh&&q.matrixWorld.determinant()<0,Pe=Uc(T,X,ie,J,q);Ge.setMaterial(J,De);let Fe=ie.index,$e=1;if(J.wireframe===!0){if(Fe=pe.getWireframeAttribute(ie),Fe===void 0)return;$e=2}const tt=ie.drawRange,Ze=ie.attributes.position;let ct=tt.start*$e,Et=(tt.start+tt.count)*$e;Te!==null&&(ct=Math.max(ct,Te.start*$e),Et=Math.min(Et,(Te.start+Te.count)*$e)),Fe!==null?(ct=Math.max(ct,0),Et=Math.min(Et,Fe.count)):Ze!=null&&(ct=Math.max(ct,0),Et=Math.min(Et,Ze.count));const Rt=Et-ct;if(Rt<0||Rt===1/0)return;H.setup(q,J,Pe,ie,Fe);let St,Nt=Ve;if(Fe!==null&&(St=K.get(Fe),Nt=Oe,Nt.setIndex(St)),q.isMesh)J.wireframe===!0?(Ge.setLineWidth(J.wireframeLinewidth*Tt()),Nt.setMode(I.LINES)):Nt.setMode(I.TRIANGLES);else if(q.isLine){let Je=J.linewidth;Je===void 0&&(Je=1),Ge.setLineWidth(Je*Tt()),q.isLineSegments?Nt.setMode(I.LINES):q.isLineLoop?Nt.setMode(I.LINE_LOOP):Nt.setMode(I.LINE_STRIP)}else q.isPoints?Nt.setMode(I.POINTS):q.isSprite&&Nt.setMode(I.TRIANGLES);if(q.isBatchedMesh)if(q._multiDrawInstances!==null)Po("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Nt.renderMultiDrawInstances(q._multiDrawStarts,q._multiDrawCounts,q._multiDrawCount,q._multiDrawInstances);else if(mt.get("WEBGL_multi_draw"))Nt.renderMultiDraw(q._multiDrawStarts,q._multiDrawCounts,q._multiDrawCount);else{const Je=q._multiDrawStarts,Xt=q._multiDrawCounts,yt=q._multiDrawCount,_n=Fe?K.get(Fe).bytesPerElement:1,ma=je.get(J).currentProgram.getUniforms();for(let qt=0;qt<yt;qt++)ma.setValue(I,"_gl_DrawID",qt),Nt.render(Je[qt]/_n,Xt[qt])}else if(q.isInstancedMesh)Nt.renderInstances(ct,Rt,q.count);else if(ie.isInstancedBufferGeometry){const Je=ie._maxInstanceCount!==void 0?ie._maxInstanceCount:1/0,Xt=Math.min(ie.instanceCount,Je);Nt.renderInstances(ct,Rt,Xt)}else Nt.render(ct,Rt)};function Cn(T,X,ie){T.transparent===!0&&T.side===oa&&T.forceSinglePass===!1?(T.side=Vn,T.needsUpdate=!0,dn(T,X,ie),T.side=ja,T.needsUpdate=!0,dn(T,X,ie),T.side=oa):dn(T,X,ie)}this.compile=function(T,X,ie=null){ie===null&&(ie=T),U=Qe.get(ie),U.init(X),k.push(U),ie.traverseVisible(function(q){q.isLight&&q.layers.test(X.layers)&&(U.pushLight(q),q.castShadow&&U.pushShadow(q))}),T!==ie&&T.traverseVisible(function(q){q.isLight&&q.layers.test(X.layers)&&(U.pushLight(q),q.castShadow&&U.pushShadow(q))}),U.setupLights();const J=new Set;return T.traverse(function(q){if(!(q.isMesh||q.isPoints||q.isLine||q.isSprite))return;const Te=q.material;if(Te)if(Array.isArray(Te))for(let De=0;De<Te.length;De++){const Pe=Te[De];Cn(Pe,ie,q),J.add(Pe)}else Cn(Te,ie,q),J.add(Te)}),U=k.pop(),J},this.compileAsync=function(T,X,ie=null){const J=this.compile(T,X,ie);return new Promise(q=>{function Te(){if(J.forEach(function(De){je.get(De).currentProgram.isReady()&&J.delete(De)}),J.size===0){q(T);return}setTimeout(Te,10)}mt.get("KHR_parallel_shader_compile")!==null?Te():setTimeout(Te,10)})};let kn=null;function Go(T){kn&&kn(T)}function Ds(){hi.stop()}function Us(){hi.start()}const hi=new Lg;hi.setAnimationLoop(Go),typeof self<"u"&&hi.setContext(self),this.setAnimationLoop=function(T){kn=T,Re.setAnimationLoop(T),T===null?hi.stop():hi.start()},Re.addEventListener("sessionstart",Ds),Re.addEventListener("sessionend",Us),this.render=function(T,X){if(X!==void 0&&X.isCamera!==!0){nn("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(B===!0)return;if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),X.parent===null&&X.matrixWorldAutoUpdate===!0&&X.updateMatrixWorld(),Re.enabled===!0&&Re.isPresenting===!0&&(Re.cameraAutoUpdate===!0&&Re.updateCamera(X),X=Re.getCamera()),T.isScene===!0&&T.onBeforeRender(N,T,X,R),U=Qe.get(T,k.length),U.init(X),k.push(U),He.multiplyMatrices(X.projectionMatrix,X.matrixWorldInverse),ne.setFromProjectionMatrix(He,Di,X.reversedDepth),Ce=this.localClippingEnabled,le=We.init(this.clippingPlanes,Ce),P=Le.get(T,F.length),P.init(),F.push(P),Re.enabled===!0&&Re.isPresenting===!0){const Te=N.xr.getDepthSensingMesh();Te!==null&&Qa(Te,X,-1/0,N.sortObjects)}Qa(T,X,0,N.sortObjects),P.finish(),N.sortObjects===!0&&P.sort(L,ae),dt=Re.enabled===!1||Re.isPresenting===!1||Re.hasDepthSensing()===!1,dt&&Me.addToRenderList(P,T),this.info.render.frame++,le===!0&&We.beginShadows();const ie=U.state.shadowsArray;Se.render(ie,T,X),le===!0&&We.endShadows(),this.info.autoReset===!0&&this.info.reset();const J=P.opaque,q=P.transmissive;if(U.setupLights(),X.isArrayCamera){const Te=X.cameras;if(q.length>0)for(let De=0,Pe=Te.length;De<Pe;De++){const Fe=Te[De];Ns(J,q,T,Fe)}dt&&Me.render(T);for(let De=0,Pe=Te.length;De<Pe;De++){const Fe=Te[De];Ls(P,T,Fe,Fe.viewport)}}else q.length>0&&Ns(J,q,T,X),dt&&Me.render(T),Ls(P,T,X);R!==null&&w===0&&(at.updateMultisampleRenderTarget(R),at.updateRenderTargetMipmap(R)),T.isScene===!0&&T.onAfterRender(N,T,X),H.resetDefaultState(),V=-1,$=null,k.pop(),k.length>0?(U=k[k.length-1],le===!0&&We.setGlobalState(N.clippingPlanes,U.state.camera)):U=null,F.pop(),F.length>0?P=F[F.length-1]:P=null};function Qa(T,X,ie,J){if(T.visible===!1)return;if(T.layers.test(X.layers)){if(T.isGroup)ie=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(X);else if(T.isLight)U.pushLight(T),T.castShadow&&U.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||ne.intersectsSprite(T)){J&&lt.setFromMatrixPosition(T.matrixWorld).applyMatrix4(He);const De=ve.update(T),Pe=T.material;Pe.visible&&P.push(T,De,Pe,ie,lt.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||ne.intersectsObject(T))){const De=ve.update(T),Pe=T.material;if(J&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),lt.copy(T.boundingSphere.center)):(De.boundingSphere===null&&De.computeBoundingSphere(),lt.copy(De.boundingSphere.center)),lt.applyMatrix4(T.matrixWorld).applyMatrix4(He)),Array.isArray(Pe)){const Fe=De.groups;for(let $e=0,tt=Fe.length;$e<tt;$e++){const Ze=Fe[$e],ct=Pe[Ze.materialIndex];ct&&ct.visible&&P.push(T,De,ct,ie,lt.z,Ze)}}else Pe.visible&&P.push(T,De,Pe,ie,lt.z,null)}}const Te=T.children;for(let De=0,Pe=Te.length;De<Pe;De++)Qa(Te[De],X,ie,J)}function Ls(T,X,ie,J){const{opaque:q,transmissive:Te,transparent:De}=T;U.setupLightsView(ie),le===!0&&We.setGlobalState(N.clippingPlanes,ie),J&&Ge.viewport(se.copy(J)),q.length>0&&Xn(q,X,ie),Te.length>0&&Xn(Te,X,ie),De.length>0&&Xn(De,X,ie),Ge.buffers.depth.setTest(!0),Ge.buffers.depth.setMask(!0),Ge.buffers.color.setMask(!0),Ge.setPolygonOffset(!1)}function Ns(T,X,ie,J){if((ie.isScene===!0?ie.overrideMaterial:null)!==null)return;U.state.transmissionRenderTarget[J.id]===void 0&&(U.state.transmissionRenderTarget[J.id]=new Za(1,1,{generateMipmaps:!0,type:mt.has("EXT_color_buffer_half_float")||mt.has("EXT_color_buffer_float")?Rs:da,minFilter:Er,samples:4,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Dt.workingColorSpace}));const Te=U.state.transmissionRenderTarget[J.id],De=J.viewport||se;Te.setSize(De.z*N.transmissionResolutionScale,De.w*N.transmissionResolutionScale);const Pe=N.getRenderTarget(),Fe=N.getActiveCubeFace(),$e=N.getActiveMipmapLevel();N.setRenderTarget(Te),N.getClearColor(O),j=N.getClearAlpha(),j<1&&N.setClearColor(16777215,.5),N.clear(),dt&&Me.render(ie);const tt=N.toneMapping;N.toneMapping=Ya;const Ze=J.viewport;if(J.viewport!==void 0&&(J.viewport=void 0),U.setupLightsView(J),le===!0&&We.setGlobalState(N.clippingPlanes,J),Xn(T,ie,J),at.updateMultisampleRenderTarget(Te),at.updateRenderTargetMipmap(Te),mt.has("WEBGL_multisampled_render_to_texture")===!1){let ct=!1;for(let Et=0,Rt=X.length;Et<Rt;Et++){const St=X[Et],{object:Nt,geometry:Je,material:Xt,group:yt}=St;if(Xt.side===oa&&Nt.layers.test(J.layers)){const _n=Xt.side;Xt.side=Vn,Xt.needsUpdate=!0,rn(Nt,ie,J,Je,Xt,yt),Xt.side=_n,Xt.needsUpdate=!0,ct=!0}}ct===!0&&(at.updateMultisampleRenderTarget(Te),at.updateRenderTargetMipmap(Te))}N.setRenderTarget(Pe,Fe,$e),N.setClearColor(O,j),Ze!==void 0&&(J.viewport=Ze),N.toneMapping=tt}function Xn(T,X,ie){const J=X.isScene===!0?X.overrideMaterial:null;for(let q=0,Te=T.length;q<Te;q++){const De=T[q],{object:Pe,geometry:Fe,group:$e}=De;let tt=De.material;tt.allowOverride===!0&&J!==null&&(tt=J),Pe.layers.test(ie.layers)&&rn(Pe,X,ie,Fe,tt,$e)}}function rn(T,X,ie,J,q,Te){T.onBeforeRender(N,X,ie,J,q,Te),T.modelViewMatrix.multiplyMatrices(ie.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),q.onBeforeRender(N,X,ie,J,T,Te),q.transparent===!0&&q.side===oa&&q.forceSinglePass===!1?(q.side=Vn,q.needsUpdate=!0,N.renderBufferDirect(ie,X,J,q,T,Te),q.side=ja,q.needsUpdate=!0,N.renderBufferDirect(ie,X,J,q,T,Te),q.side=oa):N.renderBufferDirect(ie,X,J,q,T,Te),T.onAfterRender(N,X,ie,J,q,Te)}function dn(T,X,ie){X.isScene!==!0&&(X=$t);const J=je.get(T),q=U.state.lights,Te=U.state.shadowsArray,De=q.state.version,Pe=oe.getParameters(T,q.state,Te,X,ie),Fe=oe.getProgramCacheKey(Pe);let $e=J.programs;J.environment=T.isMeshStandardMaterial?X.environment:null,J.fog=X.fog,J.envMap=(T.isMeshStandardMaterial?M:D).get(T.envMap||J.environment),J.envMapRotation=J.environment!==null&&T.envMap===null?X.environmentRotation:T.envMapRotation,$e===void 0&&(T.addEventListener("dispose",it),$e=new Map,J.programs=$e);let tt=$e.get(Fe);if(tt!==void 0){if(J.currentProgram===tt&&J.lightsStateVersion===De)return Rr(T,Pe),tt}else Pe.uniforms=oe.getUniforms(T),T.onBeforeCompile(Pe,N),tt=oe.acquireProgram(Pe,Fe),$e.set(Fe,tt),J.uniforms=Pe.uniforms;const Ze=J.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Ze.clippingPlanes=We.uniform),Rr(T,Pe),J.needsLights=Vo(T),J.lightsStateVersion=De,J.needsLights&&(Ze.ambientLightColor.value=q.state.ambient,Ze.lightProbe.value=q.state.probe,Ze.directionalLights.value=q.state.directional,Ze.directionalLightShadows.value=q.state.directionalShadow,Ze.spotLights.value=q.state.spot,Ze.spotLightShadows.value=q.state.spotShadow,Ze.rectAreaLights.value=q.state.rectArea,Ze.ltc_1.value=q.state.rectAreaLTC1,Ze.ltc_2.value=q.state.rectAreaLTC2,Ze.pointLights.value=q.state.point,Ze.pointLightShadows.value=q.state.pointShadow,Ze.hemisphereLights.value=q.state.hemi,Ze.directionalShadowMap.value=q.state.directionalShadowMap,Ze.directionalShadowMatrix.value=q.state.directionalShadowMatrix,Ze.spotShadowMap.value=q.state.spotShadowMap,Ze.spotLightMatrix.value=q.state.spotLightMatrix,Ze.spotLightMap.value=q.state.spotLightMap,Ze.pointShadowMap.value=q.state.pointShadowMap,Ze.pointShadowMatrix.value=q.state.pointShadowMatrix),J.currentProgram=tt,J.uniformsList=null,tt}function Ni(T){if(T.uniformsList===null){const X=T.currentProgram.getUniforms();T.uniformsList=Mc.seqWithValue(X.seq,T.uniforms)}return T.uniformsList}function Rr(T,X){const ie=je.get(T);ie.outputColorSpace=X.outputColorSpace,ie.batching=X.batching,ie.batchingColor=X.batchingColor,ie.instancing=X.instancing,ie.instancingColor=X.instancingColor,ie.instancingMorph=X.instancingMorph,ie.skinning=X.skinning,ie.morphTargets=X.morphTargets,ie.morphNormals=X.morphNormals,ie.morphColors=X.morphColors,ie.morphTargetsCount=X.morphTargetsCount,ie.numClippingPlanes=X.numClippingPlanes,ie.numIntersection=X.numClipIntersection,ie.vertexAlphas=X.vertexAlphas,ie.vertexTangents=X.vertexTangents,ie.toneMapping=X.toneMapping}function Uc(T,X,ie,J,q){X.isScene!==!0&&(X=$t),at.resetTextureUnits();const Te=X.fog,De=J.isMeshStandardMaterial?X.environment:null,Pe=R===null?N.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Es,Fe=(J.isMeshStandardMaterial?M:D).get(J.envMap||De),$e=J.vertexColors===!0&&!!ie.attributes.color&&ie.attributes.color.itemSize===4,tt=!!ie.attributes.tangent&&(!!J.normalMap||J.anisotropy>0),Ze=!!ie.morphAttributes.position,ct=!!ie.morphAttributes.normal,Et=!!ie.morphAttributes.color;let Rt=Ya;J.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(Rt=N.toneMapping);const St=ie.morphAttributes.position||ie.morphAttributes.normal||ie.morphAttributes.color,Nt=St!==void 0?St.length:0,Je=je.get(J),Xt=U.state.lights;if(le===!0&&(Ce===!0||T!==$)){const Sn=T===$&&J.id===V;We.setState(J,T,Sn)}let yt=!1;J.version===Je.__version?(Je.needsLights&&Je.lightsStateVersion!==Xt.state.version||Je.outputColorSpace!==Pe||q.isBatchedMesh&&Je.batching===!1||!q.isBatchedMesh&&Je.batching===!0||q.isBatchedMesh&&Je.batchingColor===!0&&q.colorTexture===null||q.isBatchedMesh&&Je.batchingColor===!1&&q.colorTexture!==null||q.isInstancedMesh&&Je.instancing===!1||!q.isInstancedMesh&&Je.instancing===!0||q.isSkinnedMesh&&Je.skinning===!1||!q.isSkinnedMesh&&Je.skinning===!0||q.isInstancedMesh&&Je.instancingColor===!0&&q.instanceColor===null||q.isInstancedMesh&&Je.instancingColor===!1&&q.instanceColor!==null||q.isInstancedMesh&&Je.instancingMorph===!0&&q.morphTexture===null||q.isInstancedMesh&&Je.instancingMorph===!1&&q.morphTexture!==null||Je.envMap!==Fe||J.fog===!0&&Je.fog!==Te||Je.numClippingPlanes!==void 0&&(Je.numClippingPlanes!==We.numPlanes||Je.numIntersection!==We.numIntersection)||Je.vertexAlphas!==$e||Je.vertexTangents!==tt||Je.morphTargets!==Ze||Je.morphNormals!==ct||Je.morphColors!==Et||Je.toneMapping!==Rt||Je.morphTargetsCount!==Nt)&&(yt=!0):(yt=!0,Je.__version=J.version);let _n=Je.currentProgram;yt===!0&&(_n=dn(J,X,q));let ma=!1,qt=!1,Oi=!1;const Yt=_n.getUniforms(),vn=Je.uniforms;if(Ge.useProgram(_n.program)&&(ma=!0,qt=!0,Oi=!0),J.id!==V&&(V=J.id,qt=!0),ma||$!==T){Ge.buffers.depth.getReversed()&&T.reversedDepth!==!0&&(T._reversedDepth=!0,T.updateProjectionMatrix()),Yt.setValue(I,"projectionMatrix",T.projectionMatrix),Yt.setValue(I,"viewMatrix",T.matrixWorldInverse);const Mn=Yt.map.cameraPosition;Mn!==void 0&&Mn.setValue(I,Xe.setFromMatrixPosition(T.matrixWorld)),Ot.logarithmicDepthBuffer&&Yt.setValue(I,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(J.isMeshPhongMaterial||J.isMeshToonMaterial||J.isMeshLambertMaterial||J.isMeshBasicMaterial||J.isMeshStandardMaterial||J.isShaderMaterial)&&Yt.setValue(I,"isOrthographic",T.isOrthographicCamera===!0),$!==T&&($=T,qt=!0,Oi=!0)}if(q.isSkinnedMesh){Yt.setOptional(I,q,"bindMatrix"),Yt.setOptional(I,q,"bindMatrixInverse");const Sn=q.skeleton;Sn&&(Sn.boneTexture===null&&Sn.computeBoneTexture(),Yt.setValue(I,"boneTexture",Sn.boneTexture,at))}q.isBatchedMesh&&(Yt.setOptional(I,q,"batchingTexture"),Yt.setValue(I,"batchingTexture",q._matricesTexture,at),Yt.setOptional(I,q,"batchingIdTexture"),Yt.setValue(I,"batchingIdTexture",q._indirectTexture,at),Yt.setOptional(I,q,"batchingColorTexture"),q._colorsTexture!==null&&Yt.setValue(I,"batchingColorTexture",q._colorsTexture,at));const hn=ie.morphAttributes;if((hn.position!==void 0||hn.normal!==void 0||hn.color!==void 0)&&Ye.update(q,ie,_n),(qt||Je.receiveShadow!==q.receiveShadow)&&(Je.receiveShadow=q.receiveShadow,Yt.setValue(I,"receiveShadow",q.receiveShadow)),J.isMeshGouraudMaterial&&J.envMap!==null&&(vn.envMap.value=Fe,vn.flipEnvMap.value=Fe.isCubeTexture&&Fe.isRenderTargetTexture===!1?-1:1),J.isMeshStandardMaterial&&J.envMap===null&&X.environment!==null&&(vn.envMapIntensity.value=X.environmentIntensity),vn.dfgLUT!==void 0&&(vn.dfgLUT.value=LE()),qt&&(Yt.setValue(I,"toneMappingExposure",N.toneMappingExposure),Je.needsLights&&Lc(vn,Oi),Te&&J.fog===!0&&qe.refreshFogUniforms(vn,Te),qe.refreshMaterialUniforms(vn,J,_e,ge,U.state.transmissionRenderTarget[T.id]),Mc.upload(I,Ni(Je),vn,at)),J.isShaderMaterial&&J.uniformsNeedUpdate===!0&&(Mc.upload(I,Ni(Je),vn,at),J.uniformsNeedUpdate=!1),J.isSpriteMaterial&&Yt.setValue(I,"center",q.center),Yt.setValue(I,"modelViewMatrix",q.modelViewMatrix),Yt.setValue(I,"normalMatrix",q.normalMatrix),Yt.setValue(I,"modelMatrix",q.matrixWorld),J.isShaderMaterial||J.isRawShaderMaterial){const Sn=J.uniformsGroups;for(let Mn=0,Ei=Sn.length;Mn<Ei;Mn++){const zi=Sn[Mn];we.update(zi,_n),we.bind(zi,_n)}}return _n}function Lc(T,X){T.ambientLightColor.needsUpdate=X,T.lightProbe.needsUpdate=X,T.directionalLights.needsUpdate=X,T.directionalLightShadows.needsUpdate=X,T.pointLights.needsUpdate=X,T.pointLightShadows.needsUpdate=X,T.spotLights.needsUpdate=X,T.spotLightShadows.needsUpdate=X,T.rectAreaLights.needsUpdate=X,T.hemisphereLights.needsUpdate=X}function Vo(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return te},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(T,X,ie){const J=je.get(T);J.__autoAllocateDepthBuffer=T.resolveDepthBuffer===!1,J.__autoAllocateDepthBuffer===!1&&(J.__useRenderToTexture=!1),je.get(T.texture).__webglTexture=X,je.get(T.depthTexture).__webglTexture=J.__autoAllocateDepthBuffer?void 0:ie,J.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(T,X){const ie=je.get(T);ie.__webglFramebuffer=X,ie.__useDefaultFramebuffer=X===void 0};const Ja=I.createFramebuffer();this.setRenderTarget=function(T,X=0,ie=0){R=T,te=X,w=ie;let J=!0,q=null,Te=!1,De=!1;if(T){const Fe=je.get(T);if(Fe.__useDefaultFramebuffer!==void 0)Ge.bindFramebuffer(I.FRAMEBUFFER,null),J=!1;else if(Fe.__webglFramebuffer===void 0)at.setupRenderTarget(T);else if(Fe.__hasExternalTextures)at.rebindTextures(T,je.get(T.texture).__webglTexture,je.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const Ze=T.depthTexture;if(Fe.__boundDepthTexture!==Ze){if(Ze!==null&&je.has(Ze)&&(T.width!==Ze.image.width||T.height!==Ze.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");at.setupDepthRenderbuffer(T)}}const $e=T.texture;($e.isData3DTexture||$e.isDataArrayTexture||$e.isCompressedArrayTexture)&&(De=!0);const tt=je.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(tt[X])?q=tt[X][ie]:q=tt[X],Te=!0):T.samples>0&&at.useMultisampledRTT(T)===!1?q=je.get(T).__webglMultisampledFramebuffer:Array.isArray(tt)?q=tt[ie]:q=tt,se.copy(T.viewport),de.copy(T.scissor),fe=T.scissorTest}else se.copy(ye).multiplyScalar(_e).floor(),de.copy(Ee).multiplyScalar(_e).floor(),fe=ze;if(ie!==0&&(q=Ja),Ge.bindFramebuffer(I.FRAMEBUFFER,q)&&J&&Ge.drawBuffers(T,q),Ge.viewport(se),Ge.scissor(de),Ge.setScissorTest(fe),Te){const Fe=je.get(T.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+X,Fe.__webglTexture,ie)}else if(De){const Fe=X;for(let $e=0;$e<T.textures.length;$e++){const tt=je.get(T.textures[$e]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+$e,tt.__webglTexture,ie,Fe)}}else if(T!==null&&ie!==0){const Fe=je.get(T.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Fe.__webglTexture,ie)}V=-1},this.readRenderTargetPixels=function(T,X,ie,J,q,Te,De,Pe=0){if(!(T&&T.isWebGLRenderTarget)){nn("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Fe=je.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&De!==void 0&&(Fe=Fe[De]),Fe){Ge.bindFramebuffer(I.FRAMEBUFFER,Fe);try{const $e=T.textures[Pe],tt=$e.format,Ze=$e.type;if(!Ot.textureFormatReadable(tt)){nn("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ot.textureTypeReadable(Ze)){nn("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}X>=0&&X<=T.width-J&&ie>=0&&ie<=T.height-q&&(T.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Pe),I.readPixels(X,ie,J,q,nt.convert(tt),nt.convert(Ze),Te))}finally{const $e=R!==null?je.get(R).__webglFramebuffer:null;Ge.bindFramebuffer(I.FRAMEBUFFER,$e)}}},this.readRenderTargetPixelsAsync=async function(T,X,ie,J,q,Te,De,Pe=0){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Fe=je.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&De!==void 0&&(Fe=Fe[De]),Fe)if(X>=0&&X<=T.width-J&&ie>=0&&ie<=T.height-q){Ge.bindFramebuffer(I.FRAMEBUFFER,Fe);const $e=T.textures[Pe],tt=$e.format,Ze=$e.type;if(!Ot.textureFormatReadable(tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ot.textureTypeReadable(Ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ct=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,ct),I.bufferData(I.PIXEL_PACK_BUFFER,Te.byteLength,I.STREAM_READ),T.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Pe),I.readPixels(X,ie,J,q,nt.convert(tt),nt.convert(Ze),0);const Et=R!==null?je.get(R).__webglFramebuffer:null;Ge.bindFramebuffer(I.FRAMEBUFFER,Et);const Rt=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await dy(I,Rt,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,ct),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,Te),I.deleteBuffer(ct),I.deleteSync(Rt),Te}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(T,X=null,ie=0){const J=Math.pow(2,-ie),q=Math.floor(T.image.width*J),Te=Math.floor(T.image.height*J),De=X!==null?X.x:0,Pe=X!==null?X.y:0;at.setTexture2D(T,0),I.copyTexSubImage2D(I.TEXTURE_2D,ie,0,0,De,Pe,q,Te),Ge.unbindTexture()};const Os=I.createFramebuffer(),pa=I.createFramebuffer();this.copyTextureToTexture=function(T,X,ie=null,J=null,q=0,Te=null){Te===null&&(q!==0?(Po("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Te=q,q=0):Te=0);let De,Pe,Fe,$e,tt,Ze,ct,Et,Rt;const St=T.isCompressedTexture?T.mipmaps[Te]:T.image;if(ie!==null)De=ie.max.x-ie.min.x,Pe=ie.max.y-ie.min.y,Fe=ie.isBox3?ie.max.z-ie.min.z:1,$e=ie.min.x,tt=ie.min.y,Ze=ie.isBox3?ie.min.z:0;else{const hn=Math.pow(2,-q);De=Math.floor(St.width*hn),Pe=Math.floor(St.height*hn),T.isDataArrayTexture?Fe=St.depth:T.isData3DTexture?Fe=Math.floor(St.depth*hn):Fe=1,$e=0,tt=0,Ze=0}J!==null?(ct=J.x,Et=J.y,Rt=J.z):(ct=0,Et=0,Rt=0);const Nt=nt.convert(X.format),Je=nt.convert(X.type);let Xt;X.isData3DTexture?(at.setTexture3D(X,0),Xt=I.TEXTURE_3D):X.isDataArrayTexture||X.isCompressedArrayTexture?(at.setTexture2DArray(X,0),Xt=I.TEXTURE_2D_ARRAY):(at.setTexture2D(X,0),Xt=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,X.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,X.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,X.unpackAlignment);const yt=I.getParameter(I.UNPACK_ROW_LENGTH),_n=I.getParameter(I.UNPACK_IMAGE_HEIGHT),ma=I.getParameter(I.UNPACK_SKIP_PIXELS),qt=I.getParameter(I.UNPACK_SKIP_ROWS),Oi=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,St.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,St.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,$e),I.pixelStorei(I.UNPACK_SKIP_ROWS,tt),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Ze);const Yt=T.isDataArrayTexture||T.isData3DTexture,vn=X.isDataArrayTexture||X.isData3DTexture;if(T.isDepthTexture){const hn=je.get(T),Sn=je.get(X),Mn=je.get(hn.__renderTarget),Ei=je.get(Sn.__renderTarget);Ge.bindFramebuffer(I.READ_FRAMEBUFFER,Mn.__webglFramebuffer),Ge.bindFramebuffer(I.DRAW_FRAMEBUFFER,Ei.__webglFramebuffer);for(let zi=0;zi<Fe;zi++)Yt&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,je.get(T).__webglTexture,q,Ze+zi),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,je.get(X).__webglTexture,Te,Rt+zi)),I.blitFramebuffer($e,tt,De,Pe,ct,Et,De,Pe,I.DEPTH_BUFFER_BIT,I.NEAREST);Ge.bindFramebuffer(I.READ_FRAMEBUFFER,null),Ge.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(q!==0||T.isRenderTargetTexture||je.has(T)){const hn=je.get(T),Sn=je.get(X);Ge.bindFramebuffer(I.READ_FRAMEBUFFER,Os),Ge.bindFramebuffer(I.DRAW_FRAMEBUFFER,pa);for(let Mn=0;Mn<Fe;Mn++)Yt?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,hn.__webglTexture,q,Ze+Mn):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,hn.__webglTexture,q),vn?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Sn.__webglTexture,Te,Rt+Mn):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Sn.__webglTexture,Te),q!==0?I.blitFramebuffer($e,tt,De,Pe,ct,Et,De,Pe,I.COLOR_BUFFER_BIT,I.NEAREST):vn?I.copyTexSubImage3D(Xt,Te,ct,Et,Rt+Mn,$e,tt,De,Pe):I.copyTexSubImage2D(Xt,Te,ct,Et,$e,tt,De,Pe);Ge.bindFramebuffer(I.READ_FRAMEBUFFER,null),Ge.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else vn?T.isDataTexture||T.isData3DTexture?I.texSubImage3D(Xt,Te,ct,Et,Rt,De,Pe,Fe,Nt,Je,St.data):X.isCompressedArrayTexture?I.compressedTexSubImage3D(Xt,Te,ct,Et,Rt,De,Pe,Fe,Nt,St.data):I.texSubImage3D(Xt,Te,ct,Et,Rt,De,Pe,Fe,Nt,Je,St):T.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,Te,ct,Et,De,Pe,Nt,Je,St.data):T.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,Te,ct,Et,St.width,St.height,Nt,St.data):I.texSubImage2D(I.TEXTURE_2D,Te,ct,Et,De,Pe,Nt,Je,St);I.pixelStorei(I.UNPACK_ROW_LENGTH,yt),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,_n),I.pixelStorei(I.UNPACK_SKIP_PIXELS,ma),I.pixelStorei(I.UNPACK_SKIP_ROWS,qt),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Oi),Te===0&&X.generateMipmaps&&I.generateMipmap(Xt),Ge.unbindTexture()},this.initRenderTarget=function(T){je.get(T).__webglFramebuffer===void 0&&at.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?at.setTextureCube(T,0):T.isData3DTexture?at.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?at.setTexture2DArray(T,0):at.setTexture2D(T,0),Ge.unbindTexture()},this.resetState=function(){te=0,w=0,R=null,Ge.reset(),H.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Di}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Dt._getDrawingBufferColorSpace(t),i.unpackColorSpace=Dt._getUnpackColorSpace()}}const OE=Object.assign({"../portfolio-images/aerial-reverie/AR-clip-after-intro.mp4":$v,"../portfolio-images/aerial-reverie/AR-clip-intro.mp4":eS,"../portfolio-images/aerial-reverie/AR-clip-spiraling.mp4":tS,"../portfolio-images/aerial-reverie/AR-clip-spirals-start.mp4":nS,"../portfolio-images/aerial-reverie/aerial-reverie.mp4":iS,"../portfolio-images/aerial-reverie/process-stills-2.png":aS,"../portfolio-images/aerial-reverie/still-1.jpg":rS,"../portfolio-images/aerial-reverie/still-2.jpg":sS,"../portfolio-images/aerial-reverie/still-3.jpg":oS,"../portfolio-images/aerial-reverie/still-4.jpg":lS,"../portfolio-images/aligned/gallery-w-ml.png":cS,"../portfolio-images/aligned/pcb-schematic.png":uS,"../portfolio-images/aligned/thumbnail.png":fS,"../portfolio-images/diceplay/temp-mainfig.jpg":dS,"../portfolio-images/kinetic-pixels/header_tiles.mp4":hS,"../portfolio-images/kinetic-pixels/thumbnail.png":pS,"../portfolio-images/kinetic-pixels/tiles_all.png":mS,"../portfolio-images/nuwa/gallery.png":xS,"../portfolio-images/nuwa/thumbnail2.png":gS,"../portfolio-images/pawlink/header.png":_S,"../portfolio-images/pawlink/pawlink.png":vS,"../portfolio-images/pawlink/thumbnail.png":SS,"../portfolio-images/single-fibre/dither_it_figure-1.png":yS,"../portfolio-images/spirit-oasis/thumbnail.png":bS}),fn=o=>{if(!o)return"";const i=`../portfolio-images/${o.replace(/^\.?\/?src\/portfolio-images\/?/,"").replace(/^\.?\/?portfolio-images\/?/,"")}`;return OE[i]||""};function zE({getImg:o}){const t=["china","iran","morocco","spain","portugal","mexico","india","turkey"],i=sa.useRef({}),r=sa.useRef(!1),l=[...t.slice(0,4).flatMap(u=>[{key:`${u}_ca`,country:u,type:"ca"},{key:`${u}_drone`,country:u,type:"drone"}]),...t.slice(4).flatMap(u=>[{key:`${u}_drone`,country:u,type:"drone"},{key:`${u}_ca`,country:u,type:"ca"}])];return sa.useEffect(()=>{r.current||(r.current=!0,t.forEach(u=>{const d=i.current[`${u}_ca`],h=i.current[`${u}_drone`];if(!d||!h)return;let m=!1,p=!1;const _=()=>{if(!m||!p)return;const x=Math.min(d.duration,h.duration);if(!x||!isFinite(x))return;const S=Math.random()*x;d.currentTime=S,h.currentTime=S,d.play().catch(()=>{}),h.play().catch(()=>{})};d.addEventListener("loadedmetadata",()=>{m=!0,_()},{once:!0}),h.addEventListener("loadedmetadata",()=>{p=!0,_()},{once:!0})}))},[]),Ue.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(8, 1fr)",gridTemplateRows:"repeat(2, 1fr)",width:"100%",aspectRatio:"8 / 2",gap:0,overflow:"hidden"},children:l.map(({key:u,country:d,type:h})=>Ue.jsx("video",{ref:m=>i.current[u]=m,src:o(`/src/portfolio-images/kinetic-pixels/mp4/${d}_${h==="ca"?"ca":"drone_sim"}.mp4`),muted:!0,playsInline:!0,preload:"auto",loop:!0,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}},u))})}function PE(){const o=sa.useRef(null),t=sa.useRef({x:0,y:0}),[i,r]=sa.useState("All"),[l,u]=sa.useState(null),d=[{id:1,title:"Kinetic Pixels",category:"Tech",thumbnail:fn("/src/portfolio-images/kinetic-pixels/thumbnail.png"),description:"Kinetic Pixels explores data as cultural material to be crafted and dynamically configured by coordinated robots.",fullDescription:`Kinetic Pixels explores data as cultural material by translating symbolic, geographic, and historical information into rule-based mosaics that can be constructed by coordinated aerial robots. Drawing inspiration from global tile traditions—such as Chinese 花砖, Iberian azulejos, and Islamic zellige—the project engages practices where complex cultural meaning emerges from simple, modular repetition.
...
The system includes both a fully functioning prototype demonstrating real-time posture detection and a complete hardware pipeline, from circuit schematic to manufactured PCB, ready for textile integration in future iterations.`,details:{year:"2024",role:"Software Lead (ML + Arduino), Hardware",mediums:"KiCad, Custom PCB, I²C, ML, Haptic Feedback"},images:[{src:fn("/src/portfolio-images/aligned/gallery-w-ml.png"),layout:"full"}]},{id:4,title:"NÜWA",category:"Fashion",thumbnail:fn("/src/portfolio-images/nuwa/thumbnail2.png"),description:"Modernized hanfu and qipao challenging techno-Orientalist narratives through textile craft",fullDescription:`Showcased at Fashion@Brown Runway Show 2024 & Rhode Island Fashion Week 2024.
...
By crafting modernized hanfu and qipao dresses, interweaving the histories of silk and brocade with technology, the Chinese body is situated in all timeframes, toppling the binarist narrative generated by the West. Placed before the public eye, Nüwa asks the audience to confront the simultaneous pleasure and discomfort of the techno-Orientalist paradigm.`,details:{year:"2024",role:"Solo",mediums:"Brocade, Silk, LEDs"},images:[{src:fn("/src/portfolio-images/nuwa/gallery.png"),layout:"full"}]},{id:5,title:"Spirit Oasis",category:"Tech",thumbnail:fn("/src/portfolio-images/spirit-oasis/thumbnail.png"),description:"A reimagined 3D scene from Avatar: The Last Airbender with realistic water and lighting",fullDescription:`This project is a reimagination of a scene in the episode 'The Siege of the North' from Avatar: the Last Airbender. In the Spirit Oasis, two koi fish Tui and La maintain the balance between the Earth and the Moon. When the fish are disturbed, chaos ensues. 

 Using ThreeJS and Blender, we modeled this scene using realistic water effects, lighting changes, and koi fish interaction.`,details:{year:"2023",role:"Procedural Water + Grass, Custom Watercolor Toon Shading, 3D Modeling",mediums:"Three.js, Blender, GLSL"},images:[{type:"iframe",src:"https://spirit-oasis.vercel.app/",layout:"full"}]}],h=(x,S)=>{const b=x.split(S);return b.length===1?x:Ue.jsxs(Ue.Fragment,{children:[b[0],Ue.jsx("span",{style:{fontWeight:"600",color:"rgba(255, 255, 255, 0.95)"},children:S}),b[1]]})},m=["All","Tech","Fashion"],p=i==="All"?d:d.filter(x=>x.category===i),_=x=>{const S=document.getElementById(x);S&&S.scrollIntoView({behavior:"smooth",block:"start"})};return sa.useEffect(()=>{if(!o.current)return;let x,S,b,A,C,y;const v=new qy,P=w=>{if(!o.current)return;const R=o.current.getBoundingClientRect();t.current={x:(w.clientX-R.left)/R.width*2-1,y:-((w.clientY-R.top)/R.height)*2+1}};window.addEventListener("mousemove",P);const U=12,F=Array.from({length:U}).map(()=>({pos:new Ut(Math.random()*2-1,Math.random()*2-1),scale:.4+Math.random()*.4,timeOffset:Math.random()*10,rotation:Math.random()*Math.PI*2})),k=`
      varying vec2 vUv;
      void main(){
        vUv = uv;
        gl_Position = vec4(position,1.0);
    ...
    `,N=`
      ...
      uniform vec2 u_pos[${U}];
      uniform float u_scale[${U}];
      uniform float u_timeOffset[${U}];
      uniform float u_rot[${U}];
    ...
    `;return(()=>{if(!o.current)return;const w=window.innerWidth,R=window.innerHeight;for(;o.current.firstChild;)o.current.removeChild(o.current.firstChild);x=new NE({antialias:!0}),x.setSize(w,R),x.setClearColor(0,1),o.current.appendChild(x.domElement),S=new Ug(-1,1,1,-1,0,1),C=new Za(w,R);const V=new Mi({vertexShader:k,fragmentShader:N,uniforms:{u_time:{value:0},u_resolution:{value:new Ut(w,R)},u_pos:{value:F.map(de=>de.pos)},u_scale:{value:F.map(de=>de.scale)},u_timeOffset:{value:F.map(de=>de.timeOffset)},u_rot:{value:F.map(de=>de.rotation)},u_mouse:{value:new Ut(0,0)}}});b=new zx,b.add(new Li(new As(2,2),V));const $=new Mi({vertexShader:`
          varying vec2 vUv;
          void main(){ vUv = uv; gl_Position = vec4(position, 1.0); }
        `,fragmentShader:B,uniforms:{tDiffuse:{value:C.texture},resolution:{value:new Ut(w,R)},charSize:{value:8}}});A=new zx,A.add(new Li(new As(2,2),$));const se=()=>{y=requestAnimationFrame(se);const de=v.getElapsedTime();V.uniforms.u_time.value=de;const fe=t.current.x,O=t.current.y;V.uniforms.u_mouse.value.set(fe,O),x.setRenderTarget(C),x.render(b,S),x.setRenderTarget(null),x.render(A,S)};se()})(),()=>{window.removeEventListener("mousemove",P),cancelAnimationFrame(y);try{x&&x.dispose(),C&&C.dispose(),x&&x.domElement&&o.current&&o.current.removeChild(x.domElement)}catch{}}},[]),Ue.jsxs("div",{style:{position:"relative",width:"100vw",height:"100vh",overflow:"auto"},children:[Ue.jsx("div",{ref:o,style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",zIndex:0}}),Ue.jsxs("div",{style:{position:"relative",zIndex:1,color:"white"},children:[l&&Ue.jsxs("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:200,overflowY:"auto",background:"rgba(0, 0, 0, 0.95)",backdropFilter:"blur(20px)"},children:[Ue.jsx("button",{onClick:()=>u(null),style:{position:"fixed",top:"2rem",right:"2rem",background:"rgba(255, 255, 255, 0.1)",border:"1px solid rgba(255, 255, 255, 0.2)",borderRadius:"50%",width:"50px",height:"50px",color:"white",fontSize:"1.5rem",cursor:"pointer",zIndex:201,display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.2s"},onMouseEnter:x=>{x.target.style.background="rgba(255, 255, 255, 0.2)",x.target.style.borderColor="rgba(255, 255, 255, 0.4)"},onMouseLeave:x=>{x.target.style.background="rgba(255, 255, 255, 0.1)",x.target.style.borderColor="rgba(255, 255, 255, 0.2)"},children:"×"}),Ue.jsxs("div",{style:{maxWidth:"1200px",margin:"0 auto",padding:"3rem 2rem"},children:[Ue.jsxs("div",{style:{marginBottom:"1rem"},children:[Ue.jsx("span",{style:{fontSize:"1.0rem",color:"rgba(255, 255, 255, 0.5)",textTransform:"uppercase",letterSpacing:"0.1em"},children:l.category}),Ue.jsx("h1",{className:"font-argent-normal",style:{fontSize:"2.3rem",fontWeight:"300",margin:"1rem 0",textShadow:"0 0 20px rgba(0,0,0,0.8)"},children:l.title}),Ue.jsxs("div",{style:{display:"grid",gridTemplateColumns:"auto max-content 1fr",columnGap:"2rem",marginBottom:"1rem",background:"rgba(0, 0, 0, 0.4)",backdropFilter:"blur(10px)",border:"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"8px",padding:"1rem"},children:[Ue.jsxs("div",{children:[Ue.jsx("div",{style:{fontSize:"0.8rem",color:"rgba(255, 255, 255, 0.5)",marginBottom:"0.4rem"},children:"Year"}),Ue.jsx("div",{style:{fontSize:"0.9rem",fontWeight:"400"},children:l.details.year})]}),Ue.jsxs("div",{children:[Ue.jsx("div",{style:{fontSize:"0.8rem",color:"rgba(255, 255, 255, 0.5)",marginBottom:"0.4rem"},children:"Role"}),Ue.jsx("div",{style:{fontSize:"0.9rem",fontWeight:"400"},children:l.details.role})]}),Ue.jsxs("div",{children:[Ue.jsx("div",{style:{fontSize:"0.8rem",color:"rgba(255, 255, 255, 0.5)",marginBottom:"0.4rem"},children:"Mediums"}),Ue.jsx("div",{style:{fontSize:"0.9rem",fontWeight:"400"},children:l.details.mediums})]})]}),Ue.jsx("p",{style:{fontSize:"1.1rem",fontWeight:300,color:"rgba(255, 255, 255, 0.7)",maxWidth:"100%",lineHeight:"1.25",whiteSpace:"pre-line"},children:l.fullDescription})]}),Ue.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"1rem"},children:l.images.map((x,S)=>{const b={full:{width:"100%",flexBasis:"100%"},half:{width:"calc(50% - 0.5rem)",flexBasis:"calc(50% - 0.5rem)"},third:{width:"calc(33.333% - 0.67rem)",flexBasis:"calc(33.333% - 0.67rem)"},quarter:{width:"calc(25% - 0.75rem)",flexBasis:"calc(25% - 0.75rem)"},"two-thirds":{width:"calc(66.666% - 0.5rem)",flexBasis:"calc(66.666% - 0.5rem)"}},A=x.layout||"full",C=b[A];return Ue.jsx("div",{style:{...C,minHeight:x.type==="video-row"?"auto":"300px",background:"transparent",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"0.9rem",color:"rgba(255, 255, 255, 0.3)",overflow:"hidden"},children:x.type==="iframe"?Ue.jsx("div",{style:{position:"relative",width:"100%",paddingBottom:"56.25%",height:0,borderRadius:"8px",overflow:"hidden",background:"rgba(255, 255, 255, 0.05)"},children:Ue.jsx("iframe",{src:x.src,style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",border:"none"},loading:"lazy",allow:"fullscreen"})}):x.type==="video-row"?Ue.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(4, 1fr)",gap:"0.75rem",width:"100%"},children:x.items.map((y,v)=>Ue.jsx("video",{src:y,alt:`Aerial Reverie mp4 ${v+1}`,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,preload:"auto",style:{width:"100%",height:"auto",display:"block",borderRadius:"6px",objectFit:"cover"}},v))}):x.type==="video"?(()=>{const y=x.src.includes("kinetic-pixels/header_tiles");return Ue.jsx("video",{src:x.src,autoPlay:!0,loop:y,muted:y,controls:!y,playsInline:!0,preload:"auto",style:{width:"100%",height:"100%",objectFit:"cover",borderRadius:"8px",pointerEvents:y?"none":"auto"}})})():x.src?Ue.jsx("img",{src:x.src,alt:x.placeholder,style:{width:"100%",height:"100%",objectFit:"cover"}}):x.type==="kinetic-grid"?Ue.jsx("div",{style:{width:"100%",margin:"0.5rem 0"},children:Ue.jsx(zE,{getImg:fn})}):x.placeholder},S)})})]})]}),Ue.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,padding:"1.5rem 2rem",background:"rgba(0, 0, 0, 0.5)",backdropFilter:"blur(10px)",borderBottom:"1px solid rgba(255, 255, 255, 0.1)",zIndex:100,display:"flex",justifyContent:"space-between",alignItems:"center"},children:[Ue.jsx("div",{className:"font-argent-italic",style:{fontSize:"1.3rem",fontWeight:"400"},children:"vivian li"}),Ue.jsxs("div",{style:{display:"flex",gap:"2rem"},children:[Ue.jsx("button",{onClick:()=>_("publications"),style:{background:"none",border:"none",color:"white",cursor:"pointer",fontSize:"1rem",opacity:.8,transition:"opacity 0.2s"},onMouseEnter:x=>x.target.style.opacity=1,onMouseLeave:x=>x.target.style.opacity=.8,children:"Publications"}),Ue.jsx("button",{onClick:()=>_("portfolio"),style:{background:"none",border:"none",color:"white",cursor:"pointer",fontSize:"1rem",opacity:.8,transition:"opacity 0.2s"},onMouseEnter:x=>x.target.style.opacity=1,onMouseLeave:x=>x.target.style.opacity=.8,children:"Portfolio"})]})]}),Ue.jsxs("div",{style:{minHeight:"45vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",padding:"1rem 2rem",textAlign:"center",paddingTop:"5rem"},children:[Ue.jsx("h1",{className:"font-argent-italic",style:{fontSize:"4.5rem",fontWeight:"100",marginBottom:"0.5rem",textShadow:"0 0 40px rgba(0,0,0,1), 0 0 30px rgba(0,0,0,1), 0 0 20px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,1), 2px 2px 8px rgba(0,0,0,1)"},children:"vivian li"}),Ue.jsx("p",{className:"dotgothic16-regular",style:{fontSize:"1rem",maxWidth:"900px",lineHeight:"1.5",textShadow:"none"},children:Ue.jsxs("span",{className:"text-slab",children:["I explore how computation can emerge from material behavior. Working across computational design, digital fabrication, computer graphics, and HCI, I develop reconfigurable textile and soft-material systems where sensing, logic, and actuation are encoded into geometry and structure.",Ue.jsx("br",{}),Ue.jsx("br",{}),"I am currently a researcher in the Computational Design Group @ Brown Visual Computing Lab and pursuing an Sc.M. in Electrical & Computer Engineering. I received my Sc.B. in Computer Science from Brown University."]})})]}),Ue.jsxs("div",{id:"publications",style:{padding:"0.5rem 2rem",maxWidth:"1200px",margin:"0 auto"},children:[Ue.jsx("h2",{className:"font-argent-normal",style:{fontSize:"2rem",fontWeight:"300",marginBottom:"1rem",textAlign:"center",textShadow:"0 0 20px rgba(0,0,0,0.8)"},children:"publications"}),Ue.jsxs("div",{onClick:()=>window.open("#","_blank"),style:{background:"rgba(0, 0, 0, 0.6)",backdropFilter:"blur(10px)",border:"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"8px",padding:"1.5rem",display:"flex",gap:"1.5rem",alignItems:"start",cursor:"pointer",transition:"transform 0.2s, border-color 0.2s"},onMouseEnter:x=>{x.currentTarget.style.transform="translateY(-4px)",x.currentTarget.style.borderColor="rgba(255, 255, 255, 0.3)"},onMouseLeave:x=>{x.currentTarget.style.transform="translateY(0)",x.currentTarget.style.borderColor="rgba(255, 255, 255, 0.1)"},children:[Ue.jsx("div",{style:{width:"180px",height:"135px",borderRadius:"4px",flexShrink:0,background:"white",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden"},children:Ue.jsx("img",{src:fn("/src/portfolio-images/diceplay/temp-mainfig.jpg"),alt:"Diceplay publication",style:{width:"100%",height:"100%",objectFit:"contain"}})}),Ue.jsxs("div",{style:{flex:1},children:[Ue.jsx("h3",{style:{fontSize:"1.2rem",fontWeight:"400",marginBottom:"0.4rem"},children:"Diceplay: A Modular Canvas for Physical Image Composition"}),Ue.jsx("p",{style:{fontSize:"0.9rem",color:"rgba(255, 255, 255, 0.7)",marginBottom:"0.4rem"},children:h("Milin Kodnongbua, Zihan Jack Zhang, Shishi Xiao, Vivian Li, Heather Robertson, Rulin Chen, David Laidlaw, Adriana Schulz","Vivian Li")}),Ue.jsx("p",{style:{fontSize:"1rem",color:"rgba(255, 255, 255, 0.5)"},children:"SIGGRAPH • 2026"})]})]}),Ue.jsxs("div",{onClick:()=>window.open("https://www.nature.com/articles/s41586-024-08568-6","_blank"),style:{background:"rgba(0, 0, 0, 0.6)",backdropFilter:"blur(10px)",border:"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"8px",padding:"1.5rem",display:"flex",gap:"1.5rem",alignItems:"start",cursor:"pointer",transition:"transform 0.2s, border-color 0.2s",marginTop:"1rem"},onMouseEnter:x=>{x.currentTarget.style.transform="translateY(-4px)",x.currentTarget.style.borderColor="rgba(255, 255, 255, 0.3)"},onMouseLeave:x=>{x.currentTarget.style.transform="translateY(0)",x.currentTarget.style.borderColor="rgba(255, 255, 255, 0.1)"},children:[Ue.jsx("img",{src:fn("/src/portfolio-images/single-fibre/dither_it_figure-1.png"),alt:"Single-fibre computing publication",style:{width:"180px",height:"135px",borderRadius:"4px",flexShrink:0,objectFit:"cover"}}),Ue.jsxs("div",{style:{flex:1},children:[Ue.jsx("h3",{style:{fontSize:"1.2rem",fontWeight:"400",marginBottom:"0.4rem"},children:"A single-fibre computer enables textile networks and distributed inference"}),Ue.jsx("p",{style:{fontSize:"0.9rem",color:"rgba(255, 255, 255, 0.7)",marginBottom:"0.4rem"},children:h("Nikhil Gupta, Henry Cheung, Syamantak Payra, Gabriel Loke, Jenny Li, Yongyi Zhao, Latika Balachander, Ella Son, Vivian Li, Samuel Kravitz, Sehar Lohawala, John Joannopoulos & Yoel Fink","Vivian Li")}),Ue.jsx("p",{style:{fontSize:"1rem",color:"rgba(255, 255, 255, 0.5)"},children:"Nature • 2025"})]})]})]}),Ue.jsxs("div",{id:"portfolio",style:{padding:"0.5rem 2rem 2.5rem 2rem",maxWidth:"1200px",margin:"0 auto"},children:[Ue.jsx("h2",{className:"font-argent-normal",style:{fontSize:"1.8rem",fontWeight:"300",marginBottom:"1rem",textAlign:"center",textShadow:"0 0 20px rgba(0,0,0,0.8)"},children:"portfolio"}),Ue.jsx("div",{style:{display:"flex",justifyContent:"center",gap:"1rem",marginBottom:"2rem"},children:m.map(x=>Ue.jsx("button",{onClick:()=>r(x),style:{background:i===x?"rgba(255, 255, 255, 0.2)":"rgba(0, 0, 0, 0.4)",backdropFilter:"blur(10px)",border:`1px solid ${i===x?"rgba(255, 255, 255, 0.4)":"rgba(255, 255, 255, 0.1)"}`,borderRadius:"20px",padding:"0.5rem 1.5rem",color:"white",cursor:"pointer",fontSize:"0.9rem",fontWeight:i===x?"500":"300",transition:"all 0.3s ease"},onMouseEnter:S=>{i!==x&&(S.target.style.background="rgba(255, 255, 255, 0.1)",S.target.style.borderColor="rgba(255, 255, 255, 0.2)")},onMouseLeave:S=>{i!==x&&(S.target.style.background="rgba(0, 0, 0, 0.4)",S.target.style.borderColor="rgba(255, 255, 255, 0.1)")},children:x},x))}),Ue.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:"2rem"},children:p.map(x=>Ue.jsxs("div",{onClick:()=>u(x),style:{background:"rgba(0, 0, 0, 0.6)",backdropFilter:"blur(10px)",border:"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"8px",overflow:"hidden",cursor:"pointer",transition:"transform 0.2s, border-color 0.2s"},onMouseEnter:S=>{S.currentTarget.style.transform="translateY(-4px)",S.currentTarget.style.borderColor="rgba(255, 255, 255, 0.3)"},onMouseLeave:S=>{S.currentTarget.style.transform="translateY(0)",S.currentTarget.style.borderColor="rgba(255, 255, 255, 0.1)"},children:[Ue.jsx("div",{style:{width:"100%",height:"200px",background:"rgba(255, 255, 255, 0.05)",position:"relative",overflow:"hidden",display:"flex",alignItems:"center",justifyContent:"center"},children:x.thumbnail?Ue.jsx("img",{src:x.thumbnail,alt:x.title,style:{width:"100%",height:"100%",objectFit:"cover",opacity:1}}):Ue.jsx("span",{style:{fontSize:"0.8rem",color:"rgba(255, 255, 255, 0.3)"},children:"Project Image"})}),Ue.jsxs("div",{style:{padding:"1.5rem"},children:[Ue.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"0.5rem"},children:[Ue.jsx("h3",{style:{fontSize:"1.0rem",fontWeight:"400",margin:0},children:x.title}),Ue.jsx("span",{style:{fontSize:"0.75rem",color:"rgba(255, 255, 255, 0.5)",background:"rgba(255, 255, 255, 0.1)",padding:"0.25rem 0.75rem",borderRadius:"12px"},children:x.category})]}),Ue.jsx("p",{style:{fontSize:"0.8rem",fontWeight:300,color:"rgba(255, 255, 255, 0.7)",margin:0},children:x.description})]})]},x.id))})]})]})]})}function BE(){return Ue.jsx(PE,{})}Jv.createRoot(document.getElementById("root")).render(Ue.jsx(Xv.StrictMode,{children:Ue.jsx(BE,{})}));
